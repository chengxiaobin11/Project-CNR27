#if(_PCB_TYPE == _RL6432__156PIN__HKMRT2557E03__1T1H1DP_EDP)

#define _PCB_DEBUG_DDC                       _DDC3//   _NO_DDC

#ifndef _DEF_255XE03_PCB_TYPE
#define _DEF_255XE03_PCB_TYPE									1//	o old   1 new
#endif

#ifndef _DEF_255XE08_PCB_TYPE
#define _DEF_255XE08_PCB_TYPE									0//	
#endif
...
#if 0//(Project_ID == ID_ZQ_HK255XE03_1T1P1H_MV270QHBN50_LVDS_QHD75HZ_20230522)
#define _LVDS_PN_SWAP                           _ENABLE// _DISABLE
#else
...
//////////////////////
#if(_IR_VIRTUAL)	
#define IR_STATUS                  (P1_6|P1_5)
#endif

#define LED_HIGH                   1
#define LED_LOW                    0

#if 0//(_LED_EFFECT==_LED_TJ)||(_LED_EFFECT==_LED_TJ_23G7)||(_LED_EFFECT==_LED_TJ_G2G6G7)
...
#define PCB_GPIO_SETTING_POWER_SAVING()         {\
	MCU_FE23_PORT83_PIN_REG=1;MCU_FE04_PORT44_PIN_REG=1;\
...
#define   OSD_LED_CONTRL(x)          (MCU_FE14_PORT64_PIN_REG = x)//_156PIN_PIN_49_OFF_REGION,   P6D4o
#define   GET_LED_STATUS()          (MCU_FE14_PORT64_PIN_REG)//_156PIN_PIN_49_OFF_REGION,   P6D4o

#elif(_DEF_255XE03_PCB_TYPE==0)

#define   OSD_LED_CONTRL(x)          (MCU_FE2B_PORT93_PIN_REG = x)//_156PIN_PIN_78,   P9D3o
#define   GET_LED_STATUS()          (MCU_FE2B_PORT93_PIN_REG)//_156PIN_PIN_78,   P9D3o
...
#if(_DEF_255XE03_PCB_TYPE==1)
#define bDDRPOWER                               (MCU_FE2B_PORT93_PIN_REG) // _156PIN_PIN_52, P5.2
...
sbit bD3_PIN16_CONNECT                     	= P1 ^ 0; // 156PIN_PIN_119, P1.4


#define bD0_CONNECT                             (((bit)bD0_DP_PIN15_CONNECT == _FALSE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _TRUE))
#define bD1_CONNECT                             (((bit)bD1_DP_PIN15_CONNECT == _TRUE) && ((bit)bD1_DP_PIN16_CONNECT == _TRUE) && ((bit)bD1_DP_PIN17_CONNECT == _FALSE))
#define bD3_CONNECT                             ((bit)bD3_PIN16_CONNECT)  //_156PIN_PIN_78,P9D3
...
#define HUB_SWITCH_GET()                	 (MCU_FE22_PORT82_PIN_REG)//_156PIN_PIN_70 8.2

#define HUB_SWITCH(x)                        (MCU_FE22_PORT82_PIN_REG = x)
#endif
//-----------------------------------------------
...
#if 0//(_DEF_LED_COLOR_OPPOSITE)	//指示灯颜色相反
...
#define bPOWER_KEY                               (MCU_FE05_PORT45_PIN_REG) // _156PIN_PIN_152, P4D5
...
#if  0//(Project_ID == ID_2557E09_SN270CS03_1_F27G3_LOGO_SKY_20230725)

#define POWER_KEY								0xE8
...
#elif 0//(Project_ID == ID_2557E09_SN270ES02_1_F27B2Q_LOGO_SKY_20230725)
...
#define RIGHT_REG								1
#define LEFT_REG								1
#elif 0//(Project_ID == ID_DX_HK2557E03_1T1P1H_M270DAN07_V700_QHD100HZ_20240117)

#define POWER_KEY								0x00//NO
...
#define POWER_REG								1
#define MENU_REG								2
#define EXIT_REG								0XFF
#define RIGHT_REG								1
#define LEFT_REG								1

#elif 0//(Project_ID == ID_TJ_HK2557E03_1P1H_DF245FHBNF0_FHD180HZ_20231220)
...
#if 0//(Project_ID == ID_DX_HK2557E03_1T1P1H_M270DAN07_V700_QHD100HZ_20240117)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((((KeyDefault[4]<0X10)? 0: KeyDefault[4]-0X10) <= ((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>(247-0X10))? 247: KeyDefault[4]+0X10)))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
                                                                }\
																if((((KeyDefault[3]<0X10)? 0: KeyDefault[3]-0X10) <= ((KeyDefault[8]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[8]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[3]>(247-0X10))? 247: KeyDefault[3]+0X10)))\
																{\
                                                                ...
                                                                if((((KeyDefault[1]<0X10)? 0: KeyDefault[1]-0X10) <= ((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[1]>(247-0X10))? 247: KeyDefault[1]+0X10)))\
                                                                {\
                                                                    (ucKeyState) |= _MENU_KEY_MASK ;\
                                                                }\
																if((((KeyDefault[0]<0X10)? 0: KeyDefault[0]-0X10) <= ((KeyDefault[5]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[5]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[0]>(247-0X10))? 247: KeyDefault[0]+0X10)))\
                                                                {\
...
//#define _BURNIN_STR_IC_NAME                	 _B__,_o__,_a__,_r__,_d__,_COLON__,__,_H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_7__,_E__,_0__,_3__
