...
// Macro of LED On/Off
//--------------------------------------------------
#if(Project_ID == ID_HHT_HK2556E06_1P1H_INN_M270KCJ_L5E_QHD75HZ_20210120 && (_PROJEC_ID_TYPE==2 || _PROJEC_ID_TYPE==3))||(Project_ID == ID_HHT_HK2556E06_1P1H_INN_M270HCA_L7B_FHD165HZ_20210222)
...
#if(_PROJEC_ID_TYPE==2)//||(_PROJEC_ID_TYPE==3)
...
//现在按键是 开关 减键 加键 菜单 返回
//需要修改为 菜单 减键 加键 返回 开关
#define POWER_KEY								0x80
#define MENU_KEY								0x80
