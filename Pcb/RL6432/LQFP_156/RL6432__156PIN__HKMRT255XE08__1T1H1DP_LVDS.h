...
#define   OSD_P70_CONTRL(x)          (MCU_FE22_PORT82_PIN_REG = x)//USB_SWITCH
#define   OSD_P151_CONTRL(x)         (MCU_FE04_PORT44_PIN_REG = x)//USB_POWER
...
#define PCB_USB_HUB_POWER(x)                                    (MCU_FE04_PORT44_PIN_REG = x)											

#define _USB_POWER_ON                      1
#define _USB_POWER_OFF                0

#define PCB_USB_POWER(x)                                  (MCU_FE04_PORT44_PIN_REG = x)		
...
#define _PCB_USB_POWER							(MCU_FE04_PORT44_PIN_REG)//_156PIN_PIN_151	P4.4
#define _PCB_USB_ON                   			1//    0
#define _PCB_USB_OFF                   			0//   1
#define PCB_USB_POWER_ON()					(_PCB_USB_POWER = _PCB_USB_ON)
#define PCB_USB_POWER_OFF()					(_PCB_USB_POWER = _PCB_USB_OFF)
//--------------------------------------------------
...
#define bD3_CONNECT                             ((bit)bD3_PIN16_CONNECT)//(MCU_FE2B_PORT93_PIN_REG)  //_156PIN_PIN_78,P9D3
...
#define AD_KEY3									(MCU_FE05_PORT45_PIN_REG) // 156PIN_PIN_152	P4D5
