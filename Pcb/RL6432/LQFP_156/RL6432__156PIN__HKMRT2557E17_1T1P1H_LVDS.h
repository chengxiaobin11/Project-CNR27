...
#define _D3_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_CODE//_EDID_TABLE_LOCATION_CODE
#endif
/////////////////////////////
...
//--------------------------------------------------
#define _PANEL_DPTX_1_1_SPREAD_RANGE           10//0
...
// SW & HW IIC //
/////////////////
#if (_HDMI_24C02_SUPPORT) //|| (_LIGHTING_EFFECT_IIC_SUPPORT)
...
#if 1
#define _156PIN_PIN_50_OFF_REGION                          (1 & 0x0F) // Page 10-0x1B[2:0]//1
...
// DP_HOT_PLUG_0
#define _156PIN_PIN_70                          (1 & 0x0F)//(1 & 0x0F) // Page 10-0x32[2:0]
...
#define PD_SCALER_VCC_HIGH						1
#define PD_SCALER_VCC_LOW						0

#define PCB_PD_SCALER_VCC_GET()						(MCU_FE04_PORT44_PIN_REG)	//_156PIN_PIN_151	P4D4
#define PCB_PD_SCALER_VCC_SET(x)					(MCU_FE04_PORT44_PIN_REG = (x))	//_156PIN_PIN_151	P4D4

#define _DEF_1_1V_SCALER_VCC_HIGH					1
#define _DEF_1_1V_SCALER_VCC_LOW						0
#define PCB_1_1V_SCALER_GET()						(MCU_FE29_PORT91_PIN_REG)	//_156PIN_PIN_76	P9D1
#define PCB_1_1V_SCALER_SET(x)						(MCU_FE29_PORT91_PIN_REG = (x))	//_156PIN_PIN_76	P9D1


#define PCB_SCALER_OFF_SET_POWER_SAVING_OFF()		{\
													if(PCB_PD_SCALER_VCC_GET() == PD_SCALER_VCC_HIGH)\
													PCB_PD_SCALER_VCC_SET(PD_SCALER_VCC_LOW);\
													if(PCB_1_1V_SCALER_GET() == _DEF_1_1V_SCALER_VCC_HIGH)\
													PCB_1_1V_SCALER_SET(_DEF_1_1V_SCALER_VCC_LOW);\
}

#define PCB_SCALER_ON_SET_POWER_ON()		{\
													if(PCB_1_1V_SCALER_GET() == _DEF_1_1V_SCALER_VCC_LOW)\
													PCB_1_1V_SCALER_SET(_DEF_1_1V_SCALER_VCC_HIGH);\
													ScalerTimerDelayXms(20);\
													if(PCB_PD_SCALER_VCC_GET() == PD_SCALER_VCC_LOW)\
													PCB_PD_SCALER_VCC_SET(PD_SCALER_VCC_HIGH);\
}
...
#define PCB_GPIO_SETTING_POWER_DOWN()           {\	
													PCB_SCALER_OFF_SET_POWER_SAVING_OFF();\
}
#else
#define PCB_GPIO_SETTING_POWER_SAVING()         {\											
													PCB_SCALER_OFF_SET_POWER_SAVING_OFF();\
...
#define bVCCKOFFPOWER                         	(MCU_FE29_PORT91_PIN_REG)// _156PIN_PIN_66
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE13_PORT63_PIN_REG) // 156PIN_PIN_48, P6.3
...
//-----------------------------------------------
#if 1
#define bD0_DP_PIN15_CONNECT                    (MCU_FE24_PORT84_PIN_REG) // 156PIN_PIN_71, P8.4
sbit bD0_DP_PIN16_CONNECT                       = P1 ^ 3; // 156PIN_PIN_118, P1.3
#define bD0_DP_PIN17_CONNECT                    (MCU_FE25_PORT85_PIN_REG) // _156PIN_PIN_72, P8.5
...
#else
sbit bD0_DP_PIN15_CONNECT                       = P3 ^ 0; // _156PIN_PIN_135, P3.0
sbit bD0_DP_PIN16_CONNECT                       = P1 ^ 3; // 156PIN_PIN_118, P1.3
sbit bD0_DP_PIN17_CONNECT                       = P3 ^ 1; // _156PIN_PIN_136, P8.4

sbit bD1_DP_PIN15_CONNECT                    	= P3 ^ 2; // _156PIN_PIN_137, P8.0
sbit bD1_DP_PIN16_CONNECT                       = P1 ^ 4; // 156PIN_PIN_119, P1.4
sbit bD1_DP_PIN17_CONNECT                    	= P3 ^ 3; // _156PIN_PIN_138, P8.1
#endif


#define bD0_CONNECT                             ((bit)bD0_DP_PIN16_CONNECT == _TRUE)//(((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
#define bD1_CONNECT                            	((bit)bD1_DP_PIN16_CONNECT == _TRUE)
sbit  bD3_CONNECT                             	= P1 ^ 0;  //_156PIN_PIN_82,P1D0
...
#define AD_KEY3                                 bPOWER_KEY // 156PIN_PIN_144,A-ADC1
//power adckey1=00; menu adc1 78;down adc1 d0;   up adc2:00 ;exit==adc2 d0 ;  
#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
#define bPOWER_KEY                            	(MCU_FE05_PORT45_PIN_REG)	//156PIN_PIN_152  P4D5


#if(Project_ID == ID_KAIDI_HK2557E19_MV270QHM_N30_QHD75HZ_20260319)
...
#define bPCB_HP_SENSE_DETECT                   (bHeadphoneDetect)     
...
//#define _MAIN_PAGE_MODEL_NAME                 _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_2_,_5_,_5_,_7_

#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_7__,_E__,_1__,_9__
...
// Macro of MPRT CONTROL
//-----------------------------------------------
#define bMPRT_CURRENT_CONTROL                            (MCU_FE14_PORT64_PIN_REG)	// _156PIN_PIN_49 P6.4
...
#define GET_TYPEC_SWITCH() 				(MCU_FE12_PORT62_PIN_REG)
