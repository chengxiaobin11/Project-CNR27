...
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__HKMRT255XE19__1T1P1H__LVDS)

#define _PCB_DEBUG_DDC                          _DDC3

//带不带USB操作

#define _DEF_PCB_USB_ENABLE							_OFF
...
// LVDS Driving Config
//--------------------------------------------------
#define _LVDS_DRIV_CONTROL                      _LVDS_DRIV_CONTROL_3_5//_LVDS_DRIV_CONTROL_3_0
...
// LVDS SSC Config
//--------------------------------------------------
#define _LVDS_SPREAD_RANGE                  	10//5 
...
// DDCSCL_VGA
#define _156PIN_PIN_131                         (2 & 0x0F) // Page 10-0x05[2:0]
...
//P69:MCU_FE23_PORT83_PIN_REG
     
#define HUB_SWITCH(x)                        (MCU_FE22_PORT82_PIN_REG = x)
#define HUB_SWITCH2(x)                        (MCU_FE14_PORT64_PIN_REG = x)//_156PIN_PIN_49_OFF_REGION   P6D4


#define   OSD_P69_CONTRL(x)          (MCU_FE23_PORT83_PIN_REG = x)//1.1V
#define   OSD_P78_CONTRL(x)          (MCU_FE2B_PORT93_PIN_REG = x)//DDR_EN
#define   OSD_P49_CONTRL(x)          (MCU_FE14_PORT64_PIN_REG = x)//LED


#define _USB_HUB_ON                		1
#define _USB_HUB_OFF                	0
#define PCB_USB_HUB_RESET(x)                          		(MCU_FE2A_PORT92_PIN_REG = x)	//_156PIN_PIN_77	

#define _USB_POWER_ON           		1
#define _USB_POWER_OFF                	0
#define PCB_USB_POWER_GET()                                  (MCU_FE04_PORT44_PIN_REG)		//_156PIN_PIN_151
#define PCB_USB_POWER(x)                                  	(MCU_FE04_PORT44_PIN_REG = x)		//_156PIN_PIN_151

#define _USB_SWTICH_Type_C				0
#define _USB_SWTICH_PC					1
#define _PCB_USB_SWITCH										(MCU_FE22_PORT82_PIN_REG)	//_156PIN_PIN_70
...
//#define   OSD_LED_CONTRL(x)          (MCU_FE14_PORT64_PIN_REG = x)//_156PIN_PIN_49,   P6D4
//#define   GET_LED_STATUS()          (MCU_FE14_PORT64_PIN_REG)
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE1F_PORT77_PIN_REG) // _156PIN_PIN_66, P8.1
...
sbit bIIC_MCU_PD_SCL                       		= P1^5;
sbit bIIC_MCU_PD_SDA                       		= P1^6;

#define bIIC_PD_SCL        				    	      (bIIC_MCU_PD_SCL) // _156PIN_PIN_131, 
#define bIIC_PD_SDA          					      (bIIC_MCU_PD_SDA) // _156PIN_PIN_132,
...
// Macro of LED On/Off
//--------------------------------------------------
//(_DEF_LED_COLOR_OPPOSITE)	//指示灯颜色相反
#if(_KEY_LED_INSERVE)
...
#define AD_KEY3									(MCU_FE05_PORT45_PIN_REG)
#define bPOWER_KEY								AD_KEY3 // 156PIN_PIN_152	P4D5
...
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_x__,_E__,_1__,_9__
