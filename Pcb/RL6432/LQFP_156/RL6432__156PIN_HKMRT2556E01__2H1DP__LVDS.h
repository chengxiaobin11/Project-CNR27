...
#else
#define _LVDS_PORT_SEL                        _LVDS_2_PORT_AB//_LVDS_2_PORT_AB//  _LVDS_2_PORT_CD
#endif
...
#else
#define _LVDS_DRIV_CONTROL                      _LVDS_DRIV_CONTROL_3_5
#define _LVDS_VCM_CONTROL                       _LVDS_VCM_USER
#define _LVDS_SR_CONTROL                        _LVDS_SR_CONTROL_0
#define _LVDS_PRE_EMPHASIS_CONTROL              _LVDS_PRE_EMPHASIS_0
#define _LVDS_TERMINATION_CONTROL               _DISABLE
...
#if(Project_ID == ID_SONGREN_HK2556E01_1P2H_M270DTR011_EDP_QHD75HZ_20210423)\
	||(Project_ID == ID_HENGFA_HK2556E01_1P2H_M270DAN082_QHD60HZ_20210429)\
	||(Project_ID == ID_SHUNWEI_HK2556E01_1P2H_AUO_M250HAN016_EDP4LAN_FHD165HZ_20210713)\
	||(Project_ID == ID_SHUNWEI_HK2556E01_1P2H_AUO_M270HAN032_EDP4LAN_FHD165HZ_20210913)\
	||(Project_ID == ID_JINGBAO_HK2556E01_1P2H_AUO_M270HAN032_EDP4LAN_FHD1644HZ_20211122)\
	||(Project_ID == ID_SHUNWEI_HK2556E01_1P2H_AUO_M270HAN032_EDP4LAN_FHD165HZ_202109131)\
	||(Project_ID == ID_XHS_HK2556E01_1P2H_AUO_M270HAN032_EDP4LAN_FHD165HZ_20220613)\
	||(Project_ID == ID_AUO_HK2556E01_1P2H_M315DVR016_QHD75HZ_20220516)\
	||(Project_ID == ID_CS_2556E01_DX)\
...
#endif
#if 0//(_PANEL_TYPE == _AUO_M270DAN082_EDP_QHD75HZ)
#define _PANEL_DPTX_1_1_SWING_LEVEL             _DP_SWING_1200_MV
...
#if(Project_ID == ID_DX_HK2556E01_SG3151B05_8_FHD165HZ_20230901)//(_DEF_DX_LED_MODE3)
...
#if 1//
#define dx_Led_SCL						(P1_5)	// 156PIN_PIN_131, P1.5
#define dx_Led_SDA						(P1_6)	// 156PIN_PIN_132, P1.6

#define Led_ClrLedSCL()				(dx_Led_SCL = 0)
#define Led_SetLedSCL()				(dx_Led_SCL = 1)

#define Led_ClrLedSDA()				(dx_Led_SDA = 0)
#define Led_SetLedSDA()				(dx_Led_SDA = 1)


sbit bLED_SCL_CONTROLS                       = P1 ^ 5; // 156PIN_PIN_131, P1.5

#define hw_ClrLedSCL()						(bLED_SCL_CONTROLS = 0)
#define hw_SetLedSCL()						(bLED_SCL_CONTROLS = 1)
...
#elif(Project_ID == ID_HUIXIONG_HK2556E01_MV238FHM_NG0_FHD165HZ_BG245165_20210402)||(Project_ID == ID_HUIXIONG_HK2556E01_MV238FHM_NG0_FHD165HZ_244F165_20210402)
//M L R E P
#define POWER_KEY								0xD0
...
#elif(Project_ID == ID_DX_HK2556E01_1P2H_M270HAN026_FHD165HZ_20230727)||(Project_ID == ID_DX_HK2556E01_1P2H_SN238CS041_FHD165HZ_20230807)
...
//POWER改MENU UP改DOWN EXIT改UP DOWN改为EXIT MENU改为POWER
#define POWER_KEY								0xD0
#define MENU_KEY								0xA8
#define EXIT_KEY								0x80
#define LEFT_KEY								0X00
...
#define POWER_KEY								0xA8//0x00 
#define MENU_KEY								0x0A//0xD0 
#define EXIT_KEY								0x80//0x00
#define RIGHT_KEY								0xD0//0x80 
#define LEFT_KEY								0x00//0xA8 
...
// K0 D0 1 K1 00 1 K2 00 2 K3 80 2 K4 A8 2
#if 0
#define POWER_KEY								0xD0
#define MENU_KEY								0x00
#define EXIT_KEY								0x00
...
#if(Project_ID == ID_SHUNWEI_HK2556E01_1P2H_AUO_M240HW01V8_LVDS_FHD165HZ_20210608)
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((((KeyDefault[0]<10)? 0: KeyDefault[0]-10) <= ((KeyDefault[5]==1)? AD_KEY2 : AD_KEY1)) && (((KeyDefault[5]==1)? AD_KEY2 : AD_KEY1) < ((KeyDefault[0]>237)? 247: KeyDefault[0]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _POWER_KEY_MASK;\
                                                                }\   
                                                            }
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= ((KeyDefault[9]==2)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==2)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
                                                                }\
                                                                if((((KeyDefault[3]<10)? 0: KeyDefault[3]-10) <= ((KeyDefault[8]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[8]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[3]>237)? 247: KeyDefault[3]+10)))\
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((((KeyDefault[3]<10)? 0: KeyDefault[3]-10) <= ((KeyDefault[8]==2)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[8]==2)? AD_KEY1 : AD_KEY2) < ((KeyDefault[3]>237)? 247: KeyDefault[3]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _RIGHT_KEY_MASK ;\
                                                                }\
                                                                if((((KeyDefault[2]<10)? 0: KeyDefault[2]-10) <= ((KeyDefault[7]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[7]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[2]>237)? 247: KeyDefault[2]+10)))\
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((((KeyDefault[2]<10)? 0: KeyDefault[2]-10) <= ((KeyDefault[7]==2)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[7]==2)? AD_KEY1 : AD_KEY2) < ((KeyDefault[2]>237)? 247: KeyDefault[2]+10)))\
                                                                {\
																	(ucKeyState) |= _EXIT_KEY_MASK ;\
                                                                }\                                                 
                                                                if((((KeyDefault[1]<10)? 0: KeyDefault[1]-10) <= ((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[1]>237)? 247: KeyDefault[1]+10)))\
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((((KeyDefault[1]<10)? 0: KeyDefault[1]-10) <= ((KeyDefault[6]==2)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[6]==2)? AD_KEY1 : AD_KEY2) < ((KeyDefault[1]>237)? 247: KeyDefault[1]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _MENU_KEY_MASK ;\
                                                                }\
                                                                if((((KeyDefault[0]<10)? 0: KeyDefault[0]-10) <= ((KeyDefault[5]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[5]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[0]>237)? 247: KeyDefault[0]+10)))\
