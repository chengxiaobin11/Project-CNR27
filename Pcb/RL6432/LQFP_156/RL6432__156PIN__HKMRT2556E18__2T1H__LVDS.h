...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__156PIN__HKMRT2556E18__2T1H__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6432__156PIN__HKMRT2556E18__2T1H__LVDS)
...
//========================================
///////////////
#define _D3_TMDS_BR_SWAP                        _ON// HDMI
#define _D3_TMDS_PN_SWAP                        _ON// HDMI
...
// PIN139-PIN48 , PIN150-PIN161 , PIN164-PIN172b 
...
#define PCB_USB_HUB_POWER(x)                                    (MCU_FE2B_PORT93_PIN_REG = x)											

#define _USB_POWER_ON                      1
#define _USB_POWER_OFF                0

#define PCB_USB_POWER(x)                                  (MCU_FE05_PORT45_PIN_REG = x)											

#define GET_TYPEC_SWITCH()                                (MCU_FE2A_PORT92_PIN_REG)   											
#define GET_TYPEC_B_SWITCH()                              (MCU_FE29_PORT91_PIN_REG)  											
...
#define _LANGUAGE_SWITCH(x)      (MCU_FE29_PORT91_PIN_REG = x) // _156PIN_PIN_132, P7D2
...
#define _ROTATION_OUT_B		(MCU_FE20_PORT80_PIN_REG) // _156PIN_PIN_67, P8D0
...
//-----------------------------------------------
#define bDDRPOWER                               (MCU_FE22_PORT82_PIN_REG) // _156PIN_PIN_52, P5.2
...
#define bD1_DP_PIN15_CONNECT                    (MCU_FE22_PORT82_PIN_REG) // _156PIN_PIN_69, P8.2
#define bD1_DP_PIN17_CONNECT                    (MCU_FE21_PORT81_PIN_REG) // _156PIN_PIN_68, P8.1



//#define bD0_CONNECT                               (((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _FALSE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
//#define bD1_CONNECT                             (((bit)bD1_DP_PIN15_CONNECT == _TRUE) && ((bit)bD1_DP_PIN16_CONNECT == _TRUE) && ((bit)bD1_DP_PIN17_CONNECT == _FALSE))

sbit bD0_CONNECT                                = P1 ^ 3; // _156PIN_PIN_118, P1.3 
sbit bD1_CONNECT                                = P1 ^ 4; // _156PIN_PIN_119, P1.4 


#define PCB_D0_PIN()                            (!bD0_CONNECT)
#define PCB_D1_PIN()                            (!bD1_CONNECT)
#define PCB_D3_PIN()                            (_TRUE)
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_6)// (MCU_FE22_PORT82_PIN_REG) // 156PIN_PIN_70, P8.2
#define bD1_HPD                                 (MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(P1_6)//(MCU_FE23_PORT83_PIN_REG) // 156PIN_PIN_69, P8.3
...
#if(Project_ID==ID_TEST_HK2556MINI_TYPEC_WIFI_EDP60HZ_20200908 &&_PROJEC_ID_TYPE ==1)
#define _MAIN_PAGE_MODEL_NAME                 _M__,_o__,_d__,_e__,_l__,__,_COLON__,__,_S__,_X__,_1__,_5__,_6__,_W__,_0__,_P__,_A__,_0__
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_V__,_DOT__,_C__,_S__,_5__,_6__,_2__,_9__,_V__,_0__,_2__,_X__


#else
#define _MAIN_PAGE_MODEL_NAME                 _M__,_o__,_d__,_e__,_l__,__,_COLON__,__,_2__,_5__,_5__,_6__
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_5__,_6__,_E__,_0__,_2__
#endif
...
#endif // End of #if(_PCB_TYPE == _RL6432__156PIN__HKMRT2556E18__2T1H__LVDS)
