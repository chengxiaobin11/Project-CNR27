...
// LVDS Driving Config
//--------------------------------------------------
#if 0//(Project_ID == ID_JX_HK2556E02_1P1H_M270HCA_L7B_LVDS_FHD165HZ_20211012)
...
// Macro of LED On/Off
//--------------------------------------------------
#if (Project_ID == ID_AS_HK2556E02_1P1H_SG2701B01_8_LVDS_FHD165_20211027)
...
#define POWER_KEY								0x80
#define MENU_KEY								0X00//0x80
#define EXIT_KEY								0xA8//0xD0
#define RIGHT_KEY  								0xD0//0X00	
#define LEFT_KEY								0x80
...
#elif(Project_ID == ID_TRD_HK25561DP1HDMI__BOE_MV238FHB_NG0_FHD165HZ__20200628)
#define POWER_KEY								0x80
#define MENU_KEY								0x00
#define EXIT_KEY								0xa8
#define RIGHT_KEY  								0Xd0	
...
#define RIGHT_REG								1
	...
	#define MENU_KEY								0X80
	#define EXIT_KEY								0x00
	#define RIGHT_KEY  								0xA8//0xD0	
	#define LEFT_KEY								0xD0//0xA8
...
//按键要求菜单--下--上--AUTO--开关，实际开关--下--上--菜单--AUTO
	#define POWER_KEY								0x80
	#define MENU_KEY								0x80
...
#define POWER_KEY								0XA8
#define MENU_KEY								0xE3//0XE0
#define EXIT_KEY								0xE0
#define LEFT_KEY								0XA8
#define RIGHT_KEY								0xCD//0XD0
...
//P 80 1 R C0 2 L 98 2 UP C0 1 DOWN 80 2 -> P M E R L
    #define POWER_KEY								0x80
	#define MENU_KEY								0XC0	
	#define EXIT_KEY								0x98
	#define LEFT_KEY								0XC0
    ...
    #define POWER_KEY								0XD0//0x80
	#define MENU_KEY								0x80	
	#define EXIT_KEY								0x80//0xD0
	#define LEFT_KEY								0X0A//0xA8
	#define RIGHT_KEY								0xA8//0X0A	
