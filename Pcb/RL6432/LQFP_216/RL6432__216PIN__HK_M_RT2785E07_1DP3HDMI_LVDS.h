...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6432__216PIN__HK_M_RT2785E02_1DP3HDMI_LVDS.h No.0000
// Update Note  :
#if(_PCB_TYPE == _RL6432__216PIN__HK_M_RT2785E07_1DP3HDMI_LVDS)
...
#define _D1_EMBEDDED_DDCRAM_LOCATION      	 	_EDID_TABLE_LOCATION_CODE//_EDID_TABLE_LOCATION_CODE
...
#if(_HDMI2_SUPPORT)&&(_HDMI3_SUPPORT)
#define _INPUT_PORT_SEARCH_PRI_2                _D2_INPUT_PORT//_D1_INPUT_PORT
#define _INPUT_PORT_SEARCH_PRI_3                _D3_INPUT_PORT//_D1_INPUT_PORT
#elif(_HDMI2_SUPPORT)
#define _INPUT_PORT_SEARCH_PRI_2                _D2_INPUT_PORT//_D1_INPUT_PORT
#elif(_HDMI3_SUPPORT)
...
// TX2_HPD_2
#define _PIN_173_OFF_REGION                                (2 & 0x0F) // Page 10-0x1B[2:0]
...
#define   OSD_LED_CONTRL(x)          (MCU_FE0B_PORT53_PIN_REG = x)//_PIN_173,   P5D3o
...
//VGA
//sbit bDDCVGAIICSCL         				    	      =P1^5; // _PIN_73, 
//sbit bDDCVGAIICSDA          					      =P1^6; // _PIN_74,
#define bVGAIICSCL         				    	 (P1_5)//   =P1^5; // _156PIN_PIN_131, 
#define bVGAIICSDA          					  (P1_6)//    	=P1^6; // _156PIN_PIN_132,


//HDMI1
#define bDDC1IICSCL         				    	(P3_2)//      =P3^2; // _PIN_73, 
#define bDDC1IICSDA          					     (P3_3)// =P3^3; // _PIN_74,
...
#define bD3_CONNECT                     (P1_0)//  = P1 ^ 0;                 // _PIN_1,  P1.0
...
#define bD2_HPD                                    (P1_2)//= P1 ^ 2; // _Pin_15, P1.2
#define bD3_HPD                                    (P1_1)//= P1 ^ 1; // _PIN_3, P1.1
...
#if(Project_ID == ID_HUIXIONG_HK2785E02_AUO_M320DVN02_LVDS_QHD_QHD75HZ__20210330)
...
#define LEFT_REG								2
#define RIGHT_REG								3
#elif(Project_ID == ID_DX_HK2785E07_1P3H_AUO_M250HTN01C_FHD165HZ_20210823)||(Project_ID == ID_DX_HK2785E07_1P3H_AUO_M270HTN022_FHD165HZ_20210823)
...
#define bHeadphoneDetect                          (P3_7)//          = P3 ^ 7; //_PIN_94,P3D7
...
#define _MAIN_PAGE_MODEL_NAME              _R__,_T__,_D__,__,_2__,_7__,_8__,_5__
#define _BURNIN_STR_IC_NAME                	  _R__,_T__,_D__,__,_2__,_7__,_8__,_5__
