...
#if 0//(Project_ID == _ID_JS_HK2785E19_MV315QHB_N10_QHD75HZ_EDID_VX3267U_2K_2_20240901)
#define _DEF_PCB_PD_SCALER_VCC_SWTICH				_ON	//PD芯片电源常高,断电操作由拉HPD去进行处理
#endif
#define _MAIN_PAGE_MODEL_NAME               _M__,_o__,_d__,_e__,_l__,__,_COLON__,__,_2__,_5__,_6__,_0__,_H__,_x__,_1__,_4__,_4__,_0__,_V__
#define _BURNIN_STR_IC_NAME                	 _R__,_T__,_D__,_2__,_7__,_8__,_5__
...
#if 0//(_WRITE_EDID_TO_SYSTEM_EEPROM==_ON)
...
//========================================
///////////////
#define _D2_TMDS_BR_SWAP                        _ON// HDMI
#define _D2_TMDS_PN_SWAP                        _ON// HDMI
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
                                                        ...
                                                        PCB_PWM_SETTING();/*ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 25000);*/\
                                                    }\
                                                    else\
                                                    {\
...
//--------------------------------------------------
//EEPROM
#define bSWIIC_SYS_EEPROM_SCL                   	(MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE2A_PORT92_PIN_REG) // _PIN_210, P9.2
#define bSWIIC_SYS_EEPROM_SDA                   	(MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE2B_PORT93_PIN_REG) // _PIN_211, P9.3
...
#if 0//(Project_ID == _ID_JS_HK2785E19_MV315QHB_N10_QHD75HZ_EDID_VX3267U_2K_2_20240901)
#define GET_TYPEC_SWITCH()                      (MCU_FE1E_PORT76_PIN_REG)  // PIN_196
#else
#define GET_TYPEC_SWITCH()                      (MCU_FE1E_PORT76_PIN_REG)  // PIN_196 P7D6  PORT76
#endif
//-----------------------------------------------
...
#define bD1_DP_PIN15_CONNECT                    (MCU_FE27_PORT87_PIN_REG) // PIN_205, P8.7  p
#define bD1_DP_PIN16_CONNECT                    (P1_4)                 // PIN_54, P1.4      de
//sbit bD1_DP_PIN16_CONNECT                              		= P1 ^ 4; // PIN_54, P1.4
#define bD1_DP_PIN17_CONNECT                    (MCU_FE26_PORT86_PIN_REG) // PIN_204, P8.6  n
...
sbit bD2_HPD                              		= P1 ^ 2; // _PIN_15, P1D2
...
#define AD_KEY3                                	(P3_6)//(MCU_FF0B_ADC_A2_CONVERT_RESULT) // _PIN_93

#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
#define PCB_ADKEY3()                            (AD_KEY3)

#if(Project_ID == ID_KAIDI_HK2785E20_MV315QHM_NX0_QHD75HZ_20260319)
...
#define POWER_REG								1//BUYONG
#define MENU_REG								2
#define EXIT_REG								2
#define LEFT_REG								0x80//3
#define RIGHT_REG								2
...
#define MENU_REG								2
#define EXIT_REG								2
#define LEFT_REG								0X80
#define RIGHT_REG								2
#endif



#if 1//(Project_ID == _ID_JS_HK2785E19_MV315QHB_N10_QHD75HZ_EDID_VX3267U_2K_2_20240901)
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE11_PORT61_PIN_REG) //_PIN_169 P9D0
