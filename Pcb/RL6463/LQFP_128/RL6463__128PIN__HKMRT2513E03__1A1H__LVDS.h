...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6463__128PIN__HKMRT2513E03__1A1H__LVDS.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6463__128PIN__HKMRT2513E03__1A1H__LVDS)
...
// Input Port Config //
///////////////////////
//VGA 删掉点不亮hdmi,暂时先不删,暂时查不到原因    已修改 _INPUT_PORT_SEARCH_PRI_0错误
//--------------------------------------------------
// A0 Input Port
//--------------------------------------------------
#if(_VGA1_SUPPORT)
...
//--------------------------------------------------
#if (_VGA1_SUPPORT)//此处出错，导致单HDMI失败
...
#define _LVDS_SPREAD_RANGE                      12//0//5//10
...
//#define bVGAIICSCL         				    	     (_PIN_100_MCU_REG)
//#define bVGAIICSDA          				            (_PIN_101_MCU_REG)
...
#define AD_KEY3                                 (MCU_FF0B_ADC_A2_CONVERT_RESULT) // Pin_44
#define PCB_ADKEY3()                            (AD_KEY3)
#define  bPOWER_KEY                              (1)// Pin_44
#else
#define  bPOWER_KEY                              (_PIN_44_MCU_REG)// Pin_44
#endif

#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
#if (Project_ID == ID_CS_2513E03_GuangGan_FHD60HZ)
//MERLP
#define POWER_KEY								0XA8//0xA8
#define EXIT_KEY								0XD0
#define RIGHT_KEY  								0x80 
#define MENU_KEY 								0XA8
#define LEFT_KEY 								0x00 

#define POWER_REG								1///2
#define EXIT_REG								1
#define RIGHT_REG  								2
#define MENU_REG 								2
#define LEFT_REG 								1
...
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_5__,_1__,_3__,_E__,_0__,_3__
...
#endif // End of #if(_PCB_TYPE == _RL6463__128PIN__HKMRT2513E03__1A1H__LVDS)
