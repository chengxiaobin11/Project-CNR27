...
#if 0//(Project_ID == ID_TZ_HK2313BRE01_FHD_20251011)
#if(TZ_Mode1)
//T2按键
...
#elif 1//(Project_ID == ID_GJ_2313BRE01_1A1H_LVDS_FHD_20250729)//冠佳这个按键太特殊了,需要这样改才行
/*
//G3键--G2 M E对换而来
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
...
#elif(SG2701B08_1||SG2701B08_1_144||SG2381B04_1||SG2381B04_144)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
																	if((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= ((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10)))\
																	{\
																		(ucKeyState) |=_RIGHT_KEY_MASK;\
...
#elif 0//(Project_ID == ID_KJ_2313BRE01_1A1H_LVDS_FHD_20250630)
#if(TestMode2)
//G2键+-对换而来的K3键
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
																if((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= ((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10)))\
