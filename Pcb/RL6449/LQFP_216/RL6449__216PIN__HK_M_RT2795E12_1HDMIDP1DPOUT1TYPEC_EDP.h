...
#define _D1_EMBEDDED_DDCRAM_MAX_SIZE            _EDID_SIZE_384//_EDID_SIZE_256
...
//--------------------------------------------------
#define _PANEL_DPTX_1_1_SPREAD_RANGE            12//0
...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SPREAD_RANGE            12//0
...
#define _VBO_SPREAD_RANGE             12//   15//     3
...
#define _PCB_Type_C_Lan_PWR					(MCU_FE22_PORT82_PIN_REG) // _Pin_180, P8D2
...
#define _PCB_USB_HUB_EN						(MCU_FE2B_PORT93_PIN_REG) // _Pin_197, P9D3
#define _PCB_USB_HUB_ON				1
#define _PCB_USB_HUB_OFF			0
#define PCB_UsbHuB_EN_Swtich(x)				(_PCB_USB_HUB_EN = (x))
...
//#define bD3_CONNECT                             (MCU_FE31_PORTA1_PIN_REG) // PIN_203, PA.1
...
//#define bD3_HPD                                 (P1_0) // _PIN_1, P1.0
...
#define KEY_67_Pin                             	(MCU_FE28_PORT90_PIN_REG) // _PIN_194,  9.0
//#define IO_power                                (MCU_FE28_PORT90_PIN_REG) // _PIN_194,  9.0

#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
//#define bPOWER_KEY                              (P3_0)// _Pin_71 P3.0


#if 0
#define POWER_KEY								0x78//0x80
#define MENU_KEY								0xA8//0x80
#define EXIT_KEY								0//0XD0
#define LEFT_KEY								0XD0//0X0A
#define RIGHT_KEY								0x78//0XA8

#define POWER_REG								1
#define MENU_REG								1//2
#define EXIT_REG								1
#define LEFT_REG								1//2//1
#define RIGHT_REG								2//1

#else
#define POWER_KEY								0x78//0x80
#define MENU_KEY								0x78//0xA8//0x80
#define EXIT_KEY								0XD0//0//0XD0
#define LEFT_KEY								0xA8//0XD0//0X0A
#define RIGHT_KEY								0//0x78//0XA8

#define POWER_REG								1
#define MENU_REG								2//1//2
#define EXIT_REG								1
#define LEFT_REG								1//2//1
#define RIGHT_REG								1//2//1
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)	{\
																					...
																					if(((0x78-10) <= (ucV1)) && ((ucV1) < (0x78+20)))\
																					{\
																						ucKeyState |=_2_KEY_MASK;\
																					}\
																					if(((0x78-10) <= (ucV2)) && ((ucV2) < (0x78+20)))\
																					{\
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                ...
                                                                if((((KeyDefault[0]<10)? 0: KeyDefault[0]-10) <= ((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[0]>237)? 247: KeyDefault[0]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _POWER_KEY_MASK ;\
                                                                }\
                                                                if(KEY_67_Pin == 0)\
...
#if 1
  #define bHeadphoneDetect                      (MCU_FE2A_PORT92_PIN_REG) // _PIN_196, P9D2
...
#else
sbit bPCB_HP_SENSE_DETECT                  		= P3 ^ 0; // _PIN_71, P3.0
...
#define _BURNIN_STR_IC_NAME                	  _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_7__,_9__,_5__,_E__,_1__,_2__
...
#endif // End of #if(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2775E04__1T1DP1H__eDPVB1)
