...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6449__216PIN__HP_HK_M_RTD2795E15__1DP2H__eDPVB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2795E15__1DP2H__eDPVB1)

#define _PCB_DEBUG_DDC                       _DDC3//_DDC2


#define _MAIN_PAGE_MODEL_NAME                _M__,_O__,_D__,_E__,_L__,_COLON__,_R__,_T__,_2__,_7__,_9__,_5__
#define _BURNIN_STR_IC_NAME                	 _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_7__,_7__,_5__,_E__,_0__,_4__




#define _MAIN_FW_VESION               		_V_,_0_,_0_,_1_
...
//  lamp_on
#define _PIN_160_OFF_REGION                            (2 & 0x0F)//       (1 & 0x0F) // Page 10-0x2B[2:0]
...
// CTRL_IR
#define _PIN_194                            (0 & 0x0F)  //  (6 & 0x0F) // Page 10-0x38[2:0]
...
// HDMI_MHL_SEL_2
#define _PIN_197                          (1 & 0x0F)//       (2 & 0x0F) // Page 10-0x3B[2:0]
// 0 ~ 7 (0: P9D3i<I>, 1: P9D3o<PP>, 2: P9D3o<OD>, 3: tcon[4], 4: test4b_out0
//        5: test4b_out1, 6:test4b_out2, 7:test4b_out3)

// HDMI_CABLE_DETECT_3
#define _PIN_198                            (2 & 0x0F)//    (0 & 0x0F) // Page 10-0x3C[2:0]
...
//NC
#define _PIN_202                              (1 & 0x0F)//   (2 & 0x0F) // Page 10-0x40[2:0]
...
#define bD3_CONNECT                         	(MCU_FE2C_PORT94_PIN_REG) // PIN_198, P9.4   (MCU_FE31_PORTA1_PIN_REG)//   
...
#define LED_HIGH                   1
#define LED_LOW                    0
sbit bK1                                	= P1 ^ 2; //_PIN_65  DDCSCL_VGA
...
#define POWER_KEY							0x00//	0xF8
#define MENU_KEY							0xc8//	0x80
#define EXIT_KEY							0xc8//	0xA8
#define LEFT_KEY							0x78//	0x80	
#define RIGHT_KEY							0x00//	0xA8	
...
#define bPOWER_KEY                            (P1_4) // P1D4 	Pin_67
...
#endif // End of #if(_PCB_TYPE == _RL6449__216PIN__HP_HK_M_RTD2795E15__1DP2H__eDPVB1)
///////////////////
