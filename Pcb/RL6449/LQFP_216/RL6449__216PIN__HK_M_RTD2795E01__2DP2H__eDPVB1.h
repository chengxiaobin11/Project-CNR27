...
//--------------------------------------------------
#if 0//(_PANEL_TYPE	== _AUO_M250HAN03_5_FHD300HZ)
...
#if(Project_ID == ID_DX_HK2795E01_2P2H_M315DVR01_3_8LANHBR_QHD165HZ_20230906)||(Project_ID == ID_DX_HK2795E01_2P2H_M315DVR01_9_4LANHBR2_QHD165HZ_20230913)
#define _PIN_65                                 (1 & 0x0F) // Page 10-0x02[2:0]
#define _PIN_66                                 (1 & 0x0F) // Page 10-0x03[2:0]
#elif(Project_ID == ID_DX_HK2795E01_2P2H_LQ270T1JG08_4LANHBR2_QHD165HZ_20230913)||(Project_ID == ID_DX_HK2795E01_2P2H_LQ270T1JG08_4LANHBR2_QHD165HZ_20230922)
#define _PIN_65                                 (1 & 0x0F) // Page 10-0x02[2:0]
...
//////////////////////
#if 1//
#define dx_Led_SDA						(P1_3)	// 156PIN_PIN_66, P1.3

#define Led_ClrLedSDA()				(dx_Led_SDA = 0)
#define Led_SetLedSDA()				(dx_Led_SDA = 1)


sbit bLED_SCL_CONTROLS                       = P1 ^ 2; // 156PIN_PIN_131, P1.2
...
//0xD0  1    -> 无用
#if(Project_ID == ID_DX_HK2795E01_2P2H_M315DVR01_3_8LANHBR_QHD165HZ_20230906)
#define POWER_KEY								0
...
#if(LEFT_KEY == 0xD0 || LEFT_KEY == 0xF8)
...
#elif(RIGHT_KEY == 0xD0 || RIGHT_KEY == 0xF8)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= ((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
...
#elif(EXIT_REG == 0xD0 || EXIT_REG == 0xF8)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= ((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10)))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
...
#define _MAIN_PAGE_MODEL_NAME                 _M__,_O__,_D__,_E__,_L__,_COLON__,_V__,_3__,_2__,_1__,_5__,_U__
#else
