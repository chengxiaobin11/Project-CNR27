#if(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2795E16__2DP2H__eDPVB1)
...
#define _DFM_HDMI1_PORT							_D3_INPUT_PORT
#define _DFM_HDMI2_PORT							_D2_INPUT_PORT
#define _DFM_DP1_PORT							_D1_INPUT_PORT
#define _DFM_DP2_PORT							_D0_INPUT_PORT
...
#define _PANEL_DPTX_1_1_LANE_SWAP               _ENABLE//_DISABLE
...
#if 0//(Project_ID == ID_JIASHI_HK2795E15_ME270QHB_NF0_8LANHBR2_QHD170HZ_EDID_VX2723_2K_PRO_20240311)
...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SPREAD_RANGE            10
...
#define _PANEL_DPTX_1_2_LANE_PN_SWAP            _ENABLE//_DISABLE
...
#define _PWM2_RST_BY_DVS                        _OFF//_ON
...
#else
#define _SW_IIC_SUPPORT                         _OFF//_ON
#endif
#define _SW_IIC_CLK_DIV                         _DIV_1

#define _HW_IIC_SUPPORT                         _ON//_OFF
...
#define _PCB_SYS_EEPROM_IIC                     _HW_IIC_PIN_210_211//_SW_IIC_PIN_GPIO//_HW_IIC_PIN_210_211
...
//-----------------------------------------------
#define bLOWPOWERCONTROL						(_FALSE)//(MCU_FE28_PORT90_PIN_REG) // Pin_194, P9.0
...
#define bD3_HPD                                 (P1_0) // _PIN_14, P1.1
...
//--------------------------------------------------
#if(_HDMI_24C02_SUPPORT)
#define bSWIIC_SYS_EEPROM_SCL                   (MCU_FE37_PORTA7_PIN_REG) // _PIN_210, PA.7
#define bSWIIC_SYS_EEPROM_SDA                   (MCU_FE38_PORTB0_PIN_REG) // _PIN_211, PB.0

//HDMI2
#define bDDC2IICSCL         				    (MCU_FE39_PORTB1_PIN_REG) //PIN_212, PB.1  
#define bDDC2IICSDA          					(MCU_FE3A_PORTB2_PIN_REG) //PIN_213, PB.2  

//HDMI3
#define bDDC3IICSCL         				    (MCU_FE3B_PORTB3_PIN_REG) //PIN_214, PB.3  
#define bDDC3IICSDA          					(MCU_FE3C_PORTB4_PIN_REG) //PIN_215, PB.4  
...
// Macro of LED On/Off
//--------------------------------------------------
#if 0//(_DEF_LED_COLOR_OPPOSITE)
#define bLED1                                   (MCU_FE24_PORT84_PIN_REG) // _PIN_184, P8D4
#define bLED2                                   (MCU_FE29_PORT91_PIN_REG) // _PIN_195, P9.1
#else
#define bLED1                                   (MCU_FE29_PORT91_PIN_REG) // _PIN_195, P9.1
#define bLED2                                   (MCU_FE24_PORT84_PIN_REG) // _PIN_184, P8D4
#endif
...
#define bPCBAUDIOSD                                     (_FALSE)

#define _AUDIO_SD_ENABLE                        0       // Audio Power off state
#define _AUDIO_SD_DISABLE                       1       // Audio Power on state

#define PCB_AUDIO_SD(x)                         {\
                                                }


//-----------------------------------------------
// Macro of Headphone Audio Amp High/Low

#define bPCBHPMUTECONTROL                      (MCU_EMPTY_PIN_ASSIGN_ADDRESS) 

#define _HP_MUTE_ON                            0       // Amp Mute on state no audio
#define _HP_MUTE_OFF                           1       // Amp Mute off state

#define PCB_HP_MUTE(x)                         {\
                                                    bPCBHPMUTECONTROL = x;\
                                               }

#define PCB_HP_MUTE_ON()                       (bPCBHPMUTECONTROL == _HP_MUTE_ON)
//-----------------------------------------------
...
//-----------------------------------------------
#define bPCB_HP_SENSE_DETECT                  (P3_0) //_PIN_71, P3.0    
...
#if 0
#define PCB_Headphones_CONNECTED				(MCU_FE2F_PORT97_PIN_REG) // Pin_197, P9.7
#define PCB_HEADP_CON_SET()						{\
													if(PCB_Headphones_CONNECTED == 0)\
                                                    PCB_Headphones_CONNECTED = 1;\
                                               }


#define PCB_HEADP_CON_CLE()						{\
													if(PCB_Headphones_CONNECTED == 1)\
                                                    PCB_Headphones_CONNECTED = 0;\
                                               }
...
//-----------------------------------------------
#define _USB_DETECTED                                                   0
#define _USB_UNDETECTED                                               1

#define PCB_USB_DETECT()                        (_FALSE)//(MCU_FE22_PORT82_PIN_REG)  // Pin_180, P8.2

#define bPCBUSBPOWERCONTROL                    (_FALSE)
...
#define PCB_USB_POWER_ON()                  (bPCBUSBPOWERCONTROL == _USB_POWER_ON)
#define PCB_USB_POWER_OFF()                  (bPCBUSBPOWERCONTROL == _USB_POWER_OFF)
...
//-----------------------------------------------
//#define bMPRT_CURRENT_CONTROL                            (MCU_FE01_PORT41_PIN_REG)	// Pin_96, P4.1
#define bMPRT_CURRENT_CONTROL                            (MCU_FE12_PORT62_PIN_REG)	// Pin_151, P6.2
...
#define bMPRT_CONTROL                            (MCU_FE20_PORT80_PIN_REG)	// Pin_166, P8.0
...
#define _PIN166_MPRT_TCON8				5		// TCON8
#define _PIN166_GPIO_PP					1		// IO
...
#endif // End of #if(_PCB_TYPE == _RL6449_SM2795E16_2H2DP_EDP)
