...
#define _AUDIO_VOLUMN_PWM                         		 _PWM0
#define _AUDIO_VOLUMN_PWM_INVERSE                		  _ON
...
// DDR_PW_EN
#define _PIN_200                                (3 & 0x0F) // Page 10-0x3E[2:0]
...
//--------------------------------------------------
#define bUSBPOWER                         (MCU_FE30_PORTA0_PIN_REG) // Pin_202, P9.2
...
#define MENU_KEY								0xD0
#define EXIT_KEY								0X38
#define RIGHT_KEY 								0X78 
#define LEFT_KEY								0x38  
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE1B_PORT73_PIN_REG ) // _PIN_160 P7.3 
...
#define PCB_MPRT_TCON_PIN_SHARE_CONFIG(x)       {\
													if(x == _ON)\
													{\
														ScalerSetByte(0X1039, (BYTE)(5));\
													}\
													else\
													{\
														ScalerSetByte(0X1039, (BYTE)(1));\
														(MCU_FE29_PORT91_PIN_REG =1);\
													}\
												}
...
#define _MAIN_PAGE_MODEL_NAME                 _M__,_O__,_D__,_E__,_L__,__,_COLON__,__,_H__,_i__,_k__,_e__,_e__,_n__,_9__,_5__
#define _BURNIN_STR_IC_NAME                	  _H_+,_i__,_k__,_e__,_e__,_n__,_9__,_5__
