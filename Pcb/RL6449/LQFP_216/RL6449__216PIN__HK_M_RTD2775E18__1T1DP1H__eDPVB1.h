...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6449__216PIN__HK_M_RTD2775E04__1T1DP1H__eDPVB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define _D0_DP_MAIN_LINK_LANES                  _DP_FOUR_LANE//_DP_TWO_LANE
...
#define _PANEL_DPTX_1_2_LANE_PN_SWAP            _DISABLE//_ENABLE 2775系列
...
#define _TYPE_C_VCC_POWER									(MCU_FE27_PORT87_PIN_REG)	//_PIN_193 		P8D7

#define _TYPE_C_POWER_ON                      1
#define _TYPE_C_POWER_OFF                	  0


#define _TYPE_C_VCC_POWER_SWTICH(x)                            (_TYPE_C_VCC_POWER = (x))

#define _TYPE_C_VCC_POWER_ON()					{\
                                                    if(_TYPE_C_VCC_POWER == _TYPE_C_POWER_OFF)\
                                                    {\
														_TYPE_C_VCC_POWER_SWTICH(_USB_HUB_ON)	;\
                                                    }\
                                                }

#define _TYPE_C_VCC_POWER_OFF()				{\
                                                    if(_TYPE_C_VCC_POWER == _TYPE_C_POWER_ON)\
                                                    {\
														_TYPE_C_VCC_POWER_SWTICH(_TYPE_C_POWER_OFF)	;\
                                                    }\
                                                }
...
#define bD3_CONNECT                             (MCU_FE2C_PORT94_PIN_REG)//198 94 (MCU_FE31_PORTA1_PIN_REG) // PIN_203, PA.1
...
#define bLED1                                (MCU_FE24_PORT84_PIN_REG) // _PIN_184, P8D4/// (MCU_FE13_PORT63_PIN_REG) //P6D3o (MCU_FE24_PORT84_PIN_REG) // _PIN_184, P8D4
#define bLED2                               (MCU_FE29_PORT91_PIN_REG) // _PIN_195,  P9D1 // (MCU_FE1C_PORT74_PIN_REG) //P7D4o (MCU_FE29_PORT91_PIN_REG) // _PIN_195,  P9D1
...
#define IO_power                               	(P1_4)// 67 1.4//(MCU_FE28_PORT90_PIN_REG) //_PIN_194,  9.0

#define PCB_ADKEY1()                            (AD_KEY1)
#define PCB_ADKEY2()                            (AD_KEY2)
//#define bPOWER_KEY                              (P3_0)// Pin_71 P3.0

#if 1//(Project_ID == ID_HHT_2795E06_1T1P1H_M280DCA_E3B_20210330)

//1.实际按键功能：开关/上/下/返回/菜单     改成：菜单/上/下/返回/开关
//嘉视
...
#define _BURNIN_STR_IC_NAME                	  _H__,_K__,_DOT__,_M__,_DOT__,_R__,_T__,_2__,_7__,_9__,_5__,_E__,_0__,_6__
