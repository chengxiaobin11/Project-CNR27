...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SPREAD_RANGE           0// 12
...
// PWM_R
#define _PIN_201                               (1 & 0x0F) // (2 & 0x0F) // Page 10-0x3F[2:0]
...
//-----------------------------------------------
#define _TYPEC_Power								(MCU_FE27_PORT87_PIN_REG)

#define PCB_USB_HUB_POWER(x)                            (_TYPEC_Power = x)//193 										


#define _TYPEC_Power_ON                      1
#define _TYPEC_Power_OFF                0
...
#define PCB_GPIO_SETTING_POWER_NORMAL()         {\
													PCB_USB_HUB_POWER(_TYPEC_Power_ON);\
												}
...
#define PCB_GPIO_SETTING_POWER_DOWN()            {\
													OSD_LED_CONTRL(_OSD_LED_OFF);\
												 PCB_USB_HUB_POWER(_TYPEC_Power_OFF);\
												 }


#define  	_OSD_LED_ON        1//0
#define  	_OSD_LED_OFF       0//1
...
#if 1//(_LED_EFFECT==_LED_TJ)||(_LED_EFFECT==_LED_TJ_23G7)||(_LED_EFFECT==_LED_TJ_G2G6G7)||(_LED_EFFECT==_LED_DX)
...
//-----------------------------------------------
#if(_HDMI_24C02_SUPPORT)
#define bEDID_WRITE_PROTECT                     (MCU_FE23_PORT83_PIN_REG) // _PIN_181, P8.3
#else
...
#define GET_TYPEC_SWITCH()                  	(MCU_FE2A_PORT92_PIN_REG)//(bTypeCDetect)   
...
#define bPOWER_KEY                              (P3_0)//   Pin_67 P3.0
