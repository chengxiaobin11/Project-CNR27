...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : _RL6449__216PIN__HK_M_RTD2795E21__2DP2H__eDPVB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2795E21__2DP2H__eDPVB1)
...
#define _VBO_SPREAD_RANGE                  10//0//     3
...
// MHL_DETECT_3
#define _PIN_203                                (1 & 0x0F) // Page 10-0x41[2:0]   //0630
...
#if(_IR_VIRTUAL)	
#define IR_STATUS                  (MCU_FE28_PORT90_PIN_REG)//_PIN_194,   P9D0
#endif

//-----------------------------------------------
// Macro of Pcb GPIO Inital Setting
//-----------------------------------------------
#if 0//(Project_ID == ID_HANGJIA_HK2795E21_2H2DP_BOE_DV430QUB_VBY_UHD60HZ_20250630)


#define PCB_ON_REGION_GPIO_SETTING_POWER_AC_ON(){\
                                                    PCB_AMP_MUTE(_AMP_MUTE_ON);\				
                                                    MCU_FE2D_PORT95_PIN_REG = 0;\						
                                                    PCB_PSON_EN(_PS_ON_EN);\	
                                                }
...
//-----------------------------------------------
// Macro of pson Poewr Control
//-----------------------------------------------
#define bPSON                               (MCU_FE31_PORTA1_PIN_REG) // _PIN_203,P9D9i

#define _PS_ON_EN                           1
#define _PS_OFF_EN                          0

#define PCB_PSON_EN(x)                        	{\
                                                    bPSON = (x);\
                                                }
//-----------------------------------------------
...
#define POWER_KEY								0x00//0xA8
#define MENU_KEY								0x80
#define EXIT_KEY								0xF8
#define LEFT_KEY								0
#define RIGHT_KEY								0
...
#define _AMP_MUTE_ON                          	0//1
#define _AMP_MUTE_OFF               			1//0
...
#endif // End of #if(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2795E21__2DP2H__eDPVB1)
///////////////////
