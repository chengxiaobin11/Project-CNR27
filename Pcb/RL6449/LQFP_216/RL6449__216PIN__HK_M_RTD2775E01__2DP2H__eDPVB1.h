...
//#define _DP_MST_AUTO_SEARCH_SUPPORT                             _ON //MST菊花链功能  UserInterfaceGetDpMSTCapablePort
//#define _DP_TX_BLOCK_CONTROL_BEFORE_STREAM_OUTPUT               _OFF//_ON
//#define _PCB_DP_OUT_ENABLE										_ON	//PCB DP OUT配置  SysModeHandler
...
//-----------------------------------------------
#if _IR_VIRTUAL
#define IR_STATUS                  (P1_2|P1_3)//DDCSCL_VGA,DDCSDA_VGA
...
#if 1//(POWER_KEY == 0xD0 || POWER_KEY == 0xF8)
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if(KeyDefault[9]==3 ? (KEY3_KEY == _DISABLE) : ((((KeyDefault[4]<10)? 0: KeyDefault[4]-10) <= ((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[9]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[4]>237)? 247: KeyDefault[4]+10))))\
                                                                {\
                                                                    (ucKeyState) |= _LEFT_KEY_MASK ;\
                                                                }\
                                                                if(KeyDefault[8]==3 ? (KEY3_KEY == _DISABLE) : ((((KeyDefault[3]<10)? 0: KeyDefault[3]-10) <= ((KeyDefault[8]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[8]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[3]>237)? 247: KeyDefault[3]+10))))\
                                                                {\
                                                                    (ucKeyState) |= _RIGHT_KEY_MASK ;\
                                                                }\                                                             
                                                                if(KeyDefault[7]==3 ? (KEY3_KEY == _DISABLE) :((((KeyDefault[2]<10)? 0: KeyDefault[2]-10) <= ((KeyDefault[7]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[7]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[2]>237)? 247: KeyDefault[2]+10))))\
                                                                {\
																	(ucKeyState) |= _EXIT_KEY_MASK ;\
                                                                }\                                                 
                                                                if(KeyDefault[6]==3 ? (KEY3_KEY == _DISABLE) :((((KeyDefault[1]<10)? 0: KeyDefault[1]-10) <= ((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[6]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[1]>237)? 247: KeyDefault[1]+10))))\
                                                                {\
                                                                    (ucKeyState) |= _MENU_KEY_MASK ;\
                                                                }\
																if(KeyDefault[5]==3 ? (KEY3_KEY == _DISABLE) :((((KeyDefault[0]<10)? 0: KeyDefault[0]-10) <= ((KeyDefault[5]==1)? AD_KEY1 : AD_KEY2)) && (((KeyDefault[5]==1)? AD_KEY1 : AD_KEY2) < ((KeyDefault[0]>237)? 247: KeyDefault[0]+10))))\
                                                                {\
...
#endif
#define _PCB_MBR_TCON_PIN                       _TCON7
