...
#if((_DIGITAL_AUDIO_OUTPUT_ADJUST_VOLUME_SUPPORT == _OFF) && (_DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT == _OFF))
    // Set IIS Input
...
#if((_DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT == _ON) && (_DIGITAL_AUDIO_OUTPUT_ADJUST_VOLUME_SUPPORT == _OFF) && (_EMBEDDED_DAC_SUPPORT == _OFF))
    // Initial DVC gain = 0x3FFF
    ScalerAudioDVCAdjustVolume(0x3FFF);
#else
    // Initial DVC gain = 0
...
#if((_DIGITAL_AUDIO_OUTPUT_ADJUST_VOLUME_SUPPORT == _ON) || (_DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT == _ON) || (_AUDIO_TTS_SUPPORT_TYPE == _AUDIO_TTS_EMBEDDED_TYPE))
#if(_LINE_IN_SUPPORT == _OFF)
...
#endif // End of #if((_DIGITAL_AUDIO_OUTPUT_ADJUST_VOLUME_SUPPORT == _ON) || (_DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT == _ON) || (_AUDIO_TTS_SUPPORT_TYPE == _AUDIO_TTS_EMBEDDED_TYPE))

#if(_DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT == _OFF)
    // Disable I2S Output Swap LR channel
    ScalerSetBit(P6_E7_AD_I2S_CTRL, ~_BIT6, _HW_AUDIO_I2S_LR_NO_SWAP);
#else
    // Enable I2S Output Swap LR channel
    ScalerSetBit(P6_E7_AD_I2S_CTRL, ~_BIT6, _HW_AUDIO_I2S_LR_SWAP);
#endif
}
