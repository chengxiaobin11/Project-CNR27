...
#if(_LINE_IN_POWER_DYNAMIC_MANAGE_SUPPORT == _ON)
        // ADCFE Mute for AIN
        ScalerSetBit(P6_B2_REG_ADC_CTRL2, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));

        // Power Down ADC/ADCFE Power
...
#if(_LINE_IN_POWER_DYNAMIC_MANAGE_SUPPORT == _ON)
        // Power On ADC/ADCFE Power
        ScalerSetBit(P6_B0_REG_ADC_POWER, ~(_BIT4 | _BIT3), (_BIT4 | _BIT3));
    ...
    if(GET_D0_DIGITAL_AUDIO_SOURCE() == _DIGITAL_AUDIO_SOURCE_HDMI)
    {
        ...
        if(ScalerGetBit(P2_CB_HDMI_SR, (_BIT2 | _BIT1)) != 0x00)
        {
            ...
            if(ScalerGetDataPortBit(P2_C9_HDMI_AP, _P2_CA_PT_31_PORT_PAGE2_HDMI_WDCR0, (_BIT2 | _BIT1)) == 0x00)
            {
                ...
                ScalerSetBit(P2_CB_HDMI_SR, ~(_BIT7 | _BIT5 | _BIT2 | _BIT1), (_BIT2 | _BIT1));
...
void ScalerAudioD0InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        {
            // HDMI MAC W/O DVC Gain Control
            ScalerSetDataPortBit(P2_C9_HDMI_AP, _P2_CA_PT_07_PORT_PAGE2_HDMI_MAG_M_FINAL, ~_BIT2, 0x00);
        ...
        else
        {
            ...
            ScalerSetDataPortBit(P2_C9_HDMI_AP, _P2_CA_PT_07_PORT_PAGE2_HDMI_MAG_M_FINAL, ~_BIT2, _BIT2);
...
void ScalerAudioD0DPAudioInitial(void)
{
    ...
    // Enable SPDIF Output
    ScalerSetBit(PB6_A9_SPDIF_TX_0, ~_BIT0, _BIT0);
