...
EnumDpVersionType ScalerDpRxGetDpVersion(BYTE ucInputPort);
...
// Input Value  : ucInputPort
// Output Value : EnumDpVersionType
//--------------------------------------------------
EnumDpVersionType ScalerDpRxGetDpVersion(BYTE ucInputPort)
{
    switch(ucInputPort)
    {
        ...
        case _D0_INPUT_PORT:
        case _D1_INPUT_PORT:
            return GET_DP_RX_D0_PORT_TARGET_VERSION();
#endif

        default:
            return _DP_VERSION_1_0;
    }
}
...
void ScalerDpRxHdrSupportSwitch(BYTE ucInputPort, EnumDpHdrSupport enumDpHdrSupport)
{
    switch(ucInputPort)
    {
        ...
        case _D0_INPUT_PORT:
            ...
            if(GET_DP_HDR_D0_SUPPORT() != enumDpHdrSupport)
            {
                SET_DP_RX_CAPABILITY_SWITCHED();
        ...
        case _D1_INPUT_PORT:
            ...
            if(GET_DP_HDR_D1_SUPPORT() != enumDpHdrSupport)
            {
                SET_DP_RX_CAPABILITY_SWITCHED();
