...
void ScalerSyncHdcpEnableDownLoadKey(bit bEnable)
{
    if(bEnable == _ENABLE)
    {
        ...
        ScalerSetBit(P2_A9_TMDS_ABC0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT2), 0x00);
        ...
        ScalerSetBit(P2_C2_HDCP_PCR, ~(_BIT7 | _BIT6 | _BIT4), (_BIT7 | _BIT6));
    }
    else if(bEnable == _DISABLE)
    {
        ...
        ScalerSetBit(P2_A9_TMDS_ABC0, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT2), _BIT4);
