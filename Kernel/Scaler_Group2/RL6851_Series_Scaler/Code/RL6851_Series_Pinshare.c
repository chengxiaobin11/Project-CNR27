    ...
    switch(enumConfigPin)
    {
        ...
        case _CONFIG_PIN_35:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM1_PP:
                    ScalerSetByte(P10_03_PIN_SHARE_CTRL03__ON2, _PIN_35_PWM1_PP);
                    break;
        ...
        case _CONFIG_PIN_63:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM0_PP:
                    ScalerSetByte(P10_1A_PIN_SHARE_CTRL1A__ON2, _PIN_63_PWM0_PP);
                    break;
        ...
        case _CONFIG_PIN_64:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM2_PP:
                    ScalerSetByte(P10_1B_PIN_SHARE_CTRL1B__ON2, _PIN_64_PWM2_PP);
                    break;
        ...
        case _CONFIG_PIN_92:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM3_PP:
                    ScalerSetByte(P10_2A_PIN_SHARE_CTRL2A__ON1, _PIN_92_PWM3_PP);
                    break;

                case _TCON_7:
                    ScalerSetByte(P10_2A_PIN_SHARE_CTRL2A__ON1, _PIN_92_TCON7);
                    break;
        ...
        case _CONFIG_PIN_93:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM2_PP:
                    ScalerSetByte(P10_2B_PIN_SHARE_CTRL2B__ON1, _PIN_93_PWM2_PP);
                    break;

                case _TCON_8:
                    ScalerSetByte(P10_2B_PIN_SHARE_CTRL2B__ON1, _PIN_93_TCON8);
                    break;
        ...
        case _CONFIG_PIN_94:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM1_PP:
                    ScalerSetByte(P10_2C_PIN_SHARE_CTRL2C__ON1, _PIN_94_PWM1_PP);
                    break;
        ...
        case _CONFIG_PIN_108:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM3_PP:
                    ScalerSetByte(P10_34_PIN_SHARE_CTRL34__ON1, _PIN_108_PWM3_PP);
                    break;
