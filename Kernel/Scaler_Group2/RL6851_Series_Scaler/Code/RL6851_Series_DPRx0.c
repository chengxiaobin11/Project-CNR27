...
void ScalerDpRx0DpcdInitial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort, EnumFreeSyncSupport enumFreeSyncSupport, EnumDpHdrSupport enumDpHdrSupport);
...
void ScalerDpRx0AuxPowerOnInitial(void)
{
    ...
    ScalerSetBit(PB7_C6_AUX_PHY_DIG2, ~(_BIT6 | _BIT4), 0x00);
    ...
    ScalerSetBit(PB7_DB_AUX_STATUS, ~(_BIT6 | _BIT5 | _BIT4), _BIT4);
    ScalerSetBit(PB7_76_AUX_DIG_PHY6, ~(_BIT7 | _BIT6), _BIT6);

    // Disable other DPCD, Aux Timeout, Receiving Aux INT.
    ScalerSetBit(PB7_DC_AUX_IRQ_STATUS, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);

    // Disable Aux Phy Int
    ScalerSetBit(PB7_77_AUX_DIG_PHY7, ~(_BIT7 | _BIT6), 0x00);

    // Aux Ack Timer.
    ScalerSetBit(PB7_F0_AUX_TX_TIMER, ~(_BIT6 | _BIT5 | _BIT2 | _BIT1), (_BIT5 | _BIT2));
    ...
    ScalerSetBit(PB7_79_AUX_DIG_PHY9, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1 | _BIT0), _BIT7);
...
void ScalerDpRx0AuxIntInitial(void)
{
    ...
    ScalerSetBit(PB7_A5_AUX_HDCP_IRQ2, ~(_BIT3 | _BIT2), _BIT2);

    // Enable Write AKSV int
    ScalerSetBit(PB7_A5_AUX_HDCP_IRQ2, ~(_BIT6 | _BIT3 | _BIT2), _BIT6);
...
void ScalerDpRx0DpcdInitial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort, EnumFreeSyncSupport enumFreeSyncSupport, EnumDpHdrSupport enumDpHdrSupport)
{
    ...
    enumDpHdrSupport = enumDpHdrSupport;
...
void ScalerDpRx0RebuildPhy(BYTE ucDpLinkRate, BYTE ucDpcdLane)
{
    ...
    ScalerSetBit(PB_06_DECODE_10B8B_ERROR, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1 | _BIT0), GET_DP_RX0_PCB_LANE3_PN_SWAP() << 7);
    ScalerSetBit(PB_06_DECODE_10B8B_ERROR, ~(_BIT6 | _BIT3 | _BIT2 | _BIT1 | _BIT0), GET_DP_RX0_PCB_LANE2_PN_SWAP() << 6);
    ScalerSetBit(PB_06_DECODE_10B8B_ERROR, ~(_BIT5 | _BIT3 | _BIT2 | _BIT1 | _BIT0), GET_DP_RX0_PCB_LANE1_PN_SWAP() << 5);
    ScalerSetBit(PB_06_DECODE_10B8B_ERROR, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), GET_DP_RX0_PCB_LANE0_PN_SWAP() << 4);
    ...
    ScalerSetBit(PB_AB_SDM_04, ~(_BIT5 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
               ...
               (ScalerDpRx0DecodeCheck() == _TRUE))
            {
                ...
                */
                ...
                if(GET_DP_RX0_NORMAL_LINK_TRAINING_SETPHY_FINISH() == _TRUE)
                {
                    ...
                    ScalerSyncDpSecDataResetProc(GET_DP_EMBEDDED_SWITCH_SELECT());
