        ...
        case _AUDIO_FROM_D1_PORT:
            ...
            else
            {
                   ...
                   ((ScalerGetBit(PB6_3B_DP_IRQ_CTRL1, _BIT0) == 0x00) && (ScalerGetBit(PB6_36_DP_GLB_STATUS, _BIT2) == _BIT2)))
                {
                    ...
                    ScalerSetBit(PB6_36_DP_GLB_STATUS, ~(_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2), _BIT2);
...
void ScalerAudioADCInitial(void)
{
    ...
    // Set AD Gail of L Ch
    ScalerSetBit(P6_B8_AD_GAIN_L, ~(_BIT7 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_LINE_IN_BOOST_GAIN_DB & 0x3F));

    // Set AD Gail of R Ch
    ScalerSetBit(P6_B9_AD_GAIN_R, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_LINE_IN_BOOST_GAIN_DB & 0x3F));
