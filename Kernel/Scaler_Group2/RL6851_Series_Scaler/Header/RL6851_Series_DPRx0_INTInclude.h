...
extern void ScalerDpRx0RebuildPhy_WDINT(EnumScalerWDTimerEventID enumEventID);
extern void ScalerDpRx0RebuildPhyPart1_WDINT(BYTE ucIcp);
extern void ScalerDpRx0RebuildPhyPart2_WDINT(BYTE ucIcp);
extern void ScalerDpRx0RebuildPhyPart3_WDINT(BYTE ucIcp);
extern void ScalerDpRx0RebuildPhyPart4_WDINT(BYTE ucIcp);
#else
