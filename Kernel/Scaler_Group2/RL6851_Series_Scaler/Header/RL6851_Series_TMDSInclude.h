...
//--------------------------------------------------
// Macro of HDCP1.4 BCH Error Check State
//--------------------------------------------------
#define GET_TMDS_HDCP14_BCH_CHK_STATE()             (g_enumTMDSHdcp14BchChkState)
#define SET_TMDS_HDCP14_BCH_CHK_STATE(x)            (g_enumTMDSHdcp14BchChkState = (x))
#endif
...
typedef enum
{
    _HDMI_HDCP14_BCH_NONE,
    _HDMI_HDCP14_BCH_AUTH_START,
    _HDMI_HDCP14_BCH_CHK_WINDOW_START,
    _HDMI_HDCP14_BCH_CHK_WINDOW_END,
    _HDMI_HDCP14_BCH_1ST_ACT_ENC_CHK_FAIL,
    _HDMI_HDCP14_BCH_1ST_ACT_ENC_CHK_PASS,
} EnumHdmiHdcp14BchChkState;
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern volatile EnumHdmiHdcp14BchChkState g_enumTMDSHdcp14BchChkState;
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern void ScalerTMDSHdcp14BchErrorCheckEvent(EnumScalerTimerEventID enumEventID);
extern bit ScalerTMDSGetFirstActiveHdcp14BchErrorCheck(BYTE ucInputPort);
extern void ScalerTMDSHdcp14BchErrorCheckReset(BYTE ucInputPort);
#endif
