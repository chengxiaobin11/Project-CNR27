...
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_220M
#elif(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_FHD_120_HZ)
#define _M2PLL_FREQ_SEL_BY_SDRAM_CLK                        _M2PLL_FREQ_220M
...
#undef _DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT
#define _DIGITAL_AUDIO_I2S_OUTPUT_L_R_CHANNEL_SWAP_SUPPORT  _OFF
...
#undef _DP_RX_SST_SPLIT_SDP_SUPPORT
#define _DP_RX_SST_SPLIT_SDP_SUPPORT                        _OFF
...
#undef _DP_IVF_OOR_EXTEND_SUPPORT
...
//--------------------------------------------------
// DP SST SPLIT SDP Option
//--------------------------------------------------
#if((_DP_SUPPORT == _ON) && (_HW_DP_RX_SST_SPLIT_SDP_SUPPORT == _ON) && (_DP_RX_SST_SPLIT_SDP_SUPPORT == _ON))
#define _DP_RX_SST_SPLIT_SDP_DPCD_SUPPORT                   _ON
#else
#define _DP_RX_SST_SPLIT_SDP_DPCD_SUPPORT                   _OFF
#endif
...
// DP VSC SDP Option
//--------------------------------------------------
#if((_DP_SUPPORT == _ON) && (_HW_DP_VSC_SDP_EXT_CAPABILITY_SUPPORT == _ON) && ((_DP_RX_SST_SPLIT_SDP_DPCD_SUPPORT == _ON) || (_DP_ULTRA_HDR_SUPPORT == _ON)))
...
// DP HDR Option
//--------------------------------------------------
#if((_DP_SUPPORT == _ON) && (_DP_HDR10_SUPPORT == _ON) && (_DP_HDR_VENDOR_SUPPORT != _DP_HDR_VENDOR_SUPPORT_NONE) && (_HW_DP_DPCD_HDR_VENDOR_CAP_PHYSICAL_ADDRESS_SUPPORT == _OFF))
#define _DP_AUX_RX_DPCD_HDR_CAP_WILDCARD_SUPPORT            _ON
#else
#define _DP_AUX_RX_DPCD_HDR_CAP_WILDCARD_SUPPORT            _OFF
#endif
...
#define _TYPE_C_EMB_PD_VERSION                              _PD_VERSION_3_2
