...
typedef struct
{
    ...
    WORD usRx0MaxPower;
    WORD usRx0PresentPower;
    WORD usRx0ReportedPower;
    WORD usRx0ReqPower;
    WORD usRx0OutputVol;
...
typedef enum
{
    ...
    _PD_3_2_SPR_ADJUSTABLE_PDO = 0x0E,  // SPR AVS APDO (Only for PD3.2), [31:28] in APDO (4 Bits)
...
typedef enum
{
    ...
    _PD_PORT_CTRL_EVENT_PWR_LV_CHG_EVENT = _BIT8,       // Port Controller Inform System / User of Power Level Change Event Occurred
}EnumPDPortCtrlEvent;
...
typedef struct
{
    ...
    WORD usSprAvs15VMaxCurrent;  // Unit =  10mA
    WORD usSprAvs20VMaxCurrent;  // Unit =  10mA
}StructTypeCUserPDO;
...
//--------------------------------------------------
// Definitions of DP Source Write 600h Status
//--------------------------------------------------
typedef enum
{
    _DP_SOURCE_WRITE_POWER_STATUS_EVENT_NONE,
    _DP_SOURCE_WRITE_POWER_STATUS_EVENT_TRIGGERED,
    _DP_SOURCE_WRITE_POWER_STATUS_EVENT_TIMER_ACTIVE,
} EnumDpSourceWritePowerStatusEvent;
...
typedef struct
{
    ...
    BYTE b1DPTXFREESYNDOWNSTREAMMSAIGNORE : 1;
...
typedef struct
{
    EnumDpHdrSupport enumDpD0HdrSupport;
    EnumDpHdrSupport enumDpD1HdrSupport;
    EnumDpHdrSupport enumDpD2HdrSupport;
    EnumDpHdrSupport enumDpD6HdrSupport;

    BYTE b1DpD0CapabilitySwitch : 1;
    BYTE b1DpD1CapabilitySwitch : 1;
    BYTE b1DpD2CapabilitySwitch : 1;
    BYTE b1DpD6CapabilitySwitch : 1;
