...
#warning "_D0_EDID_EXTERNAL_EEPROM_MAX_SIZE should be defined to decide whether to parse External Edid or not!!!"
#endif
...
#warning "_D1_EDID_EXTERNAL_EEPROM_MAX_SIZE should be defined to decide whether to parse External Edid or not!!!"
#endif
...
#warning "_D2_EDID_EXTERNAL_EEPROM_MAX_SIZE should be defined to decide whether to parse External Edid or not!!!"
#endif
...
#warning "_D3_EDID_EXTERNAL_EEPROM_MAX_SIZE should be defined to decide whether to parse External Edid or not!!!"
#endif
...
#warning "_D4_EDID_EXTERNAL_EEPROM_MAX_SIZE should be defined to decide whether to parse External Edid or not!!!"
#endif

#endif
#endif

#ifdef _D5_INPUT_PORT_TYPE
#if(_D5_INPUT_PORT_TYPE == _D5_HDMI_PORT)

#ifndef _D5_EDID_EXTERNAL_EEPROM_MAX_SIZE
#warning "_D5_EDID_EXTERNAL_EEPROM_MAX_SIZE should be defined to decide whether to parse External Edid or not!!!"
#endif
