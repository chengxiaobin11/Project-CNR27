...
#warning " _GLOBAL_DIMMING_ONLINE_CALIBRATION_SUPPORT Should be _OFF!!!"
#endif
#if(_GLOBAL_DIMMING_DARK_MODE_SUPPORT == _ON)
#warning " _GLOBAL_DIMMING_DARK_MODE_SUPPORT Should be _OFF!!!"
#endif
#if(_GLOBAL_DIMMING_HDR_FINE_TUNE_MODE_SUPPORT == _ON)
#warning " _GLOBAL_DIMMING_HDR_FINE_TUNE_MODE_SUPPORT Should be _OFF!!!"
#endif
#endif
...
#if((_SCALER_TYPE == _RL6369_SERIES) || (_SCALER_TYPE == _RL6410_SERIES) || (_SCALER_TYPE == _RL6449_SERIES) || (_SCALER_TYPE == _RL6463_SERIES) || (_SCALER_TYPE == _RL6492_SERIES))
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
#warning "_HDMI_HDCP14_BCH_ERROR_CHECK is not supported!!!"
#endif
#endif
...
#if(_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX == _MULTIPANEL_CLOCK_MAX_FHD_144_HZ)
#warning "_MULTIPANEL_ULTRA_HIGH_SPEED_PIXEL_CLOCK_MAX Should Not be _MULTIPANEL_CLOCK_MAX_FHD_144_HZ When _LVDS_ULTRA_HIGH_SPEED_SUPPORT and _PANEL_EXIST_MULTIPANEL is _ON!!!"
#endif
#endif
#endif
#endif
...
//#endif
#if(_INPUTCLOCK_RANG_HDMI > 60000)
#warning "_INPUTCLOCK_RANG_HDMI Should <= 600M !!!"
#endif
#if((_INPUTCLOCK_RANG_DP > 6000) || (_INPUTCLOCK_RANG_USBC > 6000))
#warning "_INPUTCLOCK_RANG_DP and _INPUTCLOCK_RANG_USBC Should <= 600M !!!"
#endif
...
#if(_INPUTCLOCK_RANG_DP > 3500)
#warning "INPUTCLOCK_RANGE_DP Should <= 3500M!!!"
#endif

#if(_INPUTCLOCK_RANG_HDMI > 3400)
#warning "_INPUTCLOCK_RANG_HDMI Should <= 340M!!!"
#endif
...
#if(_DAC_AUDIO_TMDS_FLATLINE_CONTROL == _FLATLINE_TO_ZERO_LEVEL)
#if(_HDMI_HDR10_SUPPORT == _ON)
#warning "_HDMI_HDR10_SUPPORT should not be _ON when _DAC_AUDIO_TMDS_FLATLINE_CONTROL == _FLATLINE_TO_ZERO_LEVEL!!!"
#endif
#endif
#endif
