...
// HW //
////////
//8lane HBR2 最高可支持2680*1481@240hz，超出异常--色深不对
//8lane HBR可以支持2560*1440@180(勉强)


//#define _EMBEDDED_MEMORY_SIZE_CONFIG						   _16M_16BIT_DDR2_1PC//_16M_16BIT_DDR2_1PC
//1ps支持fhd100hz，2ps理论可以支持fhd200
//--------------------------------------------------
...
#define _HW_D0_INPUT_CLOCK_MAX                                  (1055000000)//((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? (725000000) : (600000000)) // Unit: Hz , DP 1.2
#define _HW_D1_INPUT_CLOCK_MAX                                  (1055000000)//((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? (725000000) : (600000000)) // Unit: Hz , DP 1.2
#define _HW_D2_INPUT_CLOCK_MAX                                  6600000000 // Unit: Hz , HDMI2.0 , MHL3.2//hdmi好像没用
#define _HW_D3_INPUT_CLOCK_MAX                                  6600000000 // Unit: Hz , HDMI2.0 , MHL3.2
...
//--------------------------------------------------
// HW DP DPCD HDR Vendor Capability Physical Address (00340h ~ 00359h)
//--------------------------------------------------
#define _HW_DP_DPCD_HDR_VENDOR_CAP_PHYSICAL_ADDRESS_SUPPORT     _OFF
...
//--------------------------------------------------
// HW SST Split SDP Support
//--------------------------------------------------
#define _HW_DP_RX_SST_SPLIT_SDP_SUPPORT                         _OFF
...
//--------------------------------------------------
// HW Audio I2s Output Swap for Through DVC Only
//--------------------------------------------------
#define _HW_AUDIO_I2S_LR_NO_SWAP                                0x00
#define _HW_AUDIO_I2S_LR_SWAP                                   _BIT6
...
//--------------------------------------------------
#define _HW_PD_SUPPORT_VERSION                                  _PD_VERSION_3_2
...
// FW DRR SUPPORT Gen
//--------------------------------------------------
#define _FW_DRR_SUPPORT_GEN_TYPE                                _DRR_SUPPORT_GEN_I
