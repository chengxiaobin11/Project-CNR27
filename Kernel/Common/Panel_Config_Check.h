...
#if 1//(_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON)
#if(_PANEL_PIXEL_CLOCK_MAX_KHZ > 720000)
//#warning "_PANEL_PIXEL_CLOCK_MAX_KHZ > 720M (2 PATH)"
#endif

#if 0//(_PANEL_PIXEL_CLOCK_MAX_KHZ <= 630000)
#warning "_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT Should be _OFF"
#endif
#endif
...
#if(_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON)
#if 0//(_PANEL_PIXEL_CLOCK_MAX_KHZ > 300000)
#warning "_PANEL_PIXEL_CLOCK_MAX_KHZ > 300M"
#endif
...
#if(_GD_DARK_MODE_THD <= _GD_DARK_MODE_MIN)
#warning "_GD_DARK_MODE_MIN Should be less than _GD_DARK_MODE_THD!!!"
#endif
#endif
