...
#define _HW_D0_INPUT_CLOCK_MAX                                  ((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) ? 360000000 : ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? 340000000 : 225000000)) // Unit: Hz , DP1.1 , HDMI1.4(2.25G)
#define _HW_D1_INPUT_CLOCK_MAX                                  ((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) ? 360000000 : ((_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == _ON) ? 340000000 : 225000000)) // Unit: Hz , DP1.1 , HDMI1.4(2.25G)
...
//--------------------------------------------------
#define _HW_DP_DPCD_HDR_VENDOR_CAP_PHYSICAL_ADDRESS_SUPPORT     _ON
...
//--------------------------------------------------
#define _HW_DP_RX_SST_SPLIT_SDP_SUPPORT                         _ON
...
// FW DRR SUPPORT Gen
//--------------------------------------------------
#define _FW_DRR_SUPPORT_GEN_TYPE                                _DRR_SUPPORT_GEN_II
