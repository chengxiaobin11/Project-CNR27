...
#define GET_AUDIO_STATE()                       (g_stAudioInfo.enumAudioState)
#define SET_AUDIO_STATE(x)                      (g_stAudioInfo.enumAudioState = (x))
...
extern bit SysTypeCGetAltModeStatusChange(BYTE ucInputPort);
#endif
extern void SysTypeCSetLocalPowerDetection(void);
