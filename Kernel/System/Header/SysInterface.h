...
extern BYTE SysTypeCGetTotalSrcPdoCnt(BYTE ucInputPort);
extern BYTE SysTypeCGetTotalSnkPdoCnt(BYTE ucInputPort);
...
extern WORD SysTypeCGetAdcOutputVoltage(BYTE ucInputPort);
extern WORD SysTypeCGetAdcOutputCurrent(BYTE ucInputPort);
