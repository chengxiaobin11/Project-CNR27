...
#warning "NOTE: Must make sure all ports' searching are finished before going to Power Saving/Power Down  while _SOURCE_AUTO_SEARCH_STYLE == _SOURCE_POLLING_ASUS_STYLE !!!"
#endif
...
#endif
                    {
#if(Project_ID == ID_TEST_HK2556MINI_TYPEC_WIFI_EDP60HZ_20200908)||(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2795E02__1T1DP1H__eDPVB1)||(_PCB_TYPE == _RL6449__216PIN__HK_M_RTD2795E06__1T1DP1H__eDPVB1)
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
                            ScalerTMDSHdcp14BchErrorCheckReset(_D2_INPUT_PORT);
#endif
                        }
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
                                ScalerTMDSHdcp14BchErrorCheckReset(_D3_INPUT_PORT);
#endif
                            }
                        }
