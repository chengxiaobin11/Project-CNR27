...
void ScalerDisplayLvdsPinshareSetting(EnumLvdsPinshareType enumLvdsPinshareType)
{
    ...
    {
#if((_LVDS_PORT_SEL == _LVDS_1_PORT_C) || (_LVDS_PORT_SEL == _LVDS_2_PORT_CD))
        // TXC0P TXC0N ~ TXC3P TXC3N Pinshare
        ScalerSetByte(P10_20_PIN_SHARE_CTRL20__OFF1, 0x04);
        ScalerSetByte(P10_21_PIN_SHARE_CTRL21__OFF1, 0x04);
        ScalerSetByte(P10_22_PIN_SHARE_CTRL22__OFF1, 0x04);
        ScalerSetByte(P10_23_PIN_SHARE_CTRL23__OFF1, 0x04);
        ScalerSetByte(P10_24_PIN_SHARE_CTRL24__OFF1, 0x04);
        ScalerSetByte(P10_25_PIN_SHARE_CTRL25__OFF1, 0x04);
        ScalerSetByte(P10_26_PIN_SHARE_CTRL26__OFF1, 0x04);
        ScalerSetByte(P10_27_PIN_SHARE_CTRL27__OFF1, 0x04);
        ScalerSetByte(P10_28_PIN_SHARE_CTRL28__OFF1, 0x04);
        ScalerSetByte(P10_29_PIN_SHARE_CTRL29__OFF1, 0x04);
#endif
    }
...
#if((_LVDS_PORT_SEL == _LVDS_1_PORT_C) || (_LVDS_PORT_SEL == _LVDS_2_PORT_CD))
        // TXC0P TXC0N ~ TXC3P TXC3N Pinshare
        ScalerSetByte(P10_20_PIN_SHARE_CTRL20__OFF1, 0x00);
        ScalerSetByte(P10_21_PIN_SHARE_CTRL21__OFF1, 0x00);
        ScalerSetByte(P10_22_PIN_SHARE_CTRL22__OFF1, 0x00);
        ScalerSetByte(P10_23_PIN_SHARE_CTRL23__OFF1, 0x00);
        ScalerSetByte(P10_24_PIN_SHARE_CTRL24__OFF1, 0x00);
        ScalerSetByte(P10_25_PIN_SHARE_CTRL25__OFF1, 0x00);
        ScalerSetByte(P10_26_PIN_SHARE_CTRL26__OFF1, 0x00);
        ScalerSetByte(P10_27_PIN_SHARE_CTRL27__OFF1, 0x00);
        ScalerSetByte(P10_28_PIN_SHARE_CTRL28__OFF1, 0x00);
        ScalerSetByte(P10_29_PIN_SHARE_CTRL29__OFF1, 0x00);
#endif
    }
}
#endif
