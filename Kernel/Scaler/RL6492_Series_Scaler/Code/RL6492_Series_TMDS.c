...
void ScalerTMDSHdmiSetScdcInfo_EXINT0(void);
#if(_HDMI_FREESYNC_SUPPORT == _ON)
EnumFreeSyncSupport ScalerTMDSHdmiGetFreeSyncSupport_EXINT0(void);
void ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(bit bEnable);
#endif
#endif
...
void ScalerTMDSInitial(BYTE ucInputPort)
{
    ...
    if(ScalerGetBit(P2_E6_HDMI_FREQDET_CTRL, _BIT1) == 0x00)
    {
        ...
        ScalerSetBit(P2_38_HDMI_CTRL_38, ~(_BIT2 | _BIT1), _BIT2);
    }
...
void ScalerTMDSIntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(P2_23_HDMI_CTRL_23, (_BIT6 | _BIT1)) == (_BIT6 | _BIT1))
    {
        ...
        if(ScalerGetBit_EXINT(P2_23_HDMI_CTRL_23, (_BIT2 | _BIT0)) == 0x00)
        {
            ...
            ScalerTMDSHdmiSetScdcInfo_EXINT0();

#if(_HDMI_FREESYNC_SUPPORT == _ON)
            if(ScalerTMDSHdmiGetFreeSyncSupport_EXINT0() == _FREESYNC_SUPPORT_ON)
            {
                ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(_ENABLE);
            }
            else
            {
                ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(_DISABLE);
            }
#endif
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSHdmiSetScdcInfo_EXINT0(void) using 1
{
    // Set SCDC Info
    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D0_PORT_PAGE02_HDMI_SCDC_D0);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.ucManufactureOuiL);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D1_PORT_PAGE02_HDMI_SCDC_D1);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.ucManufactureOuiM);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D2_PORT_PAGE02_HDMI_SCDC_D2);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.ucManufactureOuiH);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D3_PORT_PAGE02_HDMI_SCDC_D3);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[0]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D4_PORT_PAGE02_HDMI_SCDC_D4);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[1]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D5_PORT_PAGE02_HDMI_SCDC_D5);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[2]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D6_PORT_PAGE02_HDMI_SCDC_D6);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[3]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D7_PORT_PAGE02_HDMI_SCDC_D7);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[4]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D8_PORT_PAGE02_HDMI_SCDC_D8);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[5]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_D9_PORT_PAGE02_HDMI_SCDC_D9);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[6]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_DA_PORT_PAGE02_HDMI_SCDC_DA);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.pucIdstring[7]);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_DB_PORT_PAGE02_HDMI_SCDC_DB);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.ucHdmiHwVersion);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_DC_PORT_PAGE02_HDMI_SCDC_DC);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.ucHdmiFwVersionMajor);

    ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_DD_PORT_PAGE02_HDMI_SCDC_DD);
    ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stTmdsMacRxScdcInfoSet.ucHdmiFwVersionMinor);
}
...
//--------------------------------------------------
EnumFreeSyncSupport ScalerTMDSHdmiGetFreeSyncSupport_EXINT0(void) using 1
{
    EnumFreeSyncSupport enumFreeSyncSupport = _FREESYNC_SUPPORT_OFF;

    if(ScalerGetBit_EXINT(P10_45_HDMI_HPD_INT_SEL__ON1, _BIT0) == 0x00)
    {
...
// Output Value : None
//--------------------------------------------------
void ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(bit bEnable) using 1
{
    ...
    {
        // Set SCDC Info
        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E0_PORT_PAGE02_HDMI_SCDC_E0);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucPanelManufactureIdL);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E1_PORT_PAGE02_HDMI_SCDC_E1);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucPanelManufactureIdM);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E2_PORT_PAGE02_HDMI_SCDC_E2);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucPanelIdL);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E3_PORT_PAGE02_HDMI_SCDC_E3);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucPanelIdM);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E4_PORT_PAGE02_HDMI_SCDC_E4);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucFwCheckSumL);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E5_PORT_PAGE02_HDMI_SCDC_E5);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucFwCheckSumM);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E6_PORT_PAGE02_HDMI_SCDC_E6);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucScalerDeviceIdL);

        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E7_PORT_PAGE02_HDMI_SCDC_E7);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, g_stDrrHdmiAmdAupiInfo.ucScalerDeviceIdM);
    }
    else
    {
        // Set SCDC Info
        // Set SCDC Info
        ScalerSetByte_EXINT(P2_39_HDMI_CTRL_39, _P2_3A_PT_E0_PORT_PAGE02_HDMI_SCDC_E0);
        ScalerSetByte_EXINT(P2_3A_HDMI_CTRL_3A, 0x00);
