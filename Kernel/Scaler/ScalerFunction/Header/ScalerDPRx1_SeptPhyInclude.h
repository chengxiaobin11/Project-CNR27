...
#define GET_DP_RX1_JUDGE_OOR()                          (g_bDpRx1JudgeOOR)
#define SET_DP_RX1_JUDGE_OOR()                          (g_bDpRx1JudgeOOR = _TRUE)
#define CLR_DP_RX1_JUDGE_OOR()                          (g_bDpRx1JudgeOOR = _FALSE)
#endif
...
#define GET_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT()    (g_stDpRx1MiscInfo.enumDpSourceWritePowerStatusEvent)
#define SET_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT(x)   {g_stDpRx1MiscInfo.enumDpSourceWritePowerStatusEvent = (x);}
#define CLR_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT()    {g_stDpRx1MiscInfo.enumDpSourceWritePowerStatusEvent = _DP_SOURCE_WRITE_POWER_STATUS_EVENT_NONE;}
#endif
...
#if(_DP_IVF_OOR_EXTEND_SUPPORT == _ON)
extern volatile bit g_bDpRx1JudgeOOR;
#endif
...
#endif
extern void ScalerDpRx1Initial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort, EnumFreeSyncSupport enumFreeSyncSupport, EnumAudioDpDpcdSupport enumAudioSupport, EnumDpHdrSupport enumDpHdrSupport);
...
extern void ScalerDpRx1HdrDpcdSetting(void);
#endif
#endif
