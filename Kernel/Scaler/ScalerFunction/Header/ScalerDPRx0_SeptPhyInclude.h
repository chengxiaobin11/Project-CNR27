...
#define GET_DP_RX0_JUDGE_OOR()                          (g_bDpRx0JudgeOOR)
#define SET_DP_RX0_JUDGE_OOR()                          (g_bDpRx0JudgeOOR = _TRUE)
#define CLR_DP_RX0_JUDGE_OOR()                          (g_bDpRx0JudgeOOR = _FALSE)
#endif
...
#define GET_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT()    (g_stDpRx0MiscInfo.enumDpSourceWritePowerStatusEvent)
#define SET_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT(x)   {g_stDpRx0MiscInfo.enumDpSourceWritePowerStatusEvent = (x);}
#define CLR_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT()    {g_stDpRx0MiscInfo.enumDpSourceWritePowerStatusEvent = _DP_SOURCE_WRITE_POWER_STATUS_EVENT_NONE;}
#endif
#endif
...
#if(_DP_IVF_OOR_EXTEND_SUPPORT == _ON)
extern volatile bit g_bDpRx0JudgeOOR;
#endif
...
#endif
extern void ScalerDpRx0Initial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort, EnumFreeSyncSupport enumFreeSyncSupport, EnumAudioDpDpcdSupport enumAudioSupport, EnumDpHdrSupport enumDpHdrSupport);
...
extern void ScalerDpRx6Initial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort, EnumFreeSyncSupport enumFreeSyncSupport, EnumAudioDpDpcdSupport enumAudioSupport, EnumDpHdrSupport enumDpHdrSupport);
...
extern void ScalerDpRx0HdrDpcdSetting(void);
#endif
#endif
#endif
