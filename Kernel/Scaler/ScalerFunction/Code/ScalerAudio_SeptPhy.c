...
void ScalerAudioD2InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P71_C9_HDMI_AP, _P71_CA_PT_07_PORT_PAGE71_HDMI_MAG_M_FINAL, ~_BIT2, 0x00);
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P71_C9_HDMI_AP, _P71_CA_PT_07_PORT_PAGE71_HDMI_MAG_M_FINAL, ~_BIT2, _BIT2);
...
void ScalerAudioD3InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_07_PORT_PAGE72_HDMI_MAG_M_FINAL, ~_BIT2, 0x00);
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P72_C9_HDMI_AP, _P72_CA_PT_07_PORT_PAGE72_HDMI_MAG_M_FINAL, ~_BIT2, _BIT2);
...
void ScalerAudioD4InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P73_C9_HDMI_AP, _P73_CA_PT_07_PORT_PAGE73_HDMI_MAG_M_FINAL, ~_BIT2, 0x00);
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P73_C9_HDMI_AP, _P73_CA_PT_07_PORT_PAGE73_HDMI_MAG_M_FINAL, ~_BIT2, _BIT2);
...
void ScalerAudioD5InternalAudioGenSwitch(bit bOn, EnumAudioLeftRightChannelSelect enumAudioLeftRightChannelSelect)
{
    ...
    if(bOn == _ON)
    {
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P74_C9_HDMI_AP, _P74_CA_PT_07_PORT_PAGE74_HDMI_MAG_M_FINAL, ~_BIT2, 0x00);
        ...
        {
            // HDMI MAC DVC Full Gain Control
            ScalerSetDataPortBit(P74_C9_HDMI_AP, _P74_CA_PT_07_PORT_PAGE74_HDMI_MAG_M_FINAL, ~_BIT2, _BIT2);
