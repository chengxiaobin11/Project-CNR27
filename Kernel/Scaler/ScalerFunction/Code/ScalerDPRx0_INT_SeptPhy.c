...
{
    BYTE ucSinkStatusBackup = ScalerDpRx0GetDpcdInfo_EXINT0(0x00, 0x02, 0x05);
    ...
    if(enumInSync == _DP_SINK_IN_SYNC)
    {
        if(enumReceiverPort == _DP_SINK_REVEICE_PORT0)
        {
            if((ucSinkStatusBackup & _BIT0) != _BIT0)
            {
                ...
                ScalerDpRx0SetDpcdValue_EXINT0(0x00, 0x02, 0x05, (ucSinkStatusBackup | _BIT0));
            }
        }
        else if(enumReceiverPort == _DP_SINK_REVEICE_PORT1)
        {
            if((ucSinkStatusBackup & _BIT1) != _BIT1)
            {
                ...
                ScalerDpRx0SetDpcdValue_EXINT0(0x00, 0x02, 0x05, (ucSinkStatusBackup | _BIT1));
            }
        }
    }
    else
