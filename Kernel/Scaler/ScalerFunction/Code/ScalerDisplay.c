...
BYTE ScalerDisplaySelectDVFMode(void)
{
	...
	if(GET_INPUT_TIMING_VFREQ()<570)
     	return _PANEL_TYP_FRAME_RATE_FREE_RUN;
#elif 0//(_PANEL_TYPE == _AUO_M250HAN01_6_EDP_FHD165HZ)	
	if(GET_INPUT_TIMING_VFREQ()<740)
		return _PANEL_TYP_FRAME_RATE_FREE_RUN;
#elif 0//(Project_ID == ID_CHANGJIA_HK2556E01_1P2H_M270HAN02_V6_FHD144HZ_20210908)
	if(GET_INPUT_TIMING_VFREQ()<800)
		return _PANEL_TYP_FRAME_RATE_FREE_RUN;
#elif 0//(Project_ID == ID_CHANGJIA_GS24S3F_HK2556E01_1P2H_M236HVR010_FHD144HZ_20210908)
	if(GET_INPUT_TIMING_VFREQ()<800)
		return _PANEL_TYP_FRAME_RATE_FREE_RUN;
#elif(Project_ID == ID_NYC_SHUNWEI_HK27851DP3HDMI__AUO_M270HAN02_2_FHD144HZ__20210203)
	if(GET_INPUT_TIMING_VFREQ()<800)
		return _PANEL_TYP_FRAME_RATE_FREE_RUN;
#elif 0//(Project_ID    ==  ID_CS_2556)
	if(GET_INPUT_TIMING_VFREQ()<700)
		return _PANEL_TYP_FRAME_RATE_FREE_RUN;
#endif
#if(_FRC_SUPPORT == _ON)
