...
{
    BYTE ucSinkStatusBackup = ScalerDpRx1GetDpcdInfo_EXINT0(0x00, 0x02, 0x05);
    ...
    if(enumInSync == _DP_SINK_IN_SYNC)
    {
        if(enumReceiverPort == _DP_SINK_REVEICE_PORT0)
        {
            if((ucSinkStatusBackup & _BIT0) != _BIT0)
            {
                ...
                ScalerDpRx1SetDpcdValue_EXINT0(0x00, 0x02, 0x05, (ucSinkStatusBackup | _BIT0));
            }
        }
        else if(enumReceiverPort == _DP_SINK_REVEICE_PORT1)
        {
            if((ucSinkStatusBackup & _BIT1) != _BIT1)
            {
                ...
                ScalerDpRx1SetDpcdValue_EXINT0(0x00, 0x02, 0x05, (ucSinkStatusBackup | _BIT1));
            }
        }
    }
    else
...
void ScalerDpRx1IntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(PBA_DC_AUX_IRQ_STATUS, _BIT7) == _BIT7)
    {
        ...
        if(ScalerGetBit_EXINT(PBA_DD_AUX_DPCD_IRQ, _BIT0) == _BIT0) // Write 00600h into INT0
        {
            ...
            SET_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT(_DP_SOURCE_WRITE_POWER_STATUS_EVENT_TRIGGERED);
#endif
        }
