...
void ScalerDpRx0SetDFEInitial_EXINT0(void) using 1
{
    ...
    ScalerSetBit_EXINT(P1D_D4_L3_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT3 | _BIT2 | _BIT1 | _BIT0));
    ...
    ScalerSetBit_EXINT(P1D_D5_L3_INIT_3, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), 0x00);
...
void ScalerDpRx0RebuildPhy_WDINT(BYTE ucDpLinkRate, BYTE ucDpcdLane) using 3
{
    ...
    // Backup LE in Dummy Register
    ScalerSetBit_EXINT(P1D_A4_L0_INIT_2, ~(_BIT7 | _BIT6 | _BIT5), ScalerGetBit_EXINT(P1D_A2_L0_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2)) << 3);
    ScalerSetBit_EXINT(P1D_A5_L0_INIT_3, ~(_BIT7 | _BIT6), ScalerGetBit_EXINT(P1D_A2_L0_LIMIT_INIT, (_BIT1 | _BIT0)) << 6);
    ScalerSetBit_EXINT(P1D_B4_L1_INIT_2, ~(_BIT7 | _BIT6 | _BIT5), ScalerGetBit_EXINT(P1D_B2_L1_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2)) << 3);
    ScalerSetBit_EXINT(P1D_B5_L1_INIT_3, ~(_BIT7 | _BIT6), ScalerGetBit_EXINT(P1D_B2_L1_LIMIT_INIT, (_BIT1 | _BIT0)) << 6);
    ScalerSetBit_EXINT(P1D_C4_L2_INIT_2, ~(_BIT7 | _BIT6 | _BIT5), ScalerGetBit_EXINT(P1D_C2_L2_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2)) << 3);
    ScalerSetBit_EXINT(P1D_C5_L2_INIT_3, ~(_BIT7 | _BIT6), ScalerGetBit_EXINT(P1D_C2_L2_LIMIT_INIT, (_BIT1 | _BIT0)) << 6);
    ScalerSetBit_EXINT(P1D_D4_L3_INIT_2, ~(_BIT7 | _BIT6 | _BIT5), ScalerGetBit_EXINT(P1D_D2_L3_LIMIT_INIT, (_BIT4 | _BIT3 | _BIT2)) << 3);
    ScalerSetBit_EXINT(P1D_D5_L3_INIT_3, ~(_BIT7 | _BIT6), ScalerGetBit_EXINT(P1D_D2_L3_LIMIT_INIT, (_BIT1 | _BIT0)) << 6);

    // HBR Reload Tap0 = 21
    if(ScalerDpRx0GetDpcdInfo_WDINT(0x00, 0x01, 0x00) == _DP_LINK_HBR)
    {
        ScalerSetBit_EXINT(P1D_A4_L0_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
        ScalerSetBit_EXINT(P1D_B4_L1_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
        ScalerSetBit_EXINT(P1D_C4_L2_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
        ScalerSetBit_EXINT(P1D_D4_L3_INIT_2, ~(_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT2 | _BIT0));
    }
