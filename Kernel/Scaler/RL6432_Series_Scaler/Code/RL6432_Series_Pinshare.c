...
void ScalerPinshareGpioDdcPinSwitch(BYTE ucPinType)
{
    switch(ucPinType)
    {
        ...
        case _DDC1_SWITCH_GPI:
            ScalerSetBit(P10_0A_PIN_SHARE_CTRL32, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-0A[2:0], Pin_73
            ScalerSetByte(P10_0B_PIN_SHARE_CTRL33, (BYTE)_GPIO_INPUT); // Page 10-0B[2:0], Pin_74
            break;
        ...
        case _DDC2_SWITCH_GPI:
            ScalerSetBit(P10_3C_PIN_SHARE_CTRL94, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-3C[2:0], Pin_212
            ScalerSetByte(P10_3D_PIN_SHARE_CTRL95, (BYTE)_GPIO_INPUT); // Page 10-3D[2:0], Pin_213
            break;
        ...
        case _DDC3_SWITCH_GPI:
            ScalerSetBit(P10_3E_PIN_SHARE_CTRL96, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-3E[2:0], Pin_214
            ScalerSetByte(P10_3F_PIN_SHARE_CTRL97, (BYTE)_GPIO_INPUT); // Page 10-3F[2:0], Pin_215
            break;
    ...
    switch(enumConfigPin)
    {
        ...
        case _CONFIG_PIN_199:
            ...
            switch(enumConfigType)
            {
                ...
                case _PWM3_PP:
                    ScalerSetBit(P10_31_PIN_SHARE_CTRL81, ~(_BIT2 | _BIT1 | _BIT0), (_BIT1 | _BIT0));
                    break;

                case _PWM3_OD:
                    ScalerSetBit(P10_31_PIN_SHARE_CTRL81, ~(_BIT2 | _BIT1 | _BIT0), _BIT2);
                    break;
