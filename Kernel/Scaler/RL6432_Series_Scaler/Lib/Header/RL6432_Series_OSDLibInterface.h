...
#define CHECK_OSD_POSITION_POST_V_OFFSET_COMPENSATION()         ((g_ucOSDPositionVOffsetCorrectCompensation == 0xFF) ? (_TRUE) : (_FALSE))
#define GET_OSD_POSITION_POST_V_OFFSET_COMPENSATION(y)          ((GET_MDOMAIN_OUTPUT_VBSTART() > 0xFF) ? ((y) + (GET_MDOMAIN_OUTPUT_VBSTART() - 0xFF)) : (y))
