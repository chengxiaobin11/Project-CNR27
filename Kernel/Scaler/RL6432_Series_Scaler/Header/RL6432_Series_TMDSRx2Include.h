...
//--------------------------------------------------
#define GET_TMDS_RX2_HDCP14_BCH_CHK_STATE()             (g_enumTMDSRx2Hdcp14BchChkState)
#define SET_TMDS_RX2_HDCP14_BCH_CHK_STATE(x)            (g_enumTMDSRx2Hdcp14BchChkState = (x))
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern volatile EnumHdmiHdcp14BchChkState g_enumTMDSRx2Hdcp14BchChkState;
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern void ScalerTMDSRx2Hdcp14BchErrorCheckEvent(void);
extern void ScalerTMDSRx2FirstActiveProcHdcp14BchErrorCheck(void);
extern bit ScalerTMDSRx2GetFirstActiveHdcp14BchErrorCheck(void);
extern void ScalerTMDSRx2Hdcp14BchErrorCheckReset(void);
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
#if((_D2_INPUT_PORT_TYPE == _D2_HDMI_PORT) || (_D2_INPUT_PORT_TYPE == _D2_MHL_PORT))
extern void ScalerTMDSRx2Hdcp14BchErrorCheckReset_EXINT0(void);
#endif
#endif
#endif
