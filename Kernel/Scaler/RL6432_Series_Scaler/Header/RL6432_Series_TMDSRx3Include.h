...
//--------------------------------------------------
#define GET_TMDS_RX3_HDCP14_BCH_CHK_STATE()             (g_enumTMDSRx3Hdcp14BchChkState)
#define SET_TMDS_RX3_HDCP14_BCH_CHK_STATE(x)            (g_enumTMDSRx3Hdcp14BchChkState = (x))
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern volatile EnumHdmiHdcp14BchChkState g_enumTMDSRx3Hdcp14BchChkState;
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern void ScalerTMDSRx3Hdcp14BchErrorCheckEvent(void);
extern void ScalerTMDSRx3FirstActiveProcHdcp14BchErrorCheck(void);
extern bit ScalerTMDSRx3GetFirstActiveHdcp14BchErrorCheck(void);
extern void ScalerTMDSRx3Hdcp14BchErrorCheckReset(void);
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
#if((_D3_INPUT_PORT_TYPE == _D3_HDMI_PORT) || (_D3_INPUT_PORT_TYPE == _D3_MHL_PORT))
extern void ScalerTMDSRx3Hdcp14BchErrorCheckReset_EXINT0(void);
#endif
#endif
#endif
