...
//--------------------------------------------------
#define GET_TMDS_RX1_HDCP14_BCH_CHK_STATE()             (g_enumTMDSRx1Hdcp14BchChkState)
#define SET_TMDS_RX1_HDCP14_BCH_CHK_STATE(x)            (g_enumTMDSRx1Hdcp14BchChkState = (x))
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern volatile EnumHdmiHdcp14BchChkState g_enumTMDSRx1Hdcp14BchChkState;
#endif
...
#if(_HDMI_HDCP14_BCH_ERROR_CHECK == _ON)
extern void ScalerTMDSRx1Hdcp14BchErrorCheckEvent(void);
extern void ScalerTMDSRx1FirstActiveProcHdcp14BchErrorCheck(void);
extern bit ScalerTMDSRx1GetFirstActiveHdcp14BchErrorCheck(void);
extern void ScalerTMDSRx1Hdcp14BchErrorCheckReset(void);
#if(_TMDS_HDCP_2_2_SUPPORT == _ON)
#if((_D1_INPUT_PORT_TYPE == _D1_HDMI_PORT) || (_D1_INPUT_PORT_TYPE == _D1_MHL_PORT))
extern void ScalerTMDSRx1Hdcp14BchErrorCheckReset_EXINT0(void);
#endif
#endif
#endif
