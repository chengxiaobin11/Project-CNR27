...
void ScalerTimerEventProc(EnumScalerTimerEventID enumEventID)
{
    switch(enumEventID)
    {
...
#endif
        ScalerTMDSHdcp14BchErrorCheckEvent(enumEventID);
        break;
        ...
        case _SCALER_TIMER_EVENT_DP_RX0_AUX_CH_NO_POWER_CHECK_DEBOUNCE:
            ...
            if(ScalerDpRx0AuxChSourcePowerCheck() == _OFF)
            {
                ...
                if(ucDebounceCnt == 10)
                {
                    ...
                    if(ScalerDpRxChPowerDownResetCheck(_D0_INPUT_PORT) == _TRUE)
                    {
        ...
        case _SCALER_TIMER_EVENT_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT_DEBOUNCE:

            if(GET_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT() == _DP_SOURCE_WRITE_POWER_STATUS_EVENT_TIMER_ACTIVE)
            {
        ...
        case _SCALER_TIMER_EVENT_DP_RX1_AUX_CH_NO_POWER_CHECK_DEBOUNCE:
            ...
            if(ScalerDpRx1AuxChSourcePowerCheck() == _OFF)
            {
                ...
                if(ucDebounceCnt == 10)
                {
                    ...
                    if(ScalerDpRxChPowerDownResetCheck(_D1_INPUT_PORT) == _TRUE)
                    {
...
#if(_DP_MST_SUPPORT == _ON)
        case _SCALER_TIMER_EVENT_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT_DEBOUNCE:

            if(GET_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT() == _DP_SOURCE_WRITE_POWER_STATUS_EVENT_TIMER_ACTIVE)
            {
