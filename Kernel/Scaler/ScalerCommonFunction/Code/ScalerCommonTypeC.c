...
EnumTypeCSpmOperation g_enumTypeCSpmOperation;
...
void ScalerTypeCSetPresentPower(BYTE ucInputPort, WORD usPresentPower);
WORD ScalerTypeCGetPresentPower(BYTE ucInputPort);
...
void ScalerTypeCSetSPRAvsPdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex, WORD usSprAvs15VMaxCur, WORD usSprAvs20VMaxCur, EnumPDPeakCurType enumPeakCur);
...
//--------------------------------------------------
// Description  : Type C Set Source Present Supply Power
// Input Value  : ucInputPort, usPresentPower in 0.1W
// Output Value : None
//--------------------------------------------------
void ScalerTypeCSetPresentPower(BYTE ucInputPort, WORD usPresentPower)
{
    ...
    switch(ucInputPort)
    {
        ...
        case _D0_INPUT_PORT:
            ...
            ScalerTypeCRx0PdSetPresentPower(usPresentPower);
...
//--------------------------------------------------
// Description  : Type C Get Source Present Supply Power
// Input Value  : ucInputPort
// Output Value : usPresentPower in 0.1W
//--------------------------------------------------
WORD ScalerTypeCGetPresentPower(BYTE ucInputPort)
{
    WORD usPresentPower = 0;
    ...
    switch(ucInputPort)
    {
        ...
        case _D0_INPUT_PORT:
            ...
            usPresentPower = ScalerTypeCRx0PdGetPresentPower();
...
//--------------------------------------------------
// Description  : Type C Set SPR AVS PDO
// Input Value  : ucInputPort, enumPowerRole(Src/Snk PDO), ucPdoIndex, usSprAvs15VMaxCur(10mA), usSprAvs20VMaxCur(10mA), enumPeakCur
// Output Value : None
//--------------------------------------------------
void ScalerTypeCSetSPRAvsPdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex, WORD usSprAvs15VMaxCur, WORD usSprAvs20VMaxCur, EnumPDPeakCurType enumPeakCur)
{
    switch(ucInputPort)
    {
        ...
        case _D0_INPUT_PORT:
            ...
            ScalerTypeCRx0PdSetSPRAdjustablePdo(enumPowerRole, ucPdoIndex, usSprAvs15VMaxCur, usSprAvs20VMaxCur, enumPeakCur);
