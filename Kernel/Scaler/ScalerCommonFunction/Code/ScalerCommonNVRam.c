...
StructFlashInformation code tFlashInformation[] =
{
    ...
    // _FLASH_W25Q32RV; ucUnprotectWRSR is not used here
    {0x9F, 0xEF, 0x40, 0x16, 0x90, 0xEF, 0x15, 0x00, 0x06, 0x04, 0x20, 0x02, 0xFC, 0x40},
    // _FLASH_ZB25VQ32D; ucUnprotectWRSR is not used here
    {0x9F, 0x5E, 0x40, 0x16, 0x90, 0x5E, 0x15, 0x00, 0x06, 0x04, 0x20, 0x02, 0xFC, 0x40},
    // _FLASH_BY25Q16ES; ucUnprotectWRSR is not used here
    {0x9F, 0x68, 0x40, 0x15, 0x90, 0x68, 0x14, 0x00, 0x06, 0x04, 0x20, 0x02, 0xFC, 0x40},
    // _FLASH_PY25Q32HB; ucUnprotectWRSR is not used here
    {0x9F, 0x85, 0x20, 0x16, 0x90, 0x85, 0x15, 0x00, 0x06, 0x04, 0x20, 0x02, 0xFC, 0x40},
};
...
#if(_FLASH_TYPE_W25Q32F_OR_W25Q32JVSSIQ_OR_W25Q32RV == _FLASH_W25Q32JVSSIQ)
            if(g_ucFlashType == _FLASH_W25Q32F)
            {
                g_ucFlashType = _FLASH_W25Q32JVSSIQ;
            }
            if(g_ucFlashType == _FLASH_W25Q32RV)
            {
                g_ucFlashType = _FLASH_W25Q32JVSSIQ;
            }
#elif(_FLASH_TYPE_W25Q32F_OR_W25Q32JVSSIQ_OR_W25Q32RV == _FLASH_W25Q32F)
...
#if(_FLASH_TYPE_BY25D16ASTIG_OR_BY25Q16ES == _FLASH_BY25D16ASTIG)
            if(g_ucFlashType == _FLASH_BY25Q16ES)
            {
                g_ucFlashType = _FLASH_BY25D16ASTIG;
            }
#else
            if(g_ucFlashType == _FLASH_BY25D16ASTIG)
            {
                g_ucFlashType = _FLASH_BY25Q16ES;
            }
#endif
...
void ScalerFlashWREN(BYTE ucBank, BYTE ucPage)
{
    ...
    switch(g_ucFlashType)
    {
        ...
        case _FLASH_W25Q32RV:
        case _FLASH_ZB25VQ32D:
            switch(ucBank)
            {
                case 0:
                    if(ucPage == 0)
