...
void ScalerDpTxMstDownRequestSend(void);
void ScalerDpTxMstDownReplyReceive(void);
void ScalerDpTxMstDownRequestAnal(void);
void ScalerDpTxMstDownRequestAnalDone(void);
void ScalerDpTxMstDownRequestDone(void);
void ScalerDpTxMstDownReplyAnal(void);
void ScalerDpTxMstDownReplyAnalDone(void);
void ScalerDpTxMstUpRequestReceive(void);
void ScalerDpTxMstUpReplySend(void);
void ScalerDpTxMstUpRequestAnal(void);
bit ScalerDpTxMstSelfGenCSNTimerEventCheck(void);
void ScalerDpTxMstUpReplyAnal(void);
void ScalerDpTxMstUpReplyDone(void);
...
//--------------------------------------------------
// Description  : ScalerDpTxMstDownRequestProc
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerDpTxMstDownRequestProc(void)
{
    ...
    ScalerDpTxMstDownRequestAnalDone();

    ScalerDpTxMstDownRequestSend();

    ScalerDpTxMstDownRequestDone();
}

//--------------------------------------------------
// Description  : ScalerDpTxMstDownReplyProc
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerDpTxMstDownReplyProc(void)
{
    ScalerDpTxMstDownReplyReceive();

    ScalerDpTxMstDownReplyAnal();

    ScalerDpTxMstDownReplyEventProc();

    ScalerDpTxMstDownReplyAnalDone();
}

//--------------------------------------------------
// Description  : ScalerDpTxMstUpRequestProc
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerDpTxMstUpRequestProc(void)
{
    ScalerDpTxMstUpRequestReceive();

    ScalerDpTxMstUpRequestAnal();
}

//--------------------------------------------------
// Description  : ScalerDpTxMstUpReplyProc
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerDpTxMstUpReplyProc(void)
{
    ...
    ScalerDpTxMstUpReplySend();

    ScalerDpTxMstUpReplyDone();
}
