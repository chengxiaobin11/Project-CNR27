...
#define _PD_SPEC_REVISION                       0x32
#define _PD_SPEC_VERSION                        0x00
...
#define _SRC_SEND_PS_RDY_AVS_MODE_TIMER         6       // 6ms, Depends on tAvsSrcTransSmall (50ms) : 6ms * 8 (Check Vbus Count) <= 50ms
...
#define _PARTNER_ALT_SUPPORT_TIMER              1500    // Wait 1.5 Sec to Detect Whether Partner Support ALT Mode
...
typedef struct
{
    ...
    WORD b10SprAvs15VMaxCurrent : 10;
    WORD b10SprAvs20VMaxCurrent : 10;
}StructTypeCPDO;
...
typedef enum
{
    ...
    _PD_SUB_INT_WAIT_GET_STATUS = 0x6D,
    ...
    _PD_SUB_WDINT_SEND_EPR_ENTER_SUCCESSFUL = 0x7B,
    ...
    _PD_SUB_INT_SEND_SRC_INFO = 0xF3,
}EnumPDSubState;
...
extern void ScalerTypeCRx0PdWDTimerEventCableProc_WDINT(BYTE *pucActiveWDID, BYTE *pucActiveWDTime);
...
extern void ScalerTypeCRx0PdSetSPRAdjustablePdo(EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex, WORD usSprAvs15VMaxCur, WORD usSprAvs20VMaxCur, EnumPDPeakCurType enumPeakCur);
...
extern void ScalerTypeCRx0PdSetPresentPower(WORD usPresentPower);
extern WORD ScalerTypeCRx0PdGetPresentPower(void);
...
extern void ScalerTypeCRx0PdDpCTSForceHpdIrq_WDINT(void);
#endif
