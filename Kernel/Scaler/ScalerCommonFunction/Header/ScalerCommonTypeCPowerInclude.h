...
#define GET_RX0_PRESENT_POWER()         (g_stTpcRx0PowerInfo.usRx0PresentPower)
#define SET_RX0_PRESENT_POWER(x)        (g_stTpcRx0PowerInfo.usRx0PresentPower = (x))

#define GET_RX0_REPORTED_POWER()        (g_stTpcRx0PowerInfo.usRx0ReportedPower)
#define SET_RX0_REPORTED_POWER(x)       (g_stTpcRx0PowerInfo.usRx0ReportedPower = (x))
...
extern WORD ScalerTypeCPowerGetAdcOutputVoltage(BYTE ucInputPort);
extern WORD ScalerTypeCPowerGetAdcOutputCurrent(BYTE ucInputPort);
