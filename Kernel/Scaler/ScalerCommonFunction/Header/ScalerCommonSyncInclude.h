...
#else
#define _TMDS_FREQ_PS_HIGH_SPEED_UPPER_BOUND                (WORD)((DWORD)600 * 1040 * 10 / (((((ScalerGetBit(P80_06_GDI_CLK_DIVIDER, _BIT4) != _BIT4) && (_SYS_USE_ISO_CLK == _FALSE)) ? _EXT_XTAL : _INTERNAL_OSC_XTAL) * _TMDS_MEASURE_CLOCK_DIVIDER) / _TMDS_MEASURE_CLOCK_COUNTER * 9)) // (600 / _TMDS_MEASURE_CLOCK_DIVIDER) * 1.04 * _TMDS_MEASURE_CLOCK_COUNTER / ((_EXT_XTAL(Mhz)/_INTERNAL_OSC_XTAL(Mhz)) * 0.9)
#define _TMDS_FREQ_PS_LOW_SPEED_UPPER_BOUND                 (WORD)((DWORD)340 * 1040 * 10 / (((((ScalerGetBit(P80_06_GDI_CLK_DIVIDER, _BIT4) != _BIT4) && (_SYS_USE_ISO_CLK == _FALSE)) ? _EXT_XTAL : _INTERNAL_OSC_XTAL) * _TMDS_MEASURE_CLOCK_DIVIDER) / _TMDS_MEASURE_CLOCK_COUNTER * 9)) // (340 / _TMDS_MEASURE_CLOCK_DIVIDER) * (1.04) * _TMDS_MEASURE_CLOCK_COUNTER / ((_EXT_XTAL(Mhz)/_INTERNAL_OSC_XTAL(Mhz)) * 0.9)
#define _TMDS_FREQ_PS_LOWER_BOUND                           (WORD)((DWORD)_TMDS_CLOCK_MEASURE_LOWER_BOUNDARY * 960 * 10 / (((((ScalerGetBit(P80_06_GDI_CLK_DIVIDER, _BIT4) != _BIT4) && (_SYS_USE_ISO_CLK == _FALSE)) ? _EXT_XTAL : _INTERNAL_OSC_XTAL) * _TMDS_MEASURE_CLOCK_DIVIDER) / _TMDS_MEASURE_CLOCK_COUNTER * 11)) // (25 / _TMDS_MEASURE_CLOCK_DIVIDER) * (0.96) * _TMDS_MEASURE_CLOCK_COUNTER / ((_EXT_XTAL(Mhz)/_INTERNAL_OSC_XTAL(Mhz)) * 1.1)
#endif
...
//--------------------------------------------------
// Macro of DP HDR Setting
//--------------------------------------------------
#define GET_DP_HDR_D0_SUPPORT()                             (g_stDpRxHdrInfo.enumDpD0HdrSupport)
#define SET_DP_HDR_D0_SUPPORT(x)                            (g_stDpRxHdrInfo.enumDpD0HdrSupport = (x))

#define GET_DP_HDR_D1_SUPPORT()                             (g_stDpRxHdrInfo.enumDpD1HdrSupport)
#define SET_DP_HDR_D1_SUPPORT(x)                            (g_stDpRxHdrInfo.enumDpD1HdrSupport = (x))

#define GET_DP_HDR_D2_SUPPORT()                             (g_stDpRxHdrInfo.enumDpD2HdrSupport)
#define SET_DP_HDR_D2_SUPPORT(x)                            (g_stDpRxHdrInfo.enumDpD2HdrSupport = (x))

#define GET_DP_HDR_D6_SUPPORT()                             (g_stDpRxHdrInfo.enumDpD6HdrSupport)
#define SET_DP_HDR_D6_SUPPORT(x)                            (g_stDpRxHdrInfo.enumDpD6HdrSupport = (x))

#define GET_DP_RX_D0_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD0CapabilitySwitch)
#define SET_DP_RX_D0_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD0CapabilitySwitch = _TRUE)
#define CLR_DP_RX_D0_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD0CapabilitySwitch = _FALSE)

#define GET_DP_RX_D1_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD1CapabilitySwitch)
#define SET_DP_RX_D1_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD1CapabilitySwitch = _TRUE)
#define CLR_DP_RX_D1_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD1CapabilitySwitch = _FALSE)

#define GET_DP_RX_D2_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD2CapabilitySwitch)
#define SET_DP_RX_D2_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD2CapabilitySwitch = _TRUE)
#define CLR_DP_RX_D2_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD2CapabilitySwitch = _FALSE)

#define GET_DP_RX_D6_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD6CapabilitySwitch)
#define SET_DP_RX_D6_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD6CapabilitySwitch = _TRUE)
#define CLR_DP_RX_D6_HDR_CAPABILITY_SWITCH()                (g_stDpRxHdrInfo.b1DpD6CapabilitySwitch = _FALSE)
#endif
#endif
...
#if(_DP_TX_SUPPORT == _ON)
#define GET_DP_TX_DOWNSTREAM_MSA_IGNORED()                  (g_stDpFREESYNCInfo.b1DPTXFREESYNDOWNSTREAMMSAIGNORE)
#define SET_DP_TX_DOWNSTREAM_MSA_IGNORED(x)                 (g_stDpFREESYNCInfo.b1DPTXFREESYNDOWNSTREAMMSAIGNORE = (x))
...
typedef struct
{
    ...
    EnumDpSourceWritePowerStatusEvent enumDpSourceWritePowerStatusEvent;
...
#if(_DP_HDR10_SUPPORT == _ON)
#if(_DP_HDR_VENDOR_SUPPORT != _DP_HDR_VENDOR_SUPPORT_NONE)
extern StructDpHdrSupportInfo g_stDpRxHdrInfo;
#endif
#endif
...
#if(_DP_MST_SUPPORT == _ON)
extern void ScalerSyncDpRxSourceWritePowerStatusEventTimerReactive(EnumSourceSearchPort enumInputPort);
extern void ScalerSyncDpRxClrSourceWritePowerStatusEvent(EnumSourceSearchPort enumInputPort);
extern EnumDpSourceWritePowerStatusEvent ScalerSyncDpRxGetSourceWritePowerStatusEvent(EnumSourceSearchPort enumInputPort);
#endif
