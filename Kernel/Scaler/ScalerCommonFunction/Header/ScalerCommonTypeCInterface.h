...
extern void ScalerTypeCSetPresentPower(BYTE ucInputPort, WORD usPresentPower);
extern WORD ScalerTypeCGetPresentPower(BYTE ucInputPort);
...
extern void ScalerTypeCSetSPRAvsPdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex, WORD usSprAvs15VMaxCur, WORD usSprAvs20VMaxCur, EnumPDPeakCurType enumPeakCur);
