...
//--------------------------------------------------
// Definitions of MSG Buffer Size & MSG Max Length
//--------------------------------------------------
#define _DP_MST_RX_DOWNSTREAM_MSG_BUFFER_SIZE                                                   48

#define _DP_MST_RX_REQUEST_REMOTE_I2C_WRITE_MSG_DATA_TO_WRITE_MAX_LEN                           (_DP_MST_RX_DOWNSTREAM_MSG_BUFFER_SIZE - 4)
#define _DP_MST_RX_REQUEST_REMOTE_I2C_READ_MSG_REMAIN_PART_MAX_LEN                              (_DP_MST_RX_DOWNSTREAM_MSG_BUFFER_SIZE - 2)
...
#define GET_DP_RX_MST_SOURCE_WRITE_POWER_STATUS_EVENT()                                         ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? GET_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT() : GET_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT())
...
#define GET_DP_RX_MST_SOURCE_WRITE_POWER_STATUS_EVENT()                                         (GET_DP_RX0_SOURCE_WRITE_POWER_STATUS_EVENT())
...
#define GET_DP_RX_MST_SOURCE_WRITE_POWER_STATUS_EVENT()                                         (GET_DP_RX1_SOURCE_WRITE_POWER_STATUS_EVENT())
...
typedef struct
{
    ...
    BYTE b2Zero1 : 2;
    BYTE b4PortNum : 4;
    BYTE pucRemainPart[_DP_MST_RX_REQUEST_REMOTE_I2C_READ_MSG_REMAIN_PART_MAX_LEN];
...
typedef struct
{
    ...
    BYTE b1Zero2 : 1;
    BYTE ucNumOfByteToWrite;
    BYTE pucI2CDateToWrite[_DP_MST_RX_REQUEST_REMOTE_I2C_WRITE_MSG_DATA_TO_WRITE_MAX_LEN];
