...
void ScalerDisplayLvdsPinshareSetting(EnumLvdsPinshareType enumLvdsPinshareType)
{
    ...
    {
#if((_LVDS_PORT_SEL == _LVDS_1_PORT_A) || (_LVDS_PORT_SEL == _LVDS_2_PORT_AB))
        if(_PANEL_DISP_BIT_MODE == _PANEL_DISP_30_BIT)
        {
            // TXA4P TXA4N Pinshare
            ScalerSetByte(P10_26_PIN_SHARE_CTRL66, 0x04);
            ScalerSetByte(P10_27_PIN_SHARE_CTRL67, 0x04);
        }
        // TXA0P TXA0N~ TXA3P TXA3N Pinshare
        ScalerSetByte(P10_3B_LVDS_TTL_SELECT0, 0x02);
        ScalerSetByte(P10_3C_LVDS_TTL_SELECT1, 0x02);
        ScalerSetByte(P10_3D_LVDS_TTL_SELECT2, 0x02);
        ScalerSetByte(P10_3E_LVDS_TTL_SELECT3, 0x02);
        ScalerSetByte(P10_3F_LVDS_TTL_SELECT4, 0x02);
        ScalerSetByte(P10_40_LVDS_TTL_SELECT5, 0x02);
        ScalerSetByte(P10_41_LVDS_TTL_SELECT6, 0x02);
        ScalerSetByte(P10_42_LVDS_TTL_SELECT7, 0x02);
        ScalerSetByte(P10_43_LVDS_TTL_SELECT8, 0x02);
        ScalerSetByte(P10_44_LVDS_TTL_SELECT9, 0x02);
#endif
        ...
        if(_PANEL_DISP_BIT_MODE == _PANEL_DISP_30_BIT)
        {
            ...
            ScalerSetByte(P10_1C_PIN_SHARE_CTRL54, 0x04);
            ScalerSetByte(P10_1D_PIN_SHARE_CTRL55, 0x04);
        }
        // TXB0P TXB0N~ TXB3P TXB3N Pinshare
        ScalerSetByte(P10_1E_PIN_SHARE_CTRL56, 0x04);
        ScalerSetByte(P10_1F_PIN_SHARE_CTRL57, 0x04);
        ScalerSetByte(P10_20_PIN_SHARE_CTRL60, 0x04);
        ScalerSetByte(P10_21_PIN_SHARE_CTRL61, 0x04);
        ScalerSetByte(P10_22_PIN_SHARE_CTRL62, 0x04);
        ScalerSetByte(P10_23_PIN_SHARE_CTRL63, 0x04);
        ScalerSetByte(P10_24_PIN_SHARE_CTRL64, 0x04);
        ScalerSetByte(P10_25_PIN_SHARE_CTRL65, 0x04);
#endif
    }
    else if(enumLvdsPinshareType == _HIZ_TYPE)
    {
        ...
        // TXA0P TXA0N~ TXA3P TXA3N Pinshare
        ScalerSetByte(P10_3B_LVDS_TTL_SELECT0, 0x03);
        ScalerSetByte(P10_3C_LVDS_TTL_SELECT1, 0x03);
        ScalerSetByte(P10_3D_LVDS_TTL_SELECT2, 0x03);
        ScalerSetByte(P10_3E_LVDS_TTL_SELECT3, 0x03);
        ScalerSetByte(P10_3F_LVDS_TTL_SELECT4, 0x03);
        ScalerSetByte(P10_40_LVDS_TTL_SELECT5, 0x03);
        ScalerSetByte(P10_41_LVDS_TTL_SELECT6, 0x03);
        ScalerSetByte(P10_42_LVDS_TTL_SELECT7, 0x03);
        ScalerSetByte(P10_43_LVDS_TTL_SELECT8, 0x03);
        ScalerSetByte(P10_44_LVDS_TTL_SELECT9, 0x03);
#endif
        ...
        {
            // TXB4P TXB4N Pinshare
            ScalerSetByte(P10_1C_PIN_SHARE_CTRL54, 0x00);
            ScalerSetByte(P10_1D_PIN_SHARE_CTRL55, 0x00);
        }
        // TXB0P TXB0N~ TXB3P TXB3N Pinshare
        ScalerSetByte(P10_1E_PIN_SHARE_CTRL56, 0x00);
        ScalerSetByte(P10_1F_PIN_SHARE_CTRL57, 0x00);
        ScalerSetByte(P10_20_PIN_SHARE_CTRL60, 0x00);
        ScalerSetByte(P10_21_PIN_SHARE_CTRL61, 0x00);
        ScalerSetByte(P10_22_PIN_SHARE_CTRL62, 0x00);
        ScalerSetByte(P10_23_PIN_SHARE_CTRL63, 0x00);
