...
void ScalerPinshareGpioDdcPinSwitch(BYTE ucPinType)
{
    switch(ucPinType)
    {
        ...
        case _DDC0_SWITCH_GPI:
            ScalerSetBit(P10_2E_PIN_SHARE_CTRL76, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1 | _BIT0), ((BYTE)_GPIO_INPUT)); // Page 10-2E[3:0], Pin_110
            ScalerSetByte(P10_2F_PIN_SHARE_CTRL77, (BYTE)_GPIO_INPUT); // Page 10-2F[3:0], Pin_111
            break;
        ...
        case _DDC1_SWITCH_GPI:
            ScalerSetBit(P10_30_PIN_SHARE_CTRL80, ~(_BIT7 | _BIT3 | _BIT2 | _BIT1 | _BIT0), ((BYTE)_GPIO_INPUT)); // Page 10-30[3:0], Pin_112
            ScalerSetByte(P10_31_PIN_SHARE_CTRL81, (BYTE)_GPIO_INPUT); // Page 10-31[3:0], Pin_113
            break;
        ...
        case _DDC2_SWITCH_GPI:
            ScalerSetBit(P10_32_PIN_SHARE_CTRL82, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), ((BYTE)_GPIO_INPUT)); // Page 10-32[3:0], Pin_115
            ScalerSetByte(P10_33_PIN_SHARE_CTRL83, (BYTE)_GPIO_INPUT); // Page 10-33[3:0], Pin_114
            break;
