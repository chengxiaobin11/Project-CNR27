...
void ScalerDisplayDPTxSSCSet(bit bSscEn, BYTE ucSpreadRange);
...
void ScalerDisplayDPTxSSCSet(bit bSscEn, BYTE ucSpreadRange)
{
    ucSpreadRange = (ucSpreadRange > 15) ? 15 : ucSpreadRange;
    ...
    if(bSscEn == _ENABLE)
    {
        ...
        PDATA_WORD(2) = ((((DWORD)PDATA_WORD(0) + 4) * 4096 + PDATA_WORD(1))) * 16 / 200 / PDATA_WORD(3) / 15 * ucSpreadRange;
