...
void ScalerTMDSRx5SwitchHdcpSlaveAddr(void);
...
void ScalerTMDSRx5Initial(void)
{
    ...
    memset(&g_stTmdsMacRx5SpdInfo, 0x00, sizeof(g_stTmdsMacRx5SpdInfo));
#endif
    ...
    if(ScalerGetBit(P74_E6_HDMI_FREQDET_CTRL, _BIT1) == 0x00)
    {
        ...
        ScalerSetBit(P74_38_HDMI_CTRL_38, ~(_BIT2 | _BIT1), _BIT2);
    }
...
void ScalerTMDSRx5AfterHotPlugEventProc(bit bRestoreZ0)
{
...
#endif
    {
        ...
        ScalerMcuDdcciEnable(_ENABLE, _D5_INPUT_PORT);
#endif
