...
void ScalerPinshareGpioDdcPinSwitch(BYTE ucPinType)
{
    switch(ucPinType)
    {
        ...
        case _DDC2_SWITCH_GPI:
            ScalerSetBit(P10_65_PIN_SHARE_CTRLE5, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-65[2:0], Pin_M6
            ScalerSetByte(P10_66_PIN_SHARE_CTRLE6, (BYTE)_GPIO_INPUT); // Page 10-66[2:0], Pin_M5
            break;
        ...
        case _DDC3_SWITCH_GPI:
            ScalerSetBit(P10_63_PIN_SHARE_CTRLE3, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-63[2:0], Pin_L6
            ScalerSetByte(P10_64_PIN_SHARE_CTRLE4, (BYTE)_GPIO_INPUT); // Page 10-64[2:0], Pin_L5
            break;
        ...
        case _DDC4_SWITCH_GPI:
            ScalerSetBit(P10_61_PIN_SHARE_CTRLE1, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-61[2:0], Pin_K6
            ScalerSetByte(P10_62_PIN_SHARE_CTRLE2, (BYTE)_GPIO_INPUT); // Page 10-62[2:0], Pin_K5
            break;
        ...
        case _DDC5_SWITCH_GPI:
            ScalerSetBit(P10_5F_PIN_SHARE_CTRLD7, ~(_BIT7 | _BIT2 | _BIT1 | _BIT0), (_BIT7 | ((BYTE)_GPIO_INPUT))); // Page 10-5F[2:0], Pin_J6
            ScalerSetByte(P10_60_PIN_SHARE_CTRLE0, (BYTE)_GPIO_INPUT); // Page 10-60[2:0], Pin_J5
            break;
