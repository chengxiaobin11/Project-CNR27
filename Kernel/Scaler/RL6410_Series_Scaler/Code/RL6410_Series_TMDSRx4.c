...
void ScalerTMDSRx4SwitchHdcpSlaveAddr(void);
...
void ScalerTMDSRx4IntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(P73_23_HDMI_CTRL_23, (_BIT6 | _BIT1)) == (_BIT6 | _BIT1))
    {
        ...
        if(ScalerGetBit_EXINT(P73_23_HDMI_CTRL_23, (_BIT2 | _BIT0)) == 0x00)
        {
            ...
            ScalerTMDSHdmiSetScdcInfo_EXINT0(_D4_INPUT_PORT);

#if(_HDMI_FREESYNC_SUPPORT == _ON)
            if(ScalerTMDSHdmiGetFreeSyncSupport_EXINT0(_D4_INPUT_PORT) == _FREESYNC_SUPPORT_ON)
            {
                ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(_D4_INPUT_PORT, _ENABLE);
            }
            else
            {
                ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(_D4_INPUT_PORT, _DISABLE);
            }
#endif
...
void ScalerTMDSRx4PSIntHandler_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(P73_23_HDMI_CTRL_23, (_BIT6 | _BIT1)) == (_BIT6 | _BIT1))
    {
        ...
        if(ScalerGetBit_EXINT(P73_23_HDMI_CTRL_23, (_BIT2 | _BIT0)) == 0x00)
        {
            ...
            ScalerTMDSHdmiSetScdcInfo_EXINT0(_D5_INPUT_PORT);

#if(_HDMI_FREESYNC_SUPPORT == _ON)
            if(ScalerTMDSHdmiGetFreeSyncSupport_EXINT0(_D5_INPUT_PORT) == _FREESYNC_SUPPORT_ON)
            {
                ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(_D5_INPUT_PORT, _ENABLE);
            }
            else
            {
                ScalerTMDSHdmiSetAmdAupiScdcInfo_EXINT0(_D5_INPUT_PORT, _DISABLE);
            }
#endif
            // Clear HDMI 2.0 Read Request Enable
            CLR_HDMI_2_0_RX4_RR_ENABLE();
...
void ScalerTMDSRx4AfterHotPlugEventProc(bit bRestoreZ0)
{
...
#endif
    {
        ...
        ScalerMcuDdcciEnable(_ENABLE, _D4_INPUT_PORT);
#endif
