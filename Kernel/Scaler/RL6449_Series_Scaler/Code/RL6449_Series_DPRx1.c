...
#if(_DP_HDR10_SUPPORT == _ON)
#if(_DP_HDR_VENDOR_SUPPORT != _DP_HDR_VENDOR_SUPPORT_NONE)
    // Source Read 00340-0034F INT
    ScalerSetByte(PBA_BA_AUX_IRQ_ADDR2_MSB, 0x30);
    ScalerSetByte(PBA_BB_AUX_IRQ_ADDR2_MSB1, 0x03);
    ScalerSetByte(PBA_BC_AUX_IRQ_ADDR2_LSB, 0x40);
#endif
#endif
...
bit ScalerDpRx1StreamClkRegenerate(void)
{
...
#endif
    {
        ...
        {
            usHBs2BsCount = (((WORD)ScalerGetByte(PB8_5B_MN_MEAS_HLN_M)) << 8) | ((WORD)ScalerGetByte(PB8_5C_MN_MEAS_HLN_L));
    ...
    */
    ...
    if(ScalerGetBit(PB8_30_DPF_CTRL_0, (_BIT5 | _BIT4)) != _BIT4)
    {
        ...
        if(GET_DP_RX1_JUDGE_OOR() == _TRUE)
        {
            ...
            PDATA_WORD(0) = (WORD)(ScalerComputeDwordMulDiv((DWORD)usHBs2BsCount, _GDI_CLK_KHZ, ulLinkClkValue / 1000));
        }
        else
#endif
        {
