...
void ScalerDpRx0AuxIntInitial(void)
{
    ...
    ScalerSetByte(PB7_BA_AUX_IRQ_ADDR2_MSB, 0x30);
    ScalerSetByte(PB7_BB_AUX_IRQ_ADDR2_MSB1, 0x03);
    ScalerSetByte(PB7_BC_AUX_IRQ_ADDR2_LSB, 0x40);
#endif
#endif
...
bit ScalerDpRx0StreamClkRegenerate(void)
{
...
#endif
    {
        ...
        {
            usHBs2BsCount = (((WORD)ScalerGetByte(PB5_5B_MN_MEAS_HLN_M)) << 8) | ((WORD)ScalerGetByte(PB5_5C_MN_MEAS_HLN_L));
