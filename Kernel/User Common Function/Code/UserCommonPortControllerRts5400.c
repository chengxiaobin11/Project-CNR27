...
// Rts Port Controller Event Macros
#define GET_TYPE_C_5400_PD_PORT_CTRL_EVENT(x)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].enumPortCtrlEvent)
#define SET_TYPE_C_5400_PD_PORT_CTRL_EVENT(x, y)            (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].enumPortCtrlEvent = (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].enumPortCtrlEvent | (y)))
#define CLR_TYPE_C_5400_PD_PORT_CTRL_EVENT(x, y)            (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].enumPortCtrlEvent = (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].enumPortCtrlEvent & (EnumPDPortCtrlEvent)(~(y))))
...
#define GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(x)           (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b4ReqObjPos)
#define SET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(x, y)        (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b4ReqObjPos = (y))
#define CLR_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(x)           (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b4ReqObjPos = 0)
...
#define GET_TYPE_C_5400_MAX_POWER(x)                        (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].usMaxPower)
#define SET_TYPE_C_5400_MAX_POWER(x, y)                     (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].usMaxPower = (y))

#define GET_TYPE_C_5400_SPR_SRC_CAP_CNT(x)                  (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfSPRSrcCap)
#define SET_TYPE_C_5400_SPR_SRC_CAP_CNT(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfSPRSrcCap = (y))

#define GET_TYPE_C_5400_EPR_SRC_CAP_CNT(x)                  (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfEPRSrcCap)
#define SET_TYPE_C_5400_EPR_SRC_CAP_CNT(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfEPRSrcCap = (y))
...
#define GET_TYPE_C_5400_SPR_SNK_CAP_CNT(x)                  (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfSPRSnkCap)
#define SET_TYPE_C_5400_SPR_SNK_CAP_CNT(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfSPRSnkCap = (y))

#define GET_TYPE_C_5400_EPR_SNK_CAP_CNT(x)                  (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfEPRSnkCap)
#define SET_TYPE_C_5400_EPR_SNK_CAP_CNT(x, y)               (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfEPRSnkCap = (y))
...
#define GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(x)          (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfPartnerSPRSrcCap)
#define SET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(x, y)       (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfPartnerSPRSrcCap = (y))

#define GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(x)          (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfPartnerEPRSrcCap)
#define SET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(x, y)       (g_pstTypeC5400Info[SysTypeCGetTypeCIndex(x)].b3NumOfPartnerEPRSrcCap = (y))
...
code StructSMBusRDGetICStatus tSMBusRdCmdGetICStatus[1] = {{0x80, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
...
code StructSMBusWRGetPdo tSMBusWrCmdGetSelfEPRSrcPdo[1] = {{0x08, 0x03, 0xAA, 0x00, 0x81}};
code StructSMBusRDGetPdo tSMBusRdCmdGetEPRPdo[1] = {{0x80, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}};
code StructSMBusWRGetPdo tSMBusWrCmdGetPartnerEPRSrcPdo[1] = {{0x08, 0x03, 0xAA, 0x00, 0x83}};
#endif
...
code StructSMBusWRGetPdo tSMBusWrCmdGetPartnerSrcPdo1st[1] = {{0x08, 0x03, 0x83, 0x00, 0xA3}};
code StructSMBusWRGetPdo tSMBusWrCmdGetPartnerSrcPdo2nd[1] = {{0x08, 0x03, 0x83, 0x00, 0x57}};
...
EnumPDPortCtrlEvent UserCommonPortController5400GetPortCtrlEvent(BYTE ucInputPort);
void UserCommonPortController5400ClrPortCtrlEvent(BYTE ucInputPort, EnumPDPortCtrlEvent enumPdPortCtrlEvent);
...
WORD UserCommonPortControllerGet5400MaxPower(BYTE ucInputPort);
void UserCommonPortControllerGet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE *pucSPRPdoCnt, BYTE *pucEPRPdoCnt);
StructTypeCUserPDO UserCommonPortControllerGet5400Pdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex);
void UserCommonPortControllerGet5400PartnerPdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE *pucSPRPdoCnt, BYTE *pucEPRPdoCnt);
...
void UserCommonPortControllerSet5400MaxPower(BYTE ucInputPort, WORD usMaxPower);
void UserCommonPortControllerSet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucSPRPdoCnt, BYTE ucEPRPdoCnt);
...
void UserCommonPortController5400Reset(BYTE ucInputPort)
{
    ...
    SET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort, 0);
    SET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort, 0);
...
bit UserCommonPortControllerUpdate5400RoleInfo(BYTE ucInputPort)
{
    ...
    BYTE ucSlaveAddr = UserCommonPortControllerGetPCAddr(ucInputPort);
#if(_TYPE_C_RTS5400_SERIES_STATUS_EVENT == _ON)
    ...
    stGetStatus.ucOffset = 0x00;
    stGetStatus.ucStatusLen = 0x0B;
#else
...
#if(_TYPE_C_RTS5400_SERIES_STATUS_EVENT == _ON)
    if(UserCommonTypecCommunicationRead(ucSlaveAddr, tSMBusRDGetStatus[0].ucCommandCode, 1, stGetStatus.ucStatusLen + 1, &(g_unSMBusRdDataPool.stRdGetStatus.ucDataLength), ucInputPort) == _FAIL)
#else
...
#if(_TYPE_C_RTS5400_SERIES_STATUS_EVENT == _ON)
    // Byte0[6] Negotiated Power Level Change
    if((g_unSMBusRdDataPool.stRdGetStatus.ucByte0 & (_BIT6)) == _BIT6)
    {
        // If Negotiated Power Level Change Event Occurs, Set Rts Port Ctrl Event
        SET_TYPE_C_5400_PD_PORT_CTRL_EVENT(ucInputPort, _PD_PORT_CTRL_EVENT_PWR_LV_CHG_EVENT);

        // Acknowledge 5400 that Negotiated Power Level Change Event Occurred
        stAckCCCI.ucByte0 = stAckCCCI.ucByte0 | (_BIT6);
    ...
    if((g_unSMBusRdDataPool.stRdGetStatus.ucByte4 & (_BIT7)) == _BIT7)
    {
        ...
        {
            SET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort, ((g_unSMBusRdDataPool.stRdGetStatus.ucByte9 & (_BIT7 | _BIT6 | _BIT5 | _BIT4)) >> 4));
...
//--------------------------------------------------
// Description  : Return 5400 Port Ctrl Event
// Input Value  : ucInputPort
// Output Value : RTS Port Ctrl Event
//--------------------------------------------------
EnumPDPortCtrlEvent UserCommonPortController5400GetPortCtrlEvent(BYTE ucInputPort)
{
    return GET_TYPE_C_5400_PD_PORT_CTRL_EVENT(ucInputPort);
}

//--------------------------------------------------
// Description  : Clear 5400 Port Ctrl Event
// Input Value  : ucInputPort
// Output Value : None
//--------------------------------------------------
void UserCommonPortController5400ClrPortCtrlEvent(BYTE ucInputPort, EnumPDPortCtrlEvent enumPdPortCtrlEvent)
{
    CLR_TYPE_C_5400_PD_PORT_CTRL_EVENT(ucInputPort, enumPdPortCtrlEvent);
}
...
bit UserCommonPortControllerUpdate5400SrcPdo(BYTE ucInputPort)
{
    ...
    BYTE pucGetData[2 + (_RTS_MAX_DATA_OBJ_CNT * 4)]; // Arrary Size = ucCommandCode + ucDataLength + Max Data Objects * 4 Bytes
    memset(pucGetData, 0, sizeof(pucGetData));
    ...
    if(UserCommonPortControllerGet5400I2CPinNum(ucInputPort) == _SW_IIC_PIN_GPIO)
    {
        ...
        SET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength / 4);
        SET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort, 0);

        memcpy(pucGetData, &g_unSMBusRdDataPool.stRdGetPdo, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength + 2);
    }
    else
    {
        ...
        if(GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort) > 5)
        {
            ...
            memcpy(&pucGetData[2 + (5 * 4)], &g_unSMBusRdDataPool.stRdGetPdo.ucByte0, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength);
        }
    }

#if(_PORT_CONTROLLER_PD3_1_EPR_SUPPORT == _ON)
    // Use Get_EPR_PDO Command to Get EPR PDO
    if(UserCommonTypecCommunicationWrite(ucSlaveAddr, tSMBusWrCmdGetSelfEPRSrcPdo[0].ucCommandCode, 1, tSMBusWrCmdGetSelfEPRSrcPdo[0].ucDataLength + 1, ((BYTE *)&tSMBusWrCmdGetSelfEPRSrcPdo[0].ucDataLength), ucInputPort) == _FAIL)
    {
        return _FAIL;
    }
    ...
    // Data Read from 5450 is placed in g_unSMBusRdDataPool
    if(UserCommonTypecCommunicationRead(ucSlaveAddr, tSMBusRdCmdGetEPRPdo[0].ucCommandCode, 1, tSMBusRdCmdGetEPRPdo[0].ucDataLength, &(g_unSMBusRdDataPool.stRdGetPdo.ucDataLength), ucInputPort) == _FAIL)
    {
        return _FAIL;
    }

    // Put EPR PDO into pucGetData array
    memcpy(&pucGetData[2 + (GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort) * 4)], &g_unSMBusRdDataPool.stRdGetPdo.ucByte0, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength);

    SET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength / 4);
#endif

    // Set RTS General Info
    SET_TYPE_C_5400_DRP(ucInputPort, pucGetData[5] >> 5);
    SET_TYPE_C_5400_SUSPEND(ucInputPort, pucGetData[5] >> 4);
    SET_TYPE_C_5400_EXT_PWR(ucInputPort, pucGetData[5] >> 3);
    SET_TYPE_C_5400_USB_CAP(ucInputPort, pucGetData[5] >> 2);
    SET_TYPE_C_5400_DRD(ucInputPort, pucGetData[5] >> 1);
    SET_TYPE_C_5400_UNCHK(ucInputPort, pucGetData[5] >> 0);
    ...
    DebugMessageTypeC("GET_TYPE_C_5400_SPR_SRC_CAP_CNT()", GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort));
    DebugMessageTypeC("GET_TYPE_C_5400_EPR_SRC_CAP_CNT()", GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort));

    for(ucIndex = 0; ucIndex < _RTS_MAX_DATA_OBJ_CNT; ucIndex++)
    {
        if(((ucIndex >= GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort)) && (ucIndex < 7)) || ((ucIndex >= (GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort) + 7)) && (ucIndex < 11)))
        {
            ...
            SET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex, 0x00);
            ...
            DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_TYPE(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_CUR(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex));

            continue;
        }

        if(ucIndex < GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort))
        {
            ucGetDataIndex = ucIndex;
        }
        else
        {
            ucGetDataIndex = ucIndex - (7 - GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort));
        }

        if((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT7 | _BIT6)) == (_BIT7 | _BIT6))
        {
            // Set APDO Type
            SET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT7 | _BIT6 | _BIT5 | _BIT4)) >> 4));
        }
        else
        {
            // Set PDO Type
            SET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT7 | _BIT6)) >> 6));
        }

        if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_FIX_SUPPLY_PDO)
        {
            // Set Peak Current
            SET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 4] & (_BIT5 | _BIT4)) >> 4));

            // Set PDO Voltage (Unit 50mV to 100mV) and Current (Unit 10mA)
            SET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, (((((WORD)(pucGetData[ucGetDataIndex * 4 + 4] & 0x0F)) << 6) | (((WORD)(pucGetData[ucGetDataIndex * 4 + 3] & 0xFC)) >> 2)) / 2));
            SET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex));
            SET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex, ((((WORD)(pucGetData[ucGetDataIndex * 4 + 3] & 0x03)) << 8) | ((WORD)pucGetData[ucGetDataIndex * 4 + 2])));
        }
        else if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_PROGRAMMABLE_PDO)
        {
            ...
            SET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, (((pucGetData[ucGetDataIndex * 4 + 5] & 0x01) << 7) | ((pucGetData[ucGetDataIndex * 4 + 4] & 0xFE) >> 1)));
            SET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, pucGetData[ucGetDataIndex * 4 + 3]);
            SET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex, pucGetData[ucGetDataIndex * 4 + 2] & 0x7F);
        }
        else if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_1_ADJUSTABLE_PDO)
        {
            // Set Peak Current
            SET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT3 | _BIT2)) >> 2));

            // Set PDO Voltage (Unit 100mV)
            SET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, ((((WORD)(pucGetData[ucGetDataIndex * 4 + 5] & 0x03)) << 7) | (((WORD)(pucGetData[ucGetDataIndex * 4 + 4] & 0xFE)) >> 1)));
            SET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, pucGetData[ucGetDataIndex * 4 + 3]);
            SET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex, 0x00);

            // Set PDP (Unit 1W to 0.1W)
            SET_TYPE_C_5400_MAX_POWER(ucInputPort, pucGetData[ucGetDataIndex * 4 + 2] * 10);
        }
        ...
        DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucIndex));
        DebugMessageTypeC("GET_TYPE_C_5400_SRC_CAP_CUR(ucRealIndex)", GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucIndex));
        DebugMessageTypeC("GET_TYPE_C_5400_MAX_POWER()", GET_TYPE_C_5400_MAX_POWER(ucInputPort));
    }
...
bit UserCommonPortControllerUpdate5400PartnerSrcPdo(BYTE ucInputPort)
{
    ...
    if(UserCommonPortControllerGet5400I2CPinNum(ucInputPort) == _SW_IIC_PIN_GPIO)
    {
        ...
        // Set Number Of RTS SRC PDO
        SET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength / 4);
        SET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort, 0);
    ...
    else
    {
        ...
        if(GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort) > 5)
        {
            // Use Get_PDO Command in the second time to Get PDO 6~7
            if(UserCommonTypecCommunicationWrite(ucSlaveAddr, tSMBusWrCmdGetPartnerSrcPdo2nd[0].ucCommandCode, 1, tSMBusWrCmdGetPartnerSrcPdo2nd[0].ucDataLength + 1, ((BYTE *)&tSMBusWrCmdGetPartnerSrcPdo2nd[0].ucDataLength), ucInputPort) == _FAIL)
            {
                return _FAIL;
            }
...
#if(_PORT_CONTROLLER_PD3_1_EPR_SUPPORT == _ON)
    // Use Get_EPR_PDO Command to Get EPR PDO
    if(UserCommonTypecCommunicationWrite(ucSlaveAddr, tSMBusWrCmdGetPartnerEPRSrcPdo[0].ucCommandCode, 1, tSMBusWrCmdGetPartnerEPRSrcPdo[0].ucDataLength + 1, ((BYTE *)&tSMBusWrCmdGetPartnerEPRSrcPdo[0].ucDataLength), ucInputPort) == _FAIL)
    {
        return _FAIL;
    }
    ...
    // Put EPR PDO into pucGetData array
    memcpy(&pucGetData[2 + (GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort) * 4)], &g_unSMBusRdDataPool.stRdGetPdo.ucByte0, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength);

    SET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort, g_unSMBusRdDataPool.stRdGetPdo.ucDataLength / 4);
#endif

    DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT()", GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort));
    DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT()", GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort));

    for(ucIndex = 0; ucIndex < _RTS_MAX_DATA_OBJ_CNT; ucIndex++)
    {
        if(((ucIndex >= GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort)) && (ucIndex < 7)) || ((ucIndex >= (GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort) + 7)) && (ucIndex < 11)))
        {
            // If the SPR Source_Cap contains fewer than 7 PDOs, the unused Related Macros Shall be zero filled
            // If the EPR Source_Cap contains fewer than 4 PDOs, the unused Related Macros Shall be zero filled
            SET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_PARTNER_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, 0x00);
            SET_TYPE_C_5400_PARTNER_SRC_CAP_CUR(ucInputPort, ucIndex, 0x00);

            DebugMessageTypeC("ucIndex", ucIndex);
            DebugMessageTypeC("SPR Source_Cap is fewer than 7 PDOs, the unused Related Macros Shall be zero filled", 0x00);
            DebugMessageTypeC("EPR Source_Cap is fewer than 4 PDOs, the unused Related Macros Shall be zero filled", 0x00);
            DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucRealIndex)", GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_SRC_CAP_PEAK_CUR(ucRealIndex)", GET_TYPE_C_5400_PARTNER_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucRealIndex)", GET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MIN(ucRealIndex)", GET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MIN(ucInputPort, ucIndex));
            DebugMessageTypeC("GET_TYPE_C_5400_PARTNER_SRC_CAP_CUR(ucRealIndex)", GET_TYPE_C_5400_PARTNER_SRC_CAP_CUR(ucInputPort, ucIndex));

            continue;
        }

        if(ucIndex < GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort))
        {
            ucGetDataIndex = ucIndex;
        }
        else
        {
            ucGetDataIndex = ucIndex - (7 - GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort));
        }

        if((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT7 | _BIT6)) == (_BIT7 | _BIT6))
        {
            // Set APDO Type
            SET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT7 | _BIT6 | _BIT5 | _BIT4)) >> 4));
        }
        else
        {
            // Set PDO Type
            SET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT7 | _BIT6)) >> 6));
        }

        if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_FIX_SUPPLY_PDO)
        {
            // Set Peak Current
            SET_TYPE_C_5400_PARTNER_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 4] & (_BIT5 | _BIT4)) >> 4));

            // Set PDO Voltage (Unit 50mV to 100mV) and Current (Unit 10mA)
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, (((((WORD)(pucGetData[ucGetDataIndex * 4 + 4] & 0x0F)) << 6) | (((WORD)(pucGetData[ucGetDataIndex * 4 + 3] & 0xFC)) >> 2)) / 2));
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, GET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucInputPort, ucIndex));
            SET_TYPE_C_5400_PARTNER_SRC_CAP_CUR(ucInputPort, ucIndex, ((((WORD)(pucGetData[ucGetDataIndex * 4 + 3] & 0x03)) << 8) | ((WORD)pucGetData[ucGetDataIndex * 4 + 2])));
        }
        else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_PROGRAMMABLE_PDO)
        {
            ...
            // Set PDO Voltage (Unit 100mV) and Current (Unit 50mA)
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, (((pucGetData[ucGetDataIndex * 4 + 5] & 0x01) << 7) | ((pucGetData[ucGetDataIndex * 4 + 4] & 0xFE) >> 1)));
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, pucGetData[ucGetDataIndex * 4 + 3]);
            SET_TYPE_C_5400_PARTNER_SRC_CAP_CUR(ucInputPort, ucIndex, pucGetData[ucGetDataIndex * 4 + 2] & 0x7F);
        }
        else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_1_ADJUSTABLE_PDO)
        {
            // Set Peak Current
            SET_TYPE_C_5400_PARTNER_SRC_CAP_PEAK_CUR(ucInputPort, ucIndex, ((pucGetData[ucGetDataIndex * 4 + 5] & (_BIT3 | _BIT2)) >> 2));

            // Set PDO Voltage (Unit 100mV)
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MAX(ucInputPort, ucIndex, ((((WORD)(pucGetData[ucGetDataIndex * 4 + 5] & 0x03)) << 7) | (((WORD)(pucGetData[ucGetDataIndex * 4 + 4] & 0xFE)) >> 1)));
            SET_TYPE_C_5400_PARTNER_SRC_CAP_VOL_MIN(ucInputPort, ucIndex, pucGetData[ucGetDataIndex * 4 + 3]);
            SET_TYPE_C_5400_PARTNER_SRC_CAP_CUR(ucInputPort, ucIndex, 0x00);
        }
...
void UserCommonPortControllerUpdate5400PdoStatus(BYTE ucInputPort)
{
    ...
    if(GET_TYPE_C_5400_POWER_ROLE(ucInputPort) == _TYPE_C_POWER_SRC)
    {
        if(GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort) != 0)
        {
            ucTotalPdoCount = 7 + GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort);
        }
        else
        {
            ucTotalPdoCount = GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort);
        }

        // Check if Object Position is Valid
        if((GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) > 0) && (GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) <= ucTotalPdoCount))
        {
            ...
            else if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) - 1) == _PD_3_PROGRAMMABLE_PDO)
            {
                ...
                SET_TYPE_C_5400_PDO_STATUS_VOL(ucInputPort, (((((WORD)(GET_TYPE_C_5400_NEGOTIATED_REQ_INFO_2(ucInputPort) & 0x1F)) << 7) | (((WORD)(GET_TYPE_C_5400_NEGOTIATED_REQ_INFO_1(ucInputPort) & 0xFE)) >> 1)) * 2));
            ...
            else if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) - 1) == _PD_3_1_ADJUSTABLE_PDO)
            {
                // Convert Voltage From 25mV to 10mV
                SET_TYPE_C_5400_PDO_STATUS_VOL(ucInputPort, (((((WORD)(GET_TYPE_C_5400_NEGOTIATED_REQ_INFO_2(ucInputPort) & 0x1F)) << 7) | (((WORD)(GET_TYPE_C_5400_NEGOTIATED_REQ_INFO_1(ucInputPort) & 0xFE)) >> 1)) * 5 / 2));
    ...
    {
        if(GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort) != 0)
        {
            ucTotalPdoCount = 7 + GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort);
        }
        else
        {
            ucTotalPdoCount = GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort);
        }
        ...
        if((GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) > 0) && (GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) <= ucTotalPdoCount))
        {
            ...
            else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_NEGOTIATED_REQ_OBJ_POS(ucInputPort) - 1) == _PD_3_1_ADJUSTABLE_PDO)
            {
                // Convert Voltage From 25mV to 10mV
                SET_TYPE_C_5400_PDO_STATUS_VOL(ucInputPort, (((((WORD)(GET_TYPE_C_5400_NEGOTIATED_REQ_INFO_2(ucInputPort) & 0x1F)) << 7) | (((WORD)(GET_TYPE_C_5400_NEGOTIATED_REQ_INFO_1(ucInputPort) & 0xFE)) >> 1)) * 5 / 2));
...
WORD UserCommonPortControllerGet5400MaxPower(BYTE ucInputPort)
{
    return GET_TYPE_C_5400_MAX_POWER(ucInputPort);
}
...
void UserCommonPortControllerGet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE *pucSPRPdoCnt, BYTE *pucEPRPdoCnt)
{
    ...
    {
        *pucSPRPdoCnt = GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort);
        *pucEPRPdoCnt = GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort);
    }
    else if(enumPowerRole == _TYPE_C_POWER_SNK)
    {
        *pucSPRPdoCnt = GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort);
        *pucEPRPdoCnt = GET_TYPE_C_5400_EPR_SNK_CAP_CNT(ucInputPort);
    }
}
...
StructTypeCUserPDO UserCommonPortControllerGet5400Pdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex)
{
    StructTypeCUserPDO stTypeCPdo = {_PD_FIX_SUPPLY_PDO, _PD_PEAK_CUR_NONE, 0x00, 0x00, 0x00, 0x00, 0x00};
    BYTE ucTotalPdoCount = 0;
    ...
    if(enumPowerRole == _TYPE_C_POWER_SRC)
    {
        ...
        if((ucPdoIndex >= 1) && (ucPdoIndex <= ucTotalPdoCount))
        {
            ...
            else if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucPdoIndex - 1) == _PD_3_1_ADJUSTABLE_PDO)
            {
                stTypeCPdo.enumPeakCurrent = GET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucPdoIndex - 1);
            }
...
void UserCommonPortControllerGet5400PartnerPdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE *pucSPRPdoCnt, BYTE *pucEPRPdoCnt)
{
    if(enumPowerRole == _TYPE_C_POWER_SRC)
    {
        *pucSPRPdoCnt = GET_TYPE_C_5400_PARTNER_SPR_SRC_CAP_CNT(ucInputPort);
        *pucEPRPdoCnt = GET_TYPE_C_5400_PARTNER_EPR_SRC_CAP_CNT(ucInputPort);
    }
    else if(enumPowerRole == _TYPE_C_POWER_SNK)
    {
...
StructTypeCUserPDO UserCommonPortControllerGet5400PartnerPdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex)
{
    StructTypeCUserPDO stTypeCPartnerPdo = {_PD_FIX_SUPPLY_PDO, _PD_PEAK_CUR_NONE, 0x00, 0x00, 0x00, 0x00, 0x00};
    BYTE ucTotalPdoCount = 0;
    ...
    if(enumPowerRole == _TYPE_C_POWER_SRC)
    {
        ...
        if((ucPdoIndex >= 1) && (ucPdoIndex <= ucTotalPdoCount))
        {
            ...
            else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, ucPdoIndex - 1) == _PD_3_1_ADJUSTABLE_PDO)
            {
                stTypeCPartnerPdo.enumPeakCurrent = GET_TYPE_C_5400_PARTNER_SRC_CAP_PEAK_CUR(ucInputPort, ucPdoIndex - 1);
            }
...
StructTypeCUserPDO UserCommonPortControllerGet5400RequestedSrcPdo(BYTE ucInputPort)
{
    StructTypeCUserPDO stTypeCSrcPdo = {_PD_FIX_SUPPLY_PDO, _PD_PEAK_CUR_NONE, 0x00, 0x00, 0x00, 0x00, 0x00};
    BYTE ucTotalPdoCount = 0;
...
// Input Value  : ucInputPort, usMaxPower (Unit = 0.1W)
// Output Value : None
//--------------------------------------------------
void UserCommonPortControllerSet5400MaxPower(BYTE ucInputPort, WORD usMaxPower)
{
    // Set Max Power
    SET_TYPE_C_5400_MAX_POWER(ucInputPort, usMaxPower);
}

//--------------------------------------------------
// Description  : Set User-Defined Number of PDOs to Rts Port Ctrl
// Input Value  : ucInputPort, enumPowerRole(Src/Snk PDO), Number of PDO Counts
// Output Value : None
//--------------------------------------------------
void UserCommonPortControllerSet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucSPRPdoCnt, BYTE ucEPRPdoCnt)
{
    if(enumPowerRole == _TYPE_C_POWER_SRC)
    {
        ...
        SET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort, ucSPRPdoCnt);
        SET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort, ucEPRPdoCnt);
    }
    else if(enumPowerRole == _TYPE_C_POWER_SNK)
    {
        // Set Number Of SPR and EPR Sink Capabilities (Number Of Data Objects)
        SET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort, ucSPRPdoCnt);
        SET_TYPE_C_5400_EPR_SNK_CAP_CNT(ucInputPort, ucEPRPdoCnt);
    }
}
...
void UserCommonPortControllerSet5400Pdo(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucPdoIndex, StructTypeCUserPDO stTypeCUserPdo)
{
    if(enumPowerRole == _TYPE_C_POWER_SRC)
    {
        ...
        if(SysTypeCGetTotalSrcPdoCnt(ucInputPort) == ucPdoIndex)
        {
    ...
    else if(enumPowerRole == _TYPE_C_POWER_SNK)
    {
        ...
        else if(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, (ucPdoIndex - 1)) == _PD_3_1_ADJUSTABLE_PDO)
        {
            // Set PDO Voltage (Unit 100mV)
            SET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMaxVoltage);
            SET_TYPE_C_5400_SNK_CAP_VOL_MIN(ucInputPort, (ucPdoIndex - 1), stTypeCUserPdo.usMinVoltage);
        ...
        if(SysTypeCGetTotalSnkPdoCnt(ucInputPort) == ucPdoIndex)
        {
...
void UserCommonPortControllerSet5400Rdo(BYTE ucInputPort, StructTypeCUserRDO stTypeCUserRdo)
{
    ...
    if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_TARGET_REQ_OBJ_POS(ucInputPort) - 1) == _PD_FIX_SUPPLY_PDO)
    {
    ...
    else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_TARGET_REQ_OBJ_POS(ucInputPort) - 1) == _PD_3_PROGRAMMABLE_PDO)
    {
        // RDO[20:9] : PPS RDO (Vol in 20mV)
        SET_TYPE_C_5400_TARGET_REQ_INFO_1(ucInputPort, (stTypeCUserRdo.usReqInfo1) & 0xFFF);

        // RDO[6:0] : PPS RDO (Op. Cur in 50mA)
        SET_TYPE_C_5400_TARGET_REQ_INFO_2(ucInputPort, (stTypeCUserRdo.usReqInfo2) & 0x7F);
    }
    else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_TARGET_REQ_OBJ_POS(ucInputPort) - 1) == _PD_3_1_ADJUSTABLE_PDO)
    {
...
bit UserCommonPortControllerWrite5400Command(BYTE ucInputPort, BYTE ucSlaveAddr, Enum5400InfoType enum5400InfoType)
{
    ...
    BYTE ucIndex = 0;
    BYTE ucRealIndex = 0;
    BYTE pucData[5 + (_RTS_MAX_DATA_OBJ_CNT * 4)]; // Arrary Size = CMD + WR_DATA_LEN + SUB_CMD + PORT_NUM + PDO Num + Max Data Objects * 4 Bytes
    ...
    switch(enum5400InfoType)
    {
        ...
        case _SET_5400_SRC_PDO:
            ...
            pucData[1] = 3 + (4 * (GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort) + GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort)));
            pucData[2] = tSMBusWrCmdSetSrcPDO[0].ucByte0;
            pucData[3] = tSMBusWrCmdSetSrcPDO[0].ucByte1;

            if(GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort) != 0)
            {
                pucData[4] = (_BIT3) | ((BYTE)(GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort) << 4)) | ((BYTE)(GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort)));
            }
            else
            {
                pucData[4] = (_BIT3) | GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort);
            }

#if(_PORT_CONTROLLER_PD3_1_EPR_SUPPORT == _ON)
            if(((ucInputPort == _D0_INPUT_PORT) && (_D0_DP_TYPE_C_EXT_PD3_1_EPR_SUPPORT == _ON)) ||
               ((ucInputPort == _D1_INPUT_PORT) && (_D1_DP_TYPE_C_EXT_PD3_1_EPR_SUPPORT == _ON)) ||
               ((ucInputPort == _D6_INPUT_PORT) && (_D6_DP_TYPE_C_EXT_PD3_1_EPR_SUPPORT == _ON)))
            {
                // [23]: EPR Mode Capable
            ...
            for(ucIndex = 0; ucIndex < (GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort) + GET_TYPE_C_5400_EPR_SRC_CAP_CNT(ucInputPort)); ucIndex++)
            {
                if(ucIndex < GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort))
                {
                    ucRealIndex = ucIndex;
                ...
                {
                    ucRealIndex = (ucIndex - GET_TYPE_C_5400_SPR_SRC_CAP_CNT(ucInputPort)) + 7;
                }

                if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucRealIndex) == _PD_3_PROGRAMMABLE_PDO)
                {
                    // [31:28] PDO Type
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucRealIndex) << 4) & (_BIT7 | _BIT6 | _BIT5 | _BIT4));

                    // Get PDO Voltage (Unit 100mV) and Current (Unit 50mA)
                    // [24:17] Max Voltage in 100mV
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucRealIndex) >> 7) & (_BIT0));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucRealIndex) << 1) & (~_BIT0));

                    // [15:8] Min Voltage in 100mV
                    pucData[(ucIndex * 4) + 6] = GET_TYPE_C_5400_SRC_CAP_VOL_MIN(ucInputPort, ucRealIndex);

                    // [6:0] Max Current in 50mA
                    pucData[(ucIndex * 4) + 5] = GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucRealIndex);
                }
                else if(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucRealIndex) == _PD_3_1_ADJUSTABLE_PDO)
                {
                    // [31:28] PDO Type
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucRealIndex) << 4) & (_BIT7 | _BIT6 | _BIT5 | _BIT4));

                    // [27:26] Peak Current
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucRealIndex) << 2) & (_BIT3 | _BIT2));

                    // [25:17] Max Voltage in 100mV
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucRealIndex) >> 7) & (_BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucRealIndex) << 1) & (~_BIT0));
                    ...
                    pucData[(ucIndex * 4) + 5] = (BYTE)(GET_TYPE_C_5400_MAX_POWER(ucInputPort) / 10);
                }
                else
                {
                    // [31:30] PDO Type
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_TYPE(ucInputPort, ucRealIndex) << 6) & (_BIT7 | _BIT6));

                    // Get PDO Voltage (Unit 100mV to 50mv) and Current (Unit 10mA)
                    // | 23 | 22 | 21 | 20 | 19 | 18 | 17 | 16 |
                    // |  Rsv(0) | Peak Cur| Voltage(50mV)[9:6]|
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SRC_CAP_PEAK_CUR(ucInputPort, ucRealIndex) << 4) & (_BIT5 | _BIT4));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucRealIndex)) * 2) >> 6) & (_BIT3 | _BIT2 | _BIT1 | _BIT0));

                    // | 15 | 14 | 13 | 12 | 11 | 10 | 09 | 08 | 07 | 06 | 05 | 04 | 03 | 02 | 01 | 00 |
                    // |     Voltage(50mV) [5:0]     |                  Max.Cur [7:0]                  |
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((((GET_TYPE_C_5400_SRC_CAP_VOL_MAX(ucInputPort, ucRealIndex)) * 2) << 2) & (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2));
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucRealIndex) >> 8) & (_BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 5] = pucData[(ucIndex * 4) + 5] | GET_TYPE_C_5400_SRC_CAP_CUR(ucInputPort, ucRealIndex);
                }
            }
        ...
        case _SET_5400_SNK_PDO:
            ...
            pucData[1] = 3 + (4 * (GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort) + GET_TYPE_C_5400_EPR_SNK_CAP_CNT(ucInputPort)));
            pucData[2] = tSMBusWrCmdSetSnkPDO[0].ucByte0;
            pucData[3] = tSMBusWrCmdSetSnkPDO[0].ucByte1;

            if(GET_TYPE_C_5400_EPR_SNK_CAP_CNT(ucInputPort) != 0)
            {
                pucData[4] = (~_BIT3) & (((BYTE)(GET_TYPE_C_5400_EPR_SNK_CAP_CNT(ucInputPort) << 4)) | ((BYTE)(GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort))));
            }
            else
            {
                pucData[4] = (~_BIT3) & GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort);
            }
            ...
            for(ucIndex = 0; ucIndex < (GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort) + GET_TYPE_C_5400_EPR_SNK_CAP_CNT(ucInputPort)); ucIndex++)
            {
                if(ucIndex < GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort))
                {
                    ucRealIndex = ucIndex;
                }
                else
                {
                    ucRealIndex = (ucIndex - GET_TYPE_C_5400_SPR_SNK_CAP_CNT(ucInputPort)) + 7;
                }

                if(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucIndex) == _PD_3_PROGRAMMABLE_PDO)
                {
                    // [31:28] PDO Type
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucRealIndex) << 4) & (_BIT7 | _BIT6 | _BIT5 | _BIT4));

                    // Get PDO Voltage (Unit 100mV) and Current (Unit 50mA)
                    // [24:17] Max Voltage in 100mV
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucRealIndex) >> 7) & (_BIT0));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucRealIndex) << 1) & (~_BIT0));

                    // [15:8] Min Voltage in 100mV
                    pucData[(ucIndex * 4) + 6] = GET_TYPE_C_5400_SNK_CAP_VOL_MIN(ucInputPort, ucRealIndex);

                    // [6:0] Max Current in 50mA
                    pucData[(ucIndex * 4) + 5] = GET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, ucRealIndex);
                }
                else if(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucRealIndex) == _PD_3_1_ADJUSTABLE_PDO)
                {
                    // [31:28] PDO Type
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucRealIndex) << 4) & (_BIT7 | _BIT6 | _BIT5 | _BIT4));

                    // [25:17] Max Voltage in 100mV
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucRealIndex) >> 7) & (_BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucRealIndex) << 1) & (~_BIT0));
                ...
                {
                    // [31:30] PDO Type
                    pucData[(ucIndex * 4) + 8] = pucData[(ucIndex * 4) + 8] | ((BYTE)(GET_TYPE_C_5400_SNK_CAP_TYPE(ucInputPort, ucRealIndex) << 6) & (_BIT7 | _BIT6));

                    // Get PDO Voltage (Unit 100mV to 50mv) and Current (Unit 10mA)
                    // | 23 | 22 | 21 | 20 | 19 .. 16 | 15 .. 10 | 09 | 08 | 07 .. 00 |
                    // | FR | Reserved(0)  | Voltage(50mV)[9:0]  |   Max.Cur [9:0]    |
                    pucData[(ucIndex * 4) + 7] = pucData[(ucIndex * 4) + 7] | ((((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucRealIndex)) * 2) >> 6) & (_BIT3 | _BIT2 | _BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((((GET_TYPE_C_5400_SNK_CAP_VOL_MAX(ucInputPort, ucRealIndex)) * 2) << 2) & (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2));
                    pucData[(ucIndex * 4) + 6] = pucData[(ucIndex * 4) + 6] | ((GET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, ucRealIndex) >> 8) & (_BIT1 | _BIT0));
                    pucData[(ucIndex * 4) + 5] = pucData[(ucIndex * 4) + 5] | GET_TYPE_C_5400_SNK_CAP_CUR(ucInputPort, ucRealIndex);
                }
            }
        ...
        case _SET_5400_RDO:
            ...
            {
                // RDO[20:9] : PPS RDO (Vol in 20mV)
                pucData[6] = pucData[6] | ((BYTE)(GET_TYPE_C_5400_TARGET_REQ_INFO_1(ucInputPort) >> 7) & (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
                pucData[5] = pucData[5] | ((BYTE)(GET_TYPE_C_5400_TARGET_REQ_INFO_1(ucInputPort) << 1) & (_BIT7 | _BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1));

                // RDO[6:0] : PPS RDO (Op. Cur in 50mA)
                pucData[4] = pucData[4] | ((BYTE)(GET_TYPE_C_5400_TARGET_REQ_INFO_2(ucInputPort)) & (_BIT6 | _BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
            }
            else if(GET_TYPE_C_5400_PARTNER_SRC_CAP_TYPE(ucInputPort, GET_TYPE_C_5400_TARGET_REQ_OBJ_POS(ucInputPort) - 1) == _PD_3_1_ADJUSTABLE_PDO)
            {
                // RDO[20:9] : AVS RDO (Vol in 25mV)
