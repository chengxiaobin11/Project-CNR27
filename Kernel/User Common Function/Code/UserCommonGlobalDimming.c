...
#endif
#if(_GLOBAL_DIMMING_ONLINE_CALIBRATION_SUPPORT == _ON)
WORD UserCommonGlobalDimmingGetWordFromFlash(BYTE ucBank, BYTE ucPage, WORD usStartAddress, WORD usIndex, BYTE ucSwap);
#endif
...
WORD UserCommonGlobalDimmingGetPWMTableValue(WORD usIndex)
{
    ...
    {
        return UserCommonGlobalDimmingGetWordFromFlash(_OGC_FLASH_BANK, _OGC_FLASH_PAGE, _OCC_GLOBAL_DIMMING_PWMLUT_ADDRESS, usIndex, _TRUE);
    }
    else
#endif
    {
