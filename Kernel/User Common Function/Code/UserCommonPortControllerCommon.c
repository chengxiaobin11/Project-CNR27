...
WORD UserCommonPortControllerGetPresentAvailablePower(BYTE ucInputPort, WORD usMaxPower);
...
EnumTypeCSpmOperation UserCommonPortControllerSpmOperation(void);
...
//--------------------------------------------------
// Description  : Get TypeC Source Present Available Power Defined By User
// Input Value  : ucInputPort --> Inputput, usMaxPower
// Output Value : return Present Available Power (Unit = 0.1W)
//--------------------------------------------------
WORD UserCommonPortControllerGetPresentAvailablePower(BYTE ucInputPort, WORD usMaxPower)
{
    ucInputPort = ucInputPort;

    // return UserInterfaceTypeCGetAvailablePower(ucInputPort, usMaxPower);
    return usMaxPower;
}
...
EnumTypeCSpmOperation UserCommonPortControllerSpmOperation(void)
{
    // return UserInterfaceTypeCSpmOperation();
