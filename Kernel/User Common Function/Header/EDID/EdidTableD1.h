...
#if ((_DEF_DP_OVERCLOCK==_ON)||(_DEF_GAME_MODE))//(Project_ID == ID_HHT_HK2785E06_1P2H_AUO_P320HVN05_6_FDH180HZ_20210106)

BYTE code tEDID_TABLE_OVERCLOCK_DP[] =
{         

};
#endif
#if((_DEF_HDMI_OVERCLOCK==_ON)||(_DEF_GAME_MODE))

BYTE code tEDID_TABLE_OVERCLOCK_HDMI[] =
{      
};
