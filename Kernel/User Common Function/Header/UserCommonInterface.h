...
extern bit UserInterfaceModeSearchGetHighGainModeVGA(BYTE ucModeIndex);
#endif
...
extern EnumDpHdrSupport UserCommonInterfaceHDRGetHDR10Support(EnumSourceSearchPort enumSourcePort);
...
extern WORD UserCommonPortControllerGetPresentAvailablePower(BYTE ucInputPort, WORD usMaxPower);
...
extern EnumTypeCSpmOperation UserCommonPortControllerSpmOperation(void);
...
extern EnumPDPortCtrlEvent UserCommonPortController5400GetPortCtrlEvent(BYTE ucInputPort);
extern void UserCommonPortController5400ClrPortCtrlEvent(BYTE ucInputPort, EnumPDPortCtrlEvent enumPdPortCtrlEvent);
...
extern void UserCommonPortControllerGet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE *pucSPRPdoCnt, BYTE *pucEPRPdoCnt);
...
extern void UserCommonPortControllerGet5400PartnerPdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE *pucSPRPdoCnt, BYTE *pucEPRPdoCnt);
...
extern void UserCommonPortControllerSet5400PdoCnt(BYTE ucInputPort, EnumTypeCPowerRole enumPowerRole, BYTE ucSPRPdoCnt, BYTE ucEPRPdoCnt);
