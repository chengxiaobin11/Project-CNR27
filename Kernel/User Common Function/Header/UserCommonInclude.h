...
#define _OCC_GLOBAL_DIMMING_PWMLUT_ADDRESS             (_DIMMING_OCC_GAMMA10_ADDRESS + _OCC_GAMMA_TABLE_SIZE * _BACKLIGHT_DIMMING_SUPPORT)
...
#define _GD_PWMLUT_CHKSUM_ADDRESS                      (_CHECKSUM_START_ADDRESS + 25)
#define _GD_FINISH_ADDRESS                             (_CHECKSUM_START_ADDRESS + 26)
...
#define _OCC_PANEL_COLOR_MAPPING_DATA_LENGTH           0x10
#define _OGC_HDR10_IG_TABLE_SIZE                       0x65
#define _OCC_HDR10_COLOR_MATRIX_SIZE                   0x50
#define _OGC_HDR10_NOTM_DCR_THD_SIZE                   0x10
#define _OGC_HDR10_NOTM_BOUND_TOTAL_SPACE              0x10 // LB_MSB, LB_LSB, UB_MSB, UB_LSB, PanelMaxLV_EDID_CV
#define _OGC_HDR10_CHECKKSUM_SIZE                      0x10
...
#define _OCC_HDR10_GAMMA10_ADDRESS                     (_OCC_GAMMA10_ADDRESS)

#define _OCC_SRGBMATRIX_ADDRESS                        (_OCC_HDR10_GAMMA10_ADDRESS + _OGC_GAMMA_TABLE_SIZE * _OCC_SUPPORT)
#define _OCC_ADOBEMATRIX_ADDRESS                       (_OCC_SRGBMATRIX_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _OCC_SUPPORT)
#define _OCC_USERDEFINE_ADDRESS                        (_OCC_ADOBEMATRIX_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _OCC_SUPPORT)
#define _OCC_EBU_ADDRESS                               (_OCC_USERDEFINE_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _OCC_SUPPORT)
#define _OCC_REC709_ADDRESS                            (_OCC_EBU_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _OCC_SUPPORT)
...
#define _OCC_HDR10_SRGB_MATRIX_ADDRESS                 (_OCC_SRGBMATRIX_ADDRESS + _OCC_COLOR_MATRIX_TOTAL_SPACE * _OCC_SUPPORT)
#define _OCC_HDR10_ADOBE_MATRIX_ADDRESS                (_OCC_HDR10_SRGB_MATRIX_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _HDR10_SUPPORT)
#define _OCC_HDR10_DCIP3_D65_MATRIX_ADDRESS            (_OCC_HDR10_ADOBE_MATRIX_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _HDR10_SUPPORT)
#define _OCC_HDR10_BT2020_MATRIX_ADDRESS               (_OCC_HDR10_DCIP3_D65_MATRIX_ADDRESS + _OCC_COLORMATRIX_TABLE_SIZE * _HDR10_SUPPORT)
...
#define _OGC_HDR10_IG_NOTM_PEAK_NOR_ADDRESS            (_OGC_HDR10_IG_NOTM_DARK_ADDRESS + _OGC_HDR10_IG_TABLE_SIZE * _HDR10_SUPPORT)
#define _OGC_HDR10_IG_NOTM_PEAK_DARK_ADDRESS           (_OGC_HDR10_IG_NOTM_PEAK_NOR_ADDRESS + _OGC_HDR10_IG_TABLE_SIZE * _HDR10_SUPPORT)
#define _OGC_HDR10_NOTM_BOUND_ADDRESS                  (_OGC_HDR10_IG_NOTM_PEAK_DARK_ADDRESS + _OGC_HDR10_IG_TABLE_SIZE * _HDR10_SUPPORT)
#define _OGC_HDR10_CHECKSUM_ADDRESS                    (_OGC_HDR10_NOTM_BOUND_ADDRESS + _OGC_HDR10_NOTM_BOUND_TOTAL_SPACE * _HDR10_SUPPORT)
#define _OGC_DICOM_ADDRESS                             (_OGC_HDR10_CHECKSUM_ADDRESS + _OGC_HDR10_CHECKKSUM_SIZE * _HDR10_SUPPORT)
...
#define _HDR_CHKSUM_ADDRESS                            (_OGC_HDR10_CHECKSUM_ADDRESS)
#define _HDR_FINISH_ADDRESS                            (_OGC_HDR10_CHECKSUM_ADDRESS + 1)
#define _HDR_NOTM_BOUND_CHKSUM_ADDRESS                 (_OGC_HDR10_CHECKSUM_ADDRESS + 2)
...
#define GET_ON_LINE_GD_HDR_CALIBRATION_STATUS()        (g_stCalibrationInfo.b1CalibrationGDActiveHDRMode)
#define SET_ON_LINE_GD_HDR_CALIBRATION_STATUS(x)       {g_stCalibrationInfo.b1CalibrationGDActiveHDRMode = (x);}
#endif
...
#define SET_ON_LINE_GD_HDR_CALIBRATION_STATUS(x)       {_nop_();}
#endif
...
typedef struct
{
    ...
    EnumPDPortCtrlEvent enumPortCtrlEvent;
...
#if(_EEPROM_ACCESS_FUNCTION_SUPPORT == _ON || _HDMI_24C02_SUPPORT||_Anjian_EFFECT)
...
#if(_TYPE_C_RTS5400_SERIES_PDO_INFO_SUPPORT == _ON)
extern WORD UserCommonPortControllerGet5400MaxPower(BYTE ucInputPort);
extern void UserCommonPortControllerSet5400MaxPower(BYTE ucInputPort, WORD usMaxPower);
#endif
...
extern void UserCommonInterfaceDpHdrSupportSwitch(void);
#endif
#endif
...
extern void MENU_AdjustRGBLedState(BYTE ucstate);
#elif(_DEF_DX_LED_MODE3)
extern void DaoXing_LedModeAdjustrRGB(BYTE ucstate);
#endif
