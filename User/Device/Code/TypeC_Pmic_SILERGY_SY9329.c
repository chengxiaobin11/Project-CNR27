...
void ExternalDeviceInterfaceTypeCPmicACOnInitial(void)
{
    ...
    // Clear INT Flag
    ScalerTypeCPmicIICRead(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY9329_STATE_REG, _SY9329_SUBADDR_LENGTH, 2, (BYTE *)(&g_stPMICData) + _SY9329_STATE_REG);
}
...
void ExternalDeviceInterfaceTypeCPmicUnattachReset_EXINT0(void) using 1
{
    ...
    // Initial Pmic Value
    ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY9329_CTRL_REG1, _SY9329_SUBADDR_LENGTH, 4, (BYTE *)(&g_stPMICData) + _SY9329_CTRL_REG1);

    // Clear INT Flag
    ScalerTypeCPmicIICRead_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _SY9329_STATE_REG, _SY9329_SUBADDR_LENGTH, 2, (BYTE *)(&g_stPMICData) + _SY9329_STATE_REG);
}
