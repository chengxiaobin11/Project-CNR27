...
#define _MP4247_OUTPUT_VOL_3V                       0x0C00
#define _MP4247_OUTPUT_VOL_5V                       0x1400
#define _MP4247_OUTPUT_VOL_7V                       0x1C00
#define _MP4247_OUTPUT_VOL_9V                       0x2400
#define _MP4247_OUTPUT_VOL_12V                      0x3000
#define _MP4247_OUTPUT_VOL_15V                      0x3C00
#define _MP4247_OUTPUT_VOL_20V                      0x5000
...
#define _MP4247_VOUT_COMMAND_HIGH_DEFAULT           HIBYTE(_MP4247_OUTPUT_VOL_5V)
#define _MP4247_VOUT_COMMAND_LOW_DEFAULT            LOBYTE(_MP4247_OUTPUT_VOL_5V)
...
StructMP4247RegisterMap code tPMIC_MP4247_INITIAL_TABLE =
{
    ...
    _MP4247_VOUT_COMMAND_HIGH_DEFAULT,
    _MP4247_VOUT_COMMAND_LOW_DEFAULT,
...
void ExternalDeviceInterfaceTypeCPmicACOnInitial(void)
{
    ...
    ScalerTypeCPmicIICWrite(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_l));
    ScalerTypeCPmicIICWrite(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND + 1, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_h));
...
void ExternalDeviceInterfaceTypeCPmicUnattachReset_EXINT0(void) using 1
{
    ...
    ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_l));
    ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND + 1, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_h));
...
EnumTypeCPmicControlResult ExternalDeviceInterfaceTypeCPmicVoltageCurrentSetting(EnumTypeCPmicDirection enumPowerDirection, WORD usVoltage, WORD usCurrent)
{
    ...
    if(enumPowerDirection == _TYPE_C_PMIC_DIRECTION_SRC)
    {
        ...
        if(usVoltage <= (300))
        {
            g_pstPmicMp4247Data.ucVoutCommand_h = HIBYTE(_MP4247_OUTPUT_VOL_3V);
            g_pstPmicMp4247Data.ucVoutCommand_l = LOBYTE(_MP4247_OUTPUT_VOL_3V);
        }
        else if(usVoltage <= (500))
        {
            g_pstPmicMp4247Data.ucVoutCommand_h = HIBYTE(_MP4247_OUTPUT_VOL_5V);
            g_pstPmicMp4247Data.ucVoutCommand_l = LOBYTE(_MP4247_OUTPUT_VOL_5V);
        }
        else if(usVoltage <= (900))
        {
            g_pstPmicMp4247Data.ucVoutCommand_h = HIBYTE(_MP4247_OUTPUT_VOL_9V);
            g_pstPmicMp4247Data.ucVoutCommand_l = LOBYTE(_MP4247_OUTPUT_VOL_9V);
        }
        else if(usVoltage <= (1200))
        {
            g_pstPmicMp4247Data.ucVoutCommand_h = HIBYTE(_MP4247_OUTPUT_VOL_12V);
            g_pstPmicMp4247Data.ucVoutCommand_l = LOBYTE(_MP4247_OUTPUT_VOL_12V);
        }
        else if(usVoltage <= (1500))
        {
            g_pstPmicMp4247Data.ucVoutCommand_h = HIBYTE(_MP4247_OUTPUT_VOL_15V);
            g_pstPmicMp4247Data.ucVoutCommand_l = LOBYTE(_MP4247_OUTPUT_VOL_15V);
        }
        else if(usVoltage <= (2000))
        {
            g_pstPmicMp4247Data.ucVoutCommand_h = HIBYTE(_MP4247_OUTPUT_VOL_20V);
            g_pstPmicMp4247Data.ucVoutCommand_l = LOBYTE(_MP4247_OUTPUT_VOL_20V);
        }

        if((ScalerTypeCPmicIICWrite(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_l)) == _FAIL) ||
           (ScalerTypeCPmicIICWrite(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND + 1, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_h)) == _FAIL))
        {
            return _TYPE_C_PMIC_CONTROL_FAIL;
        }
...
EnumTypeCPmicControlResult ExternalDeviceInterfaceTypeCPmicVoltageCurrentSetting_EXINT0(EnumTypeCPmicDirection enumPowerDirection, WORD usVoltage, WORD usCurrent) using 1
{
    ...
    if(enumPowerDirection == _TYPE_C_PMIC_DIRECTION_SRC)
    {
        ...
        if((ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_l)) == _FAIL) ||
           (ScalerTypeCPmicIICWrite_EXINT0(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND + 1, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_h)) == _FAIL))
        {
            return _TYPE_C_PMIC_CONTROL_FAIL;
        }
...
EnumTypeCPmicControlResult ExternalDeviceInterfaceTypeCPmicVoltageCurrentSetting_WDINT(EnumTypeCPmicDirection enumPowerDirection, WORD usVoltage, WORD usCurrent) using 3
{
    ...
    if(enumPowerDirection == _TYPE_C_PMIC_DIRECTION_SRC)
    {
        ...
        if((ScalerTypeCPmicIICWrite_WDINT(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_l)) == _FAIL) ||
           (ScalerTypeCPmicIICWrite_WDINT(_TYPE_C_RX0_PMIC_SLAVE_ADDRESS, _MP4247_VOUT_COMMAND + 1, _MP4247_SUBADDR_LENGTH, _MP4247_DATA_LENGTH_1, (BYTE *)(&g_pstPmicMp4247Data.ucVoutCommand_h)) == _FAIL))
        {
            return _TYPE_C_PMIC_CONTROL_FAIL;
        }
