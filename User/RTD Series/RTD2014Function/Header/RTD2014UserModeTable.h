...
typedef enum
{
    ...
    _MODE_1920x1080p_75HZ_SOG,      // Mode 150:
    _MODE_1366x768_75HZ,            // Mode 151:
	_MODE_1600x900_75HZ,			// Mode 152:
	_MODE_1920x1080_40HZ,			// Mode 153;
...
StructModeTableType code tINPUTMODE_PRESET_TABLE[_MAX_PRESET_MODE] =
{
    ...
    {   // Mode 10 : 640 x 480 x 66 Hz
        ...
        640, 480,                                                           // InputWidth, InputHeight,
        334, 670,//350, 667,                                                           // HFreq in kHz, VFreq in Hz,
        _HFREQ_TOLERANCE, _VFREQ_TOLERANCE,                                 // IHFreqTolerance in kHz, IVFreqTolerance in Hz,
        816,499,//864, 525,                                                           // HTotal, VTotal,
    ...
    {   // Mode 11 : 640 x 480 x 72 Hz
        ...
        168,31,//171, 30,                                                            // HStartPos, VStartPos,
    },
	...
	{   // Mode 150 : 1920 x 1080 x 750 Hz
		//_MODE_1920x1080p_75HZ_SOG,		// Mode 150:
		0 | _SYNC_HN_VP| _SYNC_HP_VP, 												   // Polarity Flags,
		1920, 1080,														   // InputWidth, InputHeight,
		839, 750, 	   //	 825,750,//  839, 750,															 // HFreq in kHz, VFreq in Hz,
		_HFREQ_TOLERANCE, _VFREQ_TOLERANCE,								   // HFreqTolerance in kHz, VFreqTolerance in Hz,
		2080, 1121,		   //	 2040, 1100,// 2080, 1119,														   // HTotal, VTotal,
		112, 38,//35,			   //	   72, 17,//112, 35,															// HStartPos, VStartPos,
	},

	{	// Mode 151 : _MODE_1366x768_75HZ
		//_MODE_1366x768_75HZ,			// Mode 151:
		0 | _SYNC_HN_VP| _SYNC_HP_VP,												   // Polarity Flags,
		1366, 768, 													   // InputWidth, InputHeight,
		599, 750,	   //	 825,750,//  839, 750,															 // HFreq in kHz, VFreq in Hz,
		_HFREQ_TOLERANCE, _VFREQ_TOLERANCE, 							   // HFreqTolerance in kHz, VFreqTolerance in Hz,
		1792, 798, 	   //	 2040, 1100,// 2080, 1119,														   // HTotal, VTotal,
		356, 27,//35,			   //	   72, 17,//112, 35,															// HStartPos, VStartPos,
	},
	
	{	// Mode 152 : 1600 x 900 x 75 Hz
		//_MODE_1600x900_75HZ,			// Mode 152:
		0 | _SYNC_HN_VP | _SYNC_HN_VN | _SYNC_HP_VN | _SYNC_HP_VP,			// Polarity Flags,
		1600, 900,															// InputWidth, InputHeight,
		705,750,//706, 750,															// HFreq in kHz, VFreq in Hz,
		_HFREQ_TOLERANCE, _VFREQ_TOLERANCE, 							  // HFreqTolerance in kHz, VFreqTolerance in Hz,
		2160,940,//2096, 942,															// HTotal, VTotal,
		280,36,//398, 38,															// HStartPos, VStartPos,
	},
	
	{	// Mode 153 : _MODE_1920x1080_40HZ
	0 | _SYNC_HN_VP | _SYNC_HN_VN | _SYNC_HP_VN | _SYNC_HP_VP|_VIDEO_MODE_GROUP2,			// Polarity Flags,
		1920, 1080, 													   // InputWidth, InputHeight,
		450, 400,	   //	 825,750,//  839, 750,															 // HFreq in kHz, VFreq in Hz,
		_HFREQ_TOLERANCE, _VFREQ_TOLERANCE, 							   // HFreqTolerance in kHz, VFreqTolerance in Hz,
		2200, 1125, 	   //	 2040, 1100,// 2080, 1119,														   // HTotal, VTotal,
		200, 37,//35,			   //	   72, 17,//112, 35,															// HStartPos, VStartPos,
	},
};
