...
typedef enum
{
	...
	_FLASH_ITEMID_OSD_DATA_3, // 6 
	_FLASH_ITEMID_OSD_DATA_4, // 6 
	_FLASH_ITEMID_OSD_DATA_5, // 6 
	_FLASH_ITEMID_OSD_DATA_6, // 6 
    _FLASH_ITEMID_OSD_DATA_END = _FLASH_ITEMID_OSD_DATA_6,//
    _FLASH_ITEMID_BRICON_SRC0_VGA,// 7
	_FLASH_ITEMID_BRICON_SRC0_VGA_END=_FLASH_ITEMID_BRICON_SRC0_VGA+0X10,// 7
...
extern void UserAdjustSmartCrosshairInit(void);
extern void UserAdjustSmartCrosshairHandler(void);
#endif
