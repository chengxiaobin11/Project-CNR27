...
// EDID CONTENT TABLES
//****************************************************************************
#if(((_EMBEDDED_EDID_SUPPORT == _ON) && (_WRITE_EDID_LOCATION_BY_USER_SUPPORT == _ON) && (_HDMI_SUPPORT == _ON)) || ((_EDID_EXTERNAL_EEPROM_MAX_SIZE != _EDID_SIZE_NONE) && ((_HDMI_FREESYNC_SUPPORT == _ON) || (_HDMI21_VRR_SUPPORT == _ON) || (_HDMI21_FVA_SUPPORT == _ON))))
...
#if(_HDMI_HDR10_SUPPORT == _ON)
BYTE code tHDMI_EDID_FHD_HDR_TABLE[] =
{
...
#if(_HDMI_FREESYNC_SUPPORT == _ON)
BYTE code tHDMI_EDID_FHD_FS_TABLE[] =
{
#if(_HDMI21_VRR_SUPPORT == _ON)

#if(_HDMI_FREESYNC_CAPABILITY_SWITCH_METHOD == _MCCS_SWITCH_MODE)
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC_VRR(48,120)M.h"
#else
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC_VRR(48,120).h"
#endif

#else

#if(_HDMI_FREESYNC_CAPABILITY_SWITCH_METHOD == _MCCS_SWITCH_MODE)
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC(40,100)M.h"
#else
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC(40,100).h"
#endif
...
#if((_HDMI_FREESYNC_SUPPORT == _ON) && (_HDMI21_VRR_SUPPORT == _ON) && (_HDMI_HDR10_SUPPORT == _ON))
BYTE code tHDMI_EDID_FHD_FS_HDR_TABLE[] =
{
...
#if(_HDMI_FREESYNC_CAPABILITY_SWITCH_METHOD == _MCCS_SWITCH_MODE)
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC_VRR(48,144)M_HDR.h"
#else
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC_VRR(48,144)_HDR.h"
#endif

#else// #if(_HDMI21_VRR_SUPPORT == _ON))

#if(_HDMI_FREESYNC_CAPABILITY_SWITCH_METHOD == _MCCS_SWITCH_MODE)
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC(48,144)M_HDR.h"
#else
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC(48,144)_HDR.h"
#endif

#endif// #if(_HDMI21_VRR_SUPPORT == _ON))

#else// #if(_LVDS_ULTRA_HIGH_SPEED_SUPPORT == _ON)

#if(_HDMI21_VRR_SUPPORT == _ON)

#if(_HDMI_FREESYNC_CAPABILITY_SWITCH_METHOD == _MCCS_SWITCH_MODE)
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC_VRR(48,120)M_HDR.h"
#else
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC_VRR(48,120)_HDR.h"
#endif

#else// #if(_HDMI21_VRR_SUPPORT == _ON))

#if(_HDMI_FREESYNC_CAPABILITY_SWITCH_METHOD == _MCCS_SWITCH_MODE)
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC(48,120)M_HDR.h"
#else
#include "./EDID/EdidHdmi/EDID_HDMI_1920x1080_FREESYNC(48,120)_HDR.h"
#endif
...
{
    tHDMI_EDID_FHD_TABLE,             // _EDID_INDEX_0 (1ST Order of HDMI EEPROM, IF Project have 1 or more EXT EDID)

#if(_HDMI_MULTI_EDID_SUPPORT == _ON)
#if(_HDMI_HDR10_SUPPORT == _ON)
    tHDMI_EDID_FHD_HDR_TABLE,         // _EDID_INDEX_1
#endif

#if(_HDMI_FREESYNC_SUPPORT == _ON)
    tHDMI_EDID_FHD_FS_TABLE,          // _EDID_INDEX_2
#endif

#if((_HDMI_FREESYNC_SUPPORT == _ON) && (_HDMI_HDR10_SUPPORT == _ON))
    tHDMI_EDID_FHD_FS_HDR_TABLE,     // _EDID_INDEX_3
#endif
#endif
};
#endif
