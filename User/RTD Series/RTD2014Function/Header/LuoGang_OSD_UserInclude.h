...
//----------------------------------------------------------------------------------------------------
	...
	#define _DCR_PANEL_ON_OFF									_ON //DCR打开，黑场是否关背光
...
#endif
	#define EDID_HDR_SC									_OFF//_HDR_SUPPORT//_OFF//代码 带不带HDR
	#define EDID_SIZE_WR								_ON//写入尺寸
	#define EDID_ID_CODE                            	0x2700
	#define EDID_ID_SIZE                           	 	2700//0x0000
	#define EDID_YEAR_table                         	2026//年份
	#define EDID_WEEK_table                         	16//周别
	...
	#define _DEF_COLORTEMP										_CT_USER//默认色温
...
//#define _BACKLIGHT_MIN								20
	...
	#define EDID_HDR_SC 								_ON//_HDR_SUPPORT//_OFF//代码 带不带HDR
	#define EDID_SIZE_WR								_ON//写入尺寸
	#define EDID_ID_CODE								0x2700
	#define EDID_ID_SIZE								2700//0x0000
	#define EDID_YEAR_table 							2025//年份
	...
	#define _DEF_P5_RESET_ITEM3    	  	 						 _MENU_FUN_LED								 //预留灯效位置
	#define _DEF_P5_RESET_ITEM4 								 _MENU_FUN_AUDOIVOLUME//预留灯效位置
	#define _DEF_P5_RESET_ITEM5 								 _MENU_FUN_AUDOIMUTE								 //预留灯效位置
...
#endif
#define _EOC_ENERGY_SUPPORT					     	    _ON  //宏夏能源中心
...
#define _PANEL_VGA_MAX_FRAME_RATE					750//_PANEL_MAX_FRAME_RATE
#define _DEF_COLORTEMP										_CT_7500//默认色温
...
#define _UKRAINE_SUPPRT							_ON //是否增加乌克兰语,开乌克兰必须开乌兹别克语
#define _UZBEK_SUPPRT							_ON //是否增加乌兹别克语
#define _ENABLE_PAWER_SAVING_MENU				_OFF
#define _CT_7500_SUPPRT							_ON //是否增加7500色温
...
#define _DEF_P1_PICTURE_ITEM5      _MENU_NULL 
#define _DEF_P5_RESET_ITEM4 								 _MENU_FUN_GAMMA//预留灯效位置
#define _DEF_P6_MISC_ITEM1									  _MENU_FUN_FREESYNC
#define _DEF_P6_MISC_ITEM2									  _MENU_FUN_OD
...
#define _OD_WEAK_MID_HIGH									 _ON
	...
	#define _ENABLE_MAIN_MENU_F_ICON							_OFF//工厂老化模式
	#define _OSD_SHOW_SYNC										_OFF//菜单上显示sync
	#define _OD_WEAK											0X18
	#define _OD_MID 											0X30
	#define _OD_STRONG											0X40
	#define _OD_WEAK_MID_HIGH									_OFF // OD 强中弱
	#define _MPRT_DCR_REPULSION                                 _ON  //DCR和MPRT互斥
...
//280--300mA
	...
	#define _DEF_FACTORY_MODE									_OFF//工厂模式默认开关
	#define _DEF_BURNING_MODE									_OFF//老化模式默认开关	
	#define _DEF_OSD_LANGUAGE_ARROW                    			 _ON	
	#define _DEF_VOLUME										     30
	#define _CT_7500_SUPPRT 									_ON  //色温是否带7500
	#define	_MENU_INFOR_SHOW_HDR								_ON//菜单信息页面显示 HDR
...
#define _DEF_LANGUAGE										 _ENGLISH
#define _UZBEK_SUPPRT										_OFF//是否增加乌兹别克语
...
#define _UKRAINE_SUPPRT							_OFF //是否增加乌克兰语,开乌克兰必须开乌兹别克语
#endif
