    ...
    switch(ucInputPort)
    {
        case _D0_INPUT_PORT:
            ...
            switch(ucPdoIndex)
            {
                ...
                // ALL PDO Type Must Be In Order : Fix -> SPR AVS -> PPS
                // SPR AVS PDO Must Be Supported when (PD Power > 27W) and (PD Version >= PD3.2) (Refer TO PD Power Rule in Table 10.2)
                // SPR AVS 15V Max Current Field Shall Be Equal To The Max Current Field Of The 15V Fixed Source PDO
                // SPR AVS 20V Max Current Field Shall Be Equal To The Max Current Field Of The 20V Fixed Source PDO if PD Power > 45W, otherwise Shall Be 0
                ...
                case _TYPE_C_PDO_NUM_3:
                    ...
                    // PDO Type = Programmable PDO (9V PPS PDO = 5V ~ 11V)
                    // Min Voltage (Unit = 100mV) : 50 * 100mV = 5V
                    // Max Voltage (Unit = 100mV) : 110 * 100mV = 11V
                    // Max Current (Unit = 10mA)  : 300 *  10mA = 3A
                    ...
                    pstTypeCUserSrcPdo->usMinVoltage = 50;
                    pstTypeCUserSrcPdo->usMaxVoltage = 110;
                    pstTypeCUserSrcPdo->usMaxCurrent = 300;
#endif
                    break;
...
#if((_TYPE_C_EMB_PD3_1_EPR_SUPPORT == _ON) || (_D0_DP_TYPE_C_EXT_PD3_1_EPR_SUPPORT == _ON))
...
void UserInterfaceTypeCGetRdoInfo(BYTE ucInputPort, StructTypeCUserRDO *pstTypeCUserRdo)
{
    ...
    switch(ucInputPort)
    {
        case _D0_INPUT_PORT:
            ...
            pstTypeCUserRdo->usReqInfo1 = 50;                // Fix PDO : Op. Cur in 10mA / PPS PDO : Vol in 20mV / AVS RDO (Vol in 25mV)
            pstTypeCUserRdo->usReqInfo2 = 50;                // Fix PDO : Max. Cur in 10mA / PPS PDO : Op.Cur in 50mA / AVS RDO (Op. Cur in 50mA)
