...
#define _DEF_OSD_MC_NANFEI										2//ECO切换亮度变化
...
typedef enum //menuitem
{
	...
	_MENU_FUN_MPRT,
	_MENU_FUN_GAMMA,//5
	_MENU_FUN_COLORGAMUT, //rl6463 . rl6851 hdr数据不支持
	_MENU_FUN_SATURATION,	
	_MENU_FUN_OVERCLOCK,
#if(_ROTATE_FUN_SUPPORT)
	_MENU_FUN_ROTATE,	//旋转
	_MENU_FUN_OSD_ROTATE,	//旋转//有问题 90/270不行，180旋转有问题，不调了
#endif
	...
	_MENU_FUN_POWER_SAVING,	//42种,先加一下吧
#endif
#if _DEF_KVM_FUN
	_MENU_FUN_KVM,
#endif
...
#else
// OSD_ITEM_MASK暂时只给hotkey使用,做移位操作来节省空间,6位的数组支持48种功能
...
#endif
/*OSD_MASK_SET 和 OSD_MASK 的区别在于:
* OSD_MASK_SET传进来的参数是功能，例如_MENU_FUN_BACKLIGHT
* OSD_MASK传进来的参数是OSD里的位置，例如第一个界面的第一项
*/
