...
#define _FACTORY_PAGE_0_END                         0xFB//0xA4

#define _FACTORY_PAGE_1_START                       0x01//0xA5
#define _FACTORY_PAGE_1_END                         0xFB//256-511 font
...
#define _FACTORY_EDID_INFO_ROW                      1
#define _FACTORY_EDID_INFO_COL                      1
...
#define _BURNIN_EDID0_NAME_ROW               _BURNIN_EDID0_RESOLUT_ROW+1
#define _BURNIN_EDID0_SN_ROW               _BURNIN_EDID0_NAME_ROW+1
#define _BURNIN_EDID0_CSK_ROW               	_BURNIN_EDID0_SN_ROW+1

#define _BURNIN_NAME_COL                       	5
#define _BURNIN_SN_COL                       	5
#define EDID_ROW_NUM							8
...
#if(_DEF_BURN_EDID)
#define _BURNIN_OSD_ROW                            ((_BURNIN_PANEL_NAME_ROW)+((_OSD_INPUT_AMOUNT-_SOURCE_AUTO_ON)*(EDID_ROW_NUM))+2)
#else
#define _BURNIN_OSD_ROW                            ((_BURNIN_PANEL_NAME_ROW)+((0)*(EDID_ROW_NUM))+2)
...
#if(_DEF_IR_SHOW)
extern BYTE ir_show_data[4];
extern void RTDFactoryOsdFuncShowHexNumber(BYTE ucRow, BYTE ucCol, BYTE ucFontPoint);
#endif
