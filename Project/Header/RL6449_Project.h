...
/////////////
///vby 600Mbps ～ 3.75Gbp
///单通道的传输速度达到 4Gbps，有效数据率为 3.75Gbp V-by-one可以达到3.2Gbps。（有效数据量）
//[encoded total bit-rate] (bps) = [byte mode] (byte)*8*10/8* [pixel clock] (Hz
/////8lane 3.75g  8*3.75/(3*8)*8/10 8*3.75/(4*10)*8/10
/////8lane 2.7g	  8*2.7/24*8/10=720
/*
...
//-------------------------------------------------
//2775QT/2795 _16M_16BIT_DDR2_2PCS
//#define _EMBEDDED_MEMORY_SIZE_CONFIG                            _16M_16BIT_DDR2_2PCS

//2775QR _16M_16BIT_DDR2_1PC
...
#define _DYNAMIC_COLOR_AUTO_MEASURE                             _ON//RL6463也可以用
...
#define _OOR_V_FREQ_UPPER_BOUND                                 3010 // Unit in 0.1 HZ
...
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           3010 // Unit in 0.1 HZ
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           230  // Unit in 0.1 HZ

#define _INPUTCLOCK_RANG_VGA                                    2100 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DVI                                    7000 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_HDMI                                   7000 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DP                                     7000 // Unit in 0.1 MHz // Unit in 0.1 MHz, Max 7250 (720MHz + 5MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_USBC                                   6000 // Unit in 0.1 MHz // Unit in 0.1 MHz, Max 7250 (720MHz + 5MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
...
#define _DIGITAL_VOLUME_MAX                                     0x1000                      // MAX: 0x3FFF
#define _DIGITAL_VOLUME_MIN                                     0x0000
#define _DIGITAL_VOLUME_CENTER									0x0900
