...
//更新真hdr至bank14，新的字库导致bank7被占用了
#define _OGC_FLASH_BANK                                         14//7//14
#define _OGC_FLASH_PAGE                                         0
...
#if SG2701B08_1_LONG
#define _WAIT_TIME_TO_ACTIVE_HDMI                               SEC(1)
#else
...
//--------------------------------------------------
#if 1
#define _OOR_H_FREQ_UPPER_BOUND                                 2100 // Unit in 0.1 kHZ
#define _OOR_H_FREQ_LOWER_BOUND                                 100  // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 1845  // Unit in 0.1 HZ
...
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           4845  // Unit in 0.1 HZ
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           200  // Unit in 0.1 HZ

#define _INPUTCLOCK_RANG_VGA                                    2100 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DVI                                    3400 // Unit in 0.1 MHz, Max 3400 for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_HDMI                                   3400 // Unit in 0.1 MHz, Max 3400 for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_DP                                     3500 // Unit in 0.1 MHz, Max 3500 (346.5MHz + 3.5MHz margin) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
...
// DVI & HDMI Option
//--------------------------------------------------
#define _DVI_DE_ONLY_SUPPORT                                    _ON//_ON
#define _HDMI_FROM_DVI_CONNECT                                  _ON//_ON
