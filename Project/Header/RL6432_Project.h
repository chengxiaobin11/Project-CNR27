...
/////////////
#ifndef	_OVERCLOCK
#define _OVERCLOCK												_OFF//最新版已无作用
#endif
//--------------------------------------------------
// Pcb Option
//--------------------------------------------------
...
#if(Project_ID == ID_JX_HK2556E02_1P1H_M270HCA_L7B_LVDS_FHD165HZ_20211012)
...
//#define _CAPABILITIES_STRING_HDMI                               "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 04 05 06 08 0B) 16 18 1A 52 60(0F 11) 87 AC AE B2 B6 C6 C8 CA CC(02 03 0A 08 04 05 14 0B 16 1C 12 09 07 01 0D 06 17 1A 0C) D6(01 02 04) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
//#define _CAPABILITIES_STRING_DP                                 "(prot(monitor)type(LCD)model(RTK)cmds(01 02 03 07 0C E3 F3)vcp(02 04 05 06 08 0B 0C 10 12 14(01 04 05 06 08 0B) 16 18 1A 52 60(0F 11) 87 AC AE B2 B6 C6 C8 CA CC(02 03 0A 08 04 05 14 0B 16 1C 12 09 07 01 0D 06 17 1A 0C) D6(01 02 04) DF)mswhql(1)asset_eep(40)mccs_ver(2.2))"
...
#if((Project_ID>=0x2000)&&(Project_ID<=0x2fff)&&(_PCB_TYPE>=0x3000)&&(_PCB_TYPE<=0x3FFF))
#define _EMBEDDED_MEMORY_SIZE_CONFIG							_4M_16BIT_DDR1_1PC
...
#define _FLASH_TYPE_BY25D16ASTIG_OR_BY25Q16ES                   _FLASH_BY25D16ASTIG
...
//--------------------------------------------------
#if(Project_ID    ==  ID_CS_2556)||(Project_ID    ==  ID_RD_HK2557E02_1P1H_SN238CS041_LVDS_FDH180HZ_20230522)||(Project_ID    ==  ID_WM_HK2557E04_1P2H_SG2701B018_LVDS_FDH200HZ_20230517)
...
#define _INPUTCLOCK_RANG_VGA                                    2100 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DVI                                    4450//5000 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_HDMI                                   4450///5000 // Unit in 0.1 MHz // Unit in 0.1 MHz, Max 4450 (441MHz + 1%) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_DP                                     6000//5000 // Unit in 0.1 MHz  //Unit in 0.1 MHz, Max 4300 (423.6MHz + 1%) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#define _INPUTCLOCK_RANG_USBC                                   4450//5000 // Unit in 0.1 MHz	// Unit in 0.1 MHz, Max 4300 (423.6MHz + 1%) for (_IMD_DOMAIN_ULTRA_HIGH_SPEED_SUPPORT == ON)
#endif
