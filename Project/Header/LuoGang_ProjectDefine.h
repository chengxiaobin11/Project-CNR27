...
////////////////////////   0X3101----0X310F   ///////////////////////////////
/////////////////////////////凯迪///////////////////////////////////////
#define ID_KAIDI_HK2785E20_MV315QHM_NX0_QHD75HZ_20260319                                             0x3140//改2785E20
...
/*********************RL6463*********************************************/
//////////6851 2525BRE09 黑屏点不亮原因: font字库超出，需要指令部分font放在bank6
////////////////////////   0X5101----0X511F   ///////////////////////////////
...
////////////////////////////////////////////////////////////////////////////
//6463 2513ar可以超120
//6851 2525br/2513br hdmi fhd144hz dp 144hz，最高可超180，但是144以上切换有问题
/////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
...
///#define _OVERCLOCK												_ON 最新版已不使用

//#define _HDMI_24C02_SUPPORT                                                                        	_ON
#define _DEF_OSD_2525   			_OFF//不必要用，未完成
...
#define HV320FHB_F41											_ON //屏是 _HKC_PT320CT01_3_LVDS_FHD75HZ
...
#define PN270CU01_6 											_OFF//关了是PN238CS02_2
#define SG2701B08_1 											_OFF//关了是PN238CS02_2
#define SG2701B08_1_144 										_OFF//_OFF//关了是PN238CS02_2
#define SG2701B08_1_144_27M56 									_OFF//_ON//关了是PN238CS02_2
#define SG2701B08_1_LONG 										_ON//_OFF//关了是PN238CS02_2 闪屏
#define SG2381B04_1 											_OFF//关了是PN238CS02_2
#define SG2381B04_144 											_OFF//_ON//关了是PN238CS02_2
#define SG2381B04_144_2 										_OFF//_OFF//关了是PN238CS02_2
#define SG2381B04_1_shan 										_OFF//关了是PN238CS02_2 闪屏
...
#define SG2381B04_1 											_ON
    ...
    #define _OD_SUPPORT                                             _ON
	#define _HDMI_24C02_SUPPORT 									_OFF		
	#define NO_SAVE_AC_STATE_SUPPORT								_ON//不保存AC状态
...
#define _IR_MODE_2 											_OFF// 2号屏
#define _IR_MODE_3 											_ON// 3号屏
#define _IR_VIRTUAL 											_OFF
	...
	#define _KEY_LED_INSERVE                                    	_ON
	#define _FREESYNC_LEFT_RIGHT_EFFECT                        		_ON
	#define _VERSION_NO_LED                                      	_ON//不带灯效版本
...
#define _FREESYNC_LEFT_RIGHT_EFFECT 							_ON
	...
	#define _KEY_LED_INSERVE                                    	_ON
	#define _FREESYNC_LEFT_RIGHT_EFFECT                        		_ON
	#define _VERSION_NO_LED                                      	_OFF//不带灯效版本
...
#define _PROJEC_ID_TYPE 											0// 1 金品 0 none
#endif
...
#define _Def_AutoAlign_Type											1//o 旧版     1.新版，用RTD烧录板
#endif
...
#define _KEY_LED_INSERVE                                    _OFF //按键灯反转
#endif

#ifndef NO_SAVE_AC_STATE_SUPPORT
#define NO_SAVE_AC_STATE_SUPPORT							_OFF//不保存AC状态
#endif
