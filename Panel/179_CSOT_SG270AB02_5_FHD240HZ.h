...
#if(_PANEL_TYPE == _CSOT_SG270AB02_5_FHD240HZ)
//----------------------------------------------------------------------------------------------------
// ID Code      : 44_AUO_T215HVN05_1_LVDS_60HZ.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define _PANNEL_NAME                        _P__,_a__,_n__,_e__,_l__,__,_COLON__,__,_S__,_G__,_2__,_7__,_0__,_A__,_B__,_0__,_2__
...
#define _PANEL_DH_TOTAL                         2040                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX          			2080                // Maxinum Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MIN                     2020//2000                // Mininum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX           			5500               // Maxinum Display Vertical Total Clock Number in One Display Line
#define _PANEL_DV_TOTAL_MIN                     1095// 1098                // Mininum Display Vertical Total Clock Number in One Display Line

#define _PANEL_DH_SYNC_WIDTH                    8                   // Display Horizontal Sync Width
#define _PANEL_DV_SYNC_HEIGHT                   2                   // Display Vertical Sync Height

#define _PANEL_PIXEL_CLOCK                      133                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX        		    600//549                // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN             		106               // Mininum Pixel Clock in MHz
...
#define _PANEL_POWER_OFF_T5                     100                  // Panel Power Off T5 (ms)
